...
translate polish strings:
    ...
    new "Wykwalifikowany i odważny wojownik, który ucieleśnia siłę, odwagę i honor. Zacięty i zdecydowany, nigdy nie wycofuje się z wyzwania i zawsze gotowy bronić swoich sojuszników. Czy to na pierwszej linii, czy w cieniu, lojalność i determinacja wojownika czynią go cennym sojusznikiem." # TL # Victorius - AI
    ...
    new "Wysoko wyszkolony i umiejętny wojownik wybrany spośród najlepszych. Zacięty i zdecydowany, nigdy nie wycofuje się z wyzwania i zawsze gotowy bronić swoich sojuszników. Czy to na pierwszej linii, czy w cieniu, lojalność i determinacja wojownika czynią go cennym sojusznikiem." # TL # Victorius - AI
    ...
    new "Wykwalifikowany tropiciel i ekspert strzelectwa, wyszkolony w sztuce polowania i chwytania zdobyczy. Dzięki swoim ostrym zmysłom i zabójczej precyzji, łowcy potrafią wytropić nieuchwytne cele i pokonać potężnych wrogów." # TL # Victorius - AI
