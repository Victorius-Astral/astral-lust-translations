...
translate polish exp_friendly_wanderers_239f2316:
    ...
    girl "N-nic... {small}Chyba sobie coś wyobrażam... Czy to był ktoś inny...?{/small}" # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_b5f39981:
    ...
    wanderer "Jesteśmy w trakcie interesów. Skup się." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_dfbca531:
    ...
    th "To byłem ja, ale lepiej, żeby nie wiedziała, że mogę się odrodzić." # TL # Victorius - AI

# game/events/areas/bus/friendly_wanderers.rpy:72
translate polish exp_friendly_wanderers_4fc712d3:

    # th "Bandits?"
    th "Bandyci?" # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_934c1d5d:
    ...
    u_wanderer "Spokojnie. Nie chcę cię urazić." id exp_friendly_wanderers_934c1d5d # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_8da8bdd4:
    ...
    u_wanderer "Porozmawiajmy tam, inaczej jest zbyt niebezpiecznie." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_e273d62d:
    ...
    u_wanderer "Zauważyłem, że spacerujesz sam, pomyślałem, że może chcesz coś ode mnie kupić." # TL # Victorius - AI

# game/events/areas/bus/friendly_wanderers.rpy:88
translate polish exp_friendly_wanderers_first_4d7d3beb:

    # me "Are you a trader?"
    me "Jesteś handlarzem?" # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_2b62a45a:
    ...
    wanderer "Tak. Jesteśmy częścią Wędrowców." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_4c2a5ba2:
    ...
    me "To twoja społeczność?" # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_c63e17a8:
    ...
    wanderer "Tak! Możesz tak powiedzieć, ale składa się z niezależnych grup ludzi, którzy sobie pomagają, a nie z bardziej zorganizowanych struktur, które są w społecznościach." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_0ca9bbcd:
    ...
    me "Co masz na sprzedaż?" # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_b476c0c7:
    ...
    wanderer "Wszystko, czego możesz potrzebować! Materiały i jedzenie, czasami mam nawet rzeczy o bardziej... powiedzmy, nieziemskim charakterze. Widzisz tę dziewczynę za mną?" # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_cb318930:
    ...
    wanderer "To moja córka, jeśli zapłacisz wystarczająco, możesz z nią zrobić, co tylko chcesz." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_a0fd99f0:
    ...
    me "Sprzedajesz własną córkę?" # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_7a3e1c72:
    ...
    wanderer "Czasy są ciężkie, przyjacielu. Każdy musi pracować dla przetrwania najlepiej jak potrafi. Ma piękną twarz i ciało." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_first_d6d2213e:
    ...
    wanderer "Więc czym jesteś zainteresowany?" # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_trademenu_c30398ba:
    ...
    wanderer "Bardzo dobrze. Jestem pewien, że jeszcze się spotkamy, przyjacielu." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_bj_134743ef:
    ...
    "Nie odpowiada, zamiast tego zaczyna cię obciągać." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_bj_5d7e880b:
    ...
    "Nie rozumiesz, co próbuje powiedzieć." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_bj_97c71b29:
    ...
    "Zaczyna pracować nad twoim członkiem bardziej gorliwie." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_bj_e85fe1e3:
    ...
    me "Ahh, właśnie tak." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_sex_682e8abe:
    ...
    "Przyciskasz dziewczynę do ściany, gdy tylko się rozbiera." # TL # Victorius - AI

# game/events/areas/bus/friendly_wanderers.rpy:174
translate polish exp_friendly_wanderers_daughter_sex_bf35a75f:

    # girl "Please, fuck me."
    girl "Proszę, pieprz mnie." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_sex_f8088445:
    ...
    me "Nie musisz pytać dwa razy." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_sex_2d19b84d:
    ...
    "Zaczynasz ją ostro posuwać, wchodząc w nią bez większego oporu." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_sex_1875dbe8:
    ...
    girl "Mocniej, pieprz mnie mocniej." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_sex_06cf0faa:
    ...
    "Zrywasz spódnicę dziewczyny. Zostawiając ją nagą." id exp_friendly_wanderers_daughter_sex_06cf0faa # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_sex_3549f582:
    ...
    "Pieprzysz ją dziko, sprawiając, że krzyczy z rozkoszy." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_sex_fdccfc9f:
    ...
    # girl "Not inside!"
    girl "Nie do środka!" # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_sex_27c1c4ac:
    ...
    "Stajesz prosto, choć jesteś krótki oddech." # TL # Victorius - AI
...
translate polish exp_friendly_wanderers_daughter_sex_16aa113c:
    ...
    me "To była bardzo potrzebna odskocznia." # TL # Victorius - AI
...
translate polish strings:
    ...
    new "Wędrowny Handlarz" # TL # Victorius - AI

    # game/events/areas/bus/friendly_wanderers.rpy:73
    old "What do you want?"
    new "Czego chcesz?" # TL # Victorius - AI

    # game/events/areas/bus/friendly_wanderers.rpy:73
    old "What the fuck do you want?"
    new "Czego do cholery chcesz?" # TL # Victorius - AI
    ...
    new "Składają się z niezależnych grup ludzi, którzy sobie pomagają." # TL # Victorius - AI

    # game/events/areas/bus/friendly_wanderers.rpy:113
    old "Your daughter"
    new "Twoja córka" # TL # Victorius - AI

    # game/events/areas/bus/friendly_wanderers.rpy:121
    old "Sex (20 {image=capTextImg_menu})"
    new "Seks (20 {image=capTextImg_menu})" # TL # Victorius - AI

    # game/events/areas/bus/friendly_wanderers.rpy:121
    old "Blowjob (8 {image=capTextImg_menu})"
    new "Obciąganie (8 {image=capTextImg_menu})" # TL # Victorius - AI

    # game/events/areas/bus/friendly_wanderers.rpy:121
    old "I changed my mind"
    new "Zmieniłem zdanie" # TL # Victorius - AI
