...
translate polish d_Millionaire_2_583e680c:
    ...
    secretary "Przybył pan Aharon, czy mam go zaprosić?{#mtl}{#tl}"
...
translate polish d_Millionaire_2_menu1_c0b45992:
    ...
    secretary "Niewiele proszę pana, wiem tylko, że to VIP.{#mtl}{#tl}"
...
translate polish d_Millionaire_2_menu1_3d10a40f:
    ...
    secretary "Oczywiście wiem też, że to pański przyjaciel, sir.{#mtl}{#tl}"
...
translate polish d_Millionaire_2_menu1_a92ae4fc:
    ...
    th "Mój przyjaciel? Czy miałem przyjaciela o imieniu Aharon?{#mtl}{#tl}"
...
translate polish d_Millionaire_2_bj_f3aacdf8:
    ...
    me "Pozwoliliśmy mu czekać wystarczająco długo, zaprosiliśmy go do środka.{#mtl}{#tl}"
...
translate polish d_Millionaire_2_part2_70a0e022:
    ...
    "Po chwili wraca twoja sekretarka, tym razem nie sama.{#mtl}{#tl}"
...
translate polish d_Millionaire_2_part2_de86f8b2:
    ...
    me "Panie Aaronie! Jak się masz? Miło cię widzieć.{#mtl}{#tl}"
...
translate polish d_Millionaire_2_part2_52f03cb9:
    ...
    me "A teraz, czy możesz mi powiedzieć, jaki był powód twojej wizyty?{#mtl}{#tl}"
...
translate polish d_Millionaire_2_part2_77d3d3e5:
    ...
    aharon "Gdybyś miał szansę osiągnąć wszystko, o czym zawsze marzyłeś, spędzić wieczność z ludźmi, których kochasz, gdybyś miał szansę być szczęśliwym..{#mtl}{#tl}"
...
translate polish d_Millionaire_2_part2_a80f6b69:
    ...
    aharon "Jeśli tego nie zrobisz, zostaniesz sam na zawsze, wszyscy ci, których kochasz, odejdą i zapomną o tobie.{#mtl}{#tl}"
...
translate polish d_Millionaire_2_part2_699be028:
    ...
    aharon "Ale zrobienie tego oznaczałoby, że twoi bliscy musieliby żyć w fałszywym szczęściu, w świecie stworzonym z kłamstwa.{#mtl}{#tl}"
...
translate polish d_Millionaire_2_part2_81137867:
    ...
    aharon "Nie bardzo się różnimy..{#mtl}{#tl}"
...
translate polish d_Millionaire_2_menu1_8004a140:
    ...
    th "Mój przyjaciel? Czy mam przyjaciela o imieniu Aharon?{#mtl}{#tl}"
