...
translate polish strings:
    ...
    # game/combat/cards/CardManager.rpy:1337
    old "After {{{{b}}}}{X}{{{{\b}}}} turns:{{{{i}}}}"
    new "After {{{{b}}}}{X}{{{{\b}}}} turns:{{{{i}}}}"

    # game/combat/cards/CardManager.rpy:1361
    old "Have {{{{{c}}}}}{X}{{{{/{c}}}}}:{{{{i}}}}"
    new "Have {{{{{c}}}}}{X}{{{{/{c}}}}}:{{{{i}}}}"

    # game/combat/cards/CardManager.rpy:1388
    old "Consume {{{{{c}}}}}{X}{{{{/{c}}}}}:{{{{i}}}}"
    new "Consume {{{{{c}}}}}{X}{{{{/{c}}}}}:{{{{i}}}}"

    # game/combat/cards/CardManager.rpy:1410
    old "Use {{color={rar}}{X}{{/color}:{{i}}"
    new "Use {{color={rar}}{X}{{/color}:{{i}}"

    # game/combat/cards/CardManager.rpy:1431
    old "Error when modding description. Card: {}, Description: {}"
    new "Error when modding description. Card: {}, Description: {}"

    # game/combat/cards/CardManager.rpy:1454
    old "Error when modding description. Card: {}, Description: {}, Update: {}"
    new "Error when modding description. Card: {}, Description: {}, Update: {}"

    # game/combat/cards/CardManager.rpy:1609
    old "{} random enemies"
    new "{} random enemies"

    # game/combat/cards/CardManager.rpy:1610
    old "{} random allies"
    new "{} random allies"

    # game/combat/cards/CardManager.rpy:1676
    old "unavoidable"
    new "unavoidable"

    # game/combat/cards/CardManager.rpy:1680
    old "unblockable"
    new "unblockable"

    # game/combat/cards/CardManager.rpy:1684
    old "pure"
    new "pure"

    # game/combat/cards/CardManager.rpy:1688
    old "true"
    new "true"

    # game/combat/cards/CardManager.rpy:1704
    old " {} times."
    new " {} times."

    # game/combat/cards/CardManager.rpy:1709
    old "Leech {:.0%} damage as health."
    new "Leech {:.0%} damage as health."

    # game/combat/cards/CardManager.rpy:1712
    old "Leech {} health."
    new "Leech {} health."

    # game/combat/cards/CardManager.rpy:1715
    old "Die if attack fails to kill the target."
    new "Die if attack fails to kill the target."

    # game/combat/cards/CardManager.rpy:1731
    old "{} random allies'"
    new "{} random allies'"

    # game/combat/cards/CardManager.rpy:1747
    old "{} random enemies'"
    new "{} random enemies'"

    # game/combat/cards/CardManager.rpy:1772
    old "Unknown card description: {}"
    new "Unknown card description: {}"

    # game/combat/cards/CardManager.rpy:1781
    old "Discard all cards. Draw the same amount of cards{}."
    new "Discard all cards. Draw the same amount of cards{}."

    # game/combat/cards/CardManager.rpy:1785
    old "Discard all cards."
    new "Discard all cards."

    # game/combat/cards/CardManager.rpy:1788
    old "Discard all cards. Draw {} cards."
    new "Discard all cards. Draw {} cards."

    # game/combat/cards/CardManager.rpy:1842
    old "Being"
    new "Being"
