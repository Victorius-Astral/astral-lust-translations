...
translate polish room_lobby_counter_dd5952c9:
    ...
    "Skarbiec umożliwia przechowywanie materiałów i kart wewnątrz. Nie znikną po śmierci. Może przechowywać 25 przedmiotów i 2 karty." # TL # Victorius - AI
...
translate polish room_lobby_counter_89a2301a:
    ...
    "Budowa kosztuje 8 drewna, 8 kamienia i 5 metalu. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_a7a005e4:
    ...
    "Skarbiec zbudowany pomyślnie. Możesz uzyskać do niego dostęp z kuferka w swoim pokoju." # TL # Victorius - AI
...
translate polish room_lobby_counter_f159d6e1:
    ...
    "Siłownia pozwala na trenowanie ciała. Statystyki fizyczne obejmują siłę, zręczność i witalność. Te statystyki biorą udział w testach i zapewniają bonusy w walce." # TL # Victorius - AI
...
translate polish room_lobby_counter_0b1da42f:
    ...
    "Budowa kosztuje 5 drewna, 4 kamienia, 3 metalu i 3 tkaniny. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_9cb3b5f3:
    ...
    "Siłownia zbudowana pomyślnie." # TL # Victorius - AI
...
translate polish room_lobby_counter_d6fe7e01:

    # "Forge gives access to card removal and crafting. It's required to upgrade expansions."
    "Kowadło umożliwia usuwanie kart i rzemiosło. Jest wymagane do ulepszania rozszerzeń." # TL # Victorius - AI
...
translate polish room_lobby_counter_bbee43b5:
    ...
    "Budowa kosztuje 5 drewna, 5 kamienia, 15 metalu i 5 tkaniny. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_cb260629:
    ...
    "Kowadło zbudowane pomyślnie." # TL # Victorius - AI
...
translate polish room_lobby_counter_d8418d2c:
    ...
    "Pozwala na łapanie sukubów. Może być rozbudowane o pokój zabaw." # TL # Victorius - AI
...
translate polish room_lobby_counter_75290155:
    ...
    "Budowa kosztuje 7 drewna, 30 kamienia, 10 metalu i 12 tkaniny. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_912e68ef:
    ...
    "Loch zbudowany pomyślnie." # TL # Victorius - AI
...
translate polish room_lobby_counter_33e305ee:
    ...
    "Rozbudowa lochu. Pokój zabaw oferuje dodatkowe sceny H. Można tam wykonywać BDSM i zabawy w zwierzątka." # TL # Victorius - AI
...
translate polish room_lobby_counter_27dd2c0f:
    ...
    "Budowa kosztuje 16 drewna, 10 kamienia, 18 metalu i 20 tkaniny. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_84de8c4b:
    ...
    "Pokój zabaw zbudowany pomyślnie." # TL # Victorius - AI
...
translate polish room_lobby_counter_87e8404e:
    ...
    "Zwiększ pojemność do 50 przedmiotów, można przechowywać 4 karty." # TL # Victorius - AI
...
translate polish room_lobby_counter_a6fcdf90:
    ...
    "Ulepszenie kosztuje 12 drewna, 10 kamienia i 7 metalu. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_7e88de67:
    ...
    "Skarbiec został pomyślnie ulepszony." id room_lobby_counter_7e88de67 # TL # Victorius - AI
...
translate polish room_lobby_counter_2b5c2b8e:
    ...
    "Zwiększ pojemność do 75 przedmiotów, można przechowywać 6 kart." # TL # Victorius - AI
...
translate polish room_lobby_counter_e68153fb:
    ...
    "Ulepszenie kosztuje 20 kamienia i 10 metalu. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_7e88de67_1:
    ...
    "Skarbiec został pomyślnie ulepszony." id room_lobby_counter_7e88de67_1 # TL # Victorius - AI
...
translate polish room_lobby_counter_f49d91d9:
    ...
    "Zwiększ pojemność do 100 przedmiotów, można przechowywać 8 kart. Odblokowuje stację montażu broni." # TL # Victorius - AI
...
translate polish room_lobby_counter_80804fa8:
    ...
    "Ulepszenie kosztuje 25 kamienia i 20 metalu. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_7e88de67_2:
    ...
    "Skarbiec został pomyślnie ulepszony." id room_lobby_counter_7e88de67_2 # TL # Victorius - AI
...
translate polish room_lobby_counter_683bb028:
    ...
    "Zwiększ pojemność do 125 przedmiotów, można przechowywać 10 kart." # TL # Victorius - AI
...
translate polish room_lobby_counter_94a295df:
    ...
    "Ulepszenie kosztuje 20 metalu, 3 orczy stal i 3 złote samorodki. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_c9cb9b62:
    ...
    "Skarbiec został pomyślnie ulepszony." # TL # Victorius - AI
...
translate polish room_lobby_counter_f171c8e4:
    ...
    "Zwiększ pojemność do 150 przedmiotów, można przechowywać 12 kart. Waluta nie zajmuje już miejsca w skarbcu." # TL # Victorius - AI
...
translate polish room_lobby_counter_7935174e:
    ...
    "Ulepszenie kosztuje 8 złotych samorodków i 2 złote sztabki. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_fae2af3c:
    ...
    "Zwiększ pojemność do 350 przedmiotów {small}(+100%% miejsca na poziom){/small}, można przechowywać 14 kart." # TL # Victorius - AI
...
translate polish room_lobby_counter_f5802177:
    ...
    "Ulepszenie kosztuje 2 złote sztabki i 1 diament. Czy chcesz kontynuować?" # TL # Victorius - AI
...
translate polish room_lobby_counter_2919f262:
    ...
    "Zwiększ pojemność do 600 jednostek {small}(+100%% miejsca na poziom){/small}, można przechowywać 32 karty {small}(+100%% miejsca na poziom){/small}." # TL # Victorius - AI
...
translate polish room_lobby_counter_d2f6ffb2:
    ...
    "Ulepszenie kosztuje 40 kamienia, 40 metalu, 5 złotych samorodków, 3 złote sztabki, 3 diamenty i 2 orczy stal. Czy chcesz kontynuować?" # TL # Victorius - AI

# game/places/hotel/lobby/counter.rpy:311
translate polish room_lobby_counter_873b9e9f_12:
...
translate polish room_lobby_counter_3688fcdf_12:
...
translate polish room_lobby_counter_82a0b18b:
    ...
    "Zbuduj kowadło, aby ulepszać pokoje." # TL # Victorius - AI

translate polish strings:

    # game/places/hotel/lobby/counter.rpy:5
    old "Build next floor (30 Stone, 15 Wood, 15 Metal)"
    new "Zbuduj następne piętro (30 kamieni, 15 drewna, 15 metalu)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:5
    old "Build room"
    new "Zbuduj pokój" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:5
    old "Upgrade room"
    new "Ulepsz pokój" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:30
    old "Vault (8 Wood, 8 Stone, 5 Metal)"
    new "Skarbiec (8 drewna, 8 kamieni, 5 metalu)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:30
    old "Gym (5 Wood, 4 Stone, 3 Metal, 3 Cloth)"
    new "Siłownia (5 drewna, 4 kamienie, 3 metale, 3 tkaniny)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:30
    old "Forge (5 Wood, 5 Stone, 15 Metal, 5 Cloth)"
    new "Kowalnia (5 drewna, 5 kamieni, 15 metali, 5 tkanin)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:30
    old "Dungeon (7 Wood, 30 Stone, 10 Metal, 12 Cloth)"
    new "Loch (7 drewna, 30 kamieni, 10 metali, 12 tkanin)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:30
    old "Playroom (16 Wood, 10 Stone, 18 Metal, 20 Cloth)"
    new "Pokój zabaw (16 drewna, 10 kamieni, 18 metali, 20 tkanin)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:151
    old "Vault T2 (12 Wood, 10 Stone, 7 Metal)"
    new "Skarbiec T2 (12 drewna, 10 kamieni, 7 metali)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:151
    old "Vault T3 (20 Stone, 10 Metal)"
    new "Skarbiec T3 (20 kamieni, 10 metali)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:151
    old "Vault T4 (25 Stone, 20 Metal)"
    new "Skarbiec T4 (25 kamieni, 20 metali)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:151
    old "Vault T5 (20 Metal, 3 Orcish Steel, 3 Gold Nugget)"
    new "Skarbiec T5 (20 Metalu, 3 Orkowej Stali, 3 Złote Nuggety)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:151
    old "Vault T6 (8 Gold Nugget, 2 Gold Bar)"
    new "Skarbiec T6 (8 Złote Nuggety, 2 Złote Sztabki)" # TL # Victorius - AI

    # game/places/hotel/lobby/counter.rpy:151
    old "Vault T7 (2 Gold Bar, 1 Diamond)"
    new "Skarbiec T7 (2 Złote Sztabki, 1 Diament)" # TL # Victorius - AI
