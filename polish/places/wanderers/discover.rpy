...
translate polish discover_wanderers_part2_f4807aa2:
    ...
    th "Wygląda na to, że nie mam teraz wyboru.." # TL # Victorius - AI
...
translate polish discover_wanderers_win_3219fc3c:
    ...
    u_governor "Stąd, w pobliżu jest gniazdo, a wkrótce będzie ich tu tuzin." # TL # Victorius - AI

# game/places/wanderers/discover.rpy:46
translate polish discover_wanderers_win_2529f3eb:

    # me "Oh, shit. Alright, after you!"
    me "O cholera. Dobra, za tobą!" # TL # Victorius - AI
...
translate polish discover_wanderers_win_e7938e38:
    ...
    me "Znasz jakieś bezpieczne miejsce w pobliżu?" # TL # Victorius - AI
...
translate polish discover_wanderers_win_d5f8bdf6:
    ...
    u_governor "Oczywiście, wkrótce będzie noc, a widziałem, co się dzieje z ludźmi, którzy zostają tam na noc. Uwierz mi, nie chcę być jednym z nich." # TL # Victorius - AI

# game/places/wanderers/discover.rpy:53
translate polish discover_wanderers_win_16fce20f:

    # me "How fa.."
    me "Jak da.." # TL # Victorius - AI
...
translate polish discover_wanderers_win_a721d6b4:
    ...
    u_governor "Nazywamy to Abaddon! Nie martw się, nie będzie nas długo ścigać. Ono też boi się nocy." # TL # Victorius - AI

# game/places/wanderers/discover.rpy:63
translate polish discover_wanderers_win_28eb48a0:

    # me "What the hell is it?"
    me "Co to do cholery jest?" # TL # Victorius - AI
...
translate polish discover_wanderers_win_4cd32798:
    ...
    u_governor "Czas nas goni. Nie gadaj, biegnij!" # TL # Victorius - AI
...
translate polish discover_wanderers_win_df426f64:
    ...
    me "Czas na rozmowę, nie sądzisz? Wejdźmy do środka." # TL # Victorius - AI
...
translate polish discover_wanderers_win_618f7ce2:
    ...
    u_governor "Nie martw się, mgła nie może wejść do kryjówki." # TL # Victorius - AI
...
translate polish discover_wanderers_win_ab5eea35:
    ...
    u_governor "Też nie znam powodu, ale mgła unika tego miejsca. Unika wszystkich miejsc, w których ukrywają się ludzie, ale pewnie już to zauważyłeś." # TL # Victorius - AI

# game/places/wanderers/discover.rpy:86
translate polish discover_wanderers_win_effb048c:

    # me "But everything is in the open."
    me "Ale wszystko jest na otwartej przestrzeni." # TL # Victorius - AI

# game/places/wanderers/discover.rpy:87
translate polish discover_wanderers_win_4fb61e3a:

    # u_governor "It is."
    u_governor "Tak jest." # TL # Victorius - AI
...
translate polish discover_wanderers_win_b2f20a8e:
    ...
    me "To popieprzone.. Cała ta sytuacja jest popieprzona." # TL # Victorius - AI
...
translate polish discover_wanderers_win_09b8ddaf:
    ...
    governor "Rzeczywiście. Pozwól, że się przedstawię, jestem gubernatorem tej kryjówki." # TL # Victorius - AI
...
translate polish discover_wanderers_win_a265d218:
    ...
    governor "Chociaż my, wędrowcy, jesteśmy wolnymi duchami, to miejsce jest bezpiecznym schronieniem, które można wykorzystać do handlu i odpoczynku." # TL # Victorius - AI

# game/places/wanderers/discover.rpy:95
translate polish discover_wanderers_win_9204eebd:

    # me "Wanderers?"
    me "Wędrowcy?" # TL # Victorius - AI
...
translate polish discover_wanderers_win_ec126fe2:
    ...
    governor "Tak, wędrowcy to niezależne grupy ludzi, które pomagają sobie nawzajem przetrwać. Możesz myśleć o nas jako o frakcji." # TL # Victorius - AI
...
translate polish discover_wanderers_win_f991a53c:
    ...
    me "Ale jeśli wędrowcy to niezależne grupy ludzi, to co z kryjówką i gubernatorem?" # TL # Victorius - AI
...
translate polish discover_wanderers_win_dcdb7b98:
    ...
    governor "Haha, to miejsce jest jedyne w swoim rodzaju." # TL # Victorius - AI
...
translate polish discover_wanderers_win_8027bf6c:
    ...
    governor "Chciałem, żeby takie miejsce się pojawiło, więc zbudowałem je od podstaw. Później dołączyło więcej ludzi i rozrosło się do tego, czym jest teraz." id discover_wanderers_win_8027bf6c # TL # Victorius - AI
...
translate polish discover_wanderers_win_5331fc6c:
    ...
    governor "To wolny punkt handlowy i schronisko. To nie jest potrzebująca grupa, ale możesz pomóc, gdzie chcesz. Możesz też w każdej chwili odejść." # TL # Victorius - AI
...
translate polish discover_wanderers_win_3f14e1ac:
    ...
    me "Rozumiem. Myślę, że teraz rozumiem. Jak więc mam cię nazywać?" # TL # Victorius - AI
...
translate polish discover_wanderers_win_cf3a6cd0:
    ...
    th "Co ja mam z nimi zrobić?" # TL # Victorius - AI
...
translate polish discover_wanderers_win_9c3fc517:
    ...
    governor "Szkoda, że nie widzisz swojej twarzy!" # TL # Victorius - AI

# game/places/wanderers/discover.rpy:131
translate polish discover_wanderers_win_12190c3a:

    # me "Haha.. Sorry.."
    me "Haha.. Przepraszam.." # TL # Victorius - AI
...
translate polish discover_wanderers_win_c5d28f49:
    ...
    governor "To nasza lokalna waluta. Jest akceptowana przez wszystkich wędrowców." # TL # Victorius - AI

# game/places/wanderers/discover.rpy:135
translate polish discover_wanderers_win_225ecd31:

    # me "Oh, they will be useful then."
    me "Och, więc będą przydatne." # TL # Victorius - AI
...
translate polish discover_wanderers_win_acb81293:
    ...
    governor "Chodź, zaprowadzę cię do miejsca, w którym możesz się zatrzymać." # TL # Victorius - AI
...
translate polish discover_wanderers_win_d611ebaa:
    ...
    governor "To niewiele, ale lepsze niż nic. Pierwszy pokój jest twój." # TL # Victorius - AI
...
translate polish discover_wanderers_win_650ce5b6:
    ...
    governor "Możesz tu zostać w każdej chwili. Normalnie trzeba płacić za noc w motelu, ale dzisiaj uratowałeś mi skórę. Niech to zostanie między nami." # TL # Victorius - AI
...
translate polish discover_wanderers_win_b5c73233:
    ...
    me "Jasne, [governor], i dziękuję, doceniam twoją gościnność." # TL # Victorius - AI
...
translate polish discover_wanderers_win_636d1176:
    ...
    governor "To najmniej, co mogę zrobić. Dobra, mój przyjacielu, myślę, że obaj potrzebujemy odpoczynku. Porozmawiamy wkrótce." # TL # Victorius - AI
...
translate polish discover_wanderers_win_0ec0d987:
    ...
    me "Tak, to był bardzo męczący wieczór. Do zobaczenia." id discover_wanderers_win_0ec0d987 # TL # Victorius - AI

# game/places/wanderers/discover.rpy:155
translate polish discover_wanderers_win_6309f547:

    # governor "Sleep well, friend."
    governor "Śpij dobrze, przyjacielu." # TL # Victorius - AI
...
translate polish discover_wanderers_win_e4e5e3cf:
    ...
    th "Ahh.. To był naprawdę męczący dzień. Ten gość [governor] wydaje się całkiem miły. Myślę, że będziemy się dobrze dogadywać." id discover_wanderers_win_e4e5e3cf # TL # Victorius - AI
