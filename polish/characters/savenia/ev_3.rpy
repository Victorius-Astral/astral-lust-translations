...
translate polish savenia_3_part2_b614abcb:
    ...
    th "Ktoś ma problem z pająkiem, to okropne rzeczy..{#mtl}{#tl}"

# game/characters/savenia/ev_3.rpy:22
translate polish savenia_3_part2_c295f36f:

    # savenia "Die bastard!"
    savenia "Śpij draniu!{#mtl}{#tl}"
...
translate polish savenia_3_part2_7a88b645:
    ...
    savenia "Pieprzone śmieci.{#mtl}{#tl}"
...
translate polish savenia_3_part2_438a2177:
    ...
    th "Czy ona musi być taka uparta... To nie tak, że pozostanie w łóżku przez chwilę ją zabije.{#mtl}{#tl}"

# game/characters/savenia/ev_3.rpy:28
translate polish savenia_3_part2_debf8341:

    # th "I'm impressed, though."
    th "Jestem jednak pod wrażeniem.{#mtl}{#tl}"
...
translate polish savenia_3_part2_da79d808:
    ...
    me "Ach.. Nie możesz najpierw poczekać, aż twoja noga wydobrzeje?{#mtl}{#tl}"
...
translate polish savenia_3_part2_ffdd361f:
    ...
    savenia "Do tego czasu ktoś mógł już go zabrać.{#mtl}{#tl}"
...
translate polish savenia_3_part2_f7f95b92:
    ...
    me "Nie ma tam zbyt wielu ludzi. Właściwie, poza tobą, jeszcze nie widziałem, żeby ktoś używał roweru.{#mtl}{#tl}"
...
translate polish savenia_3_part2_0bb59dde:
    ...
    savenia "Rowery są głośne, a większość ludzi boi się słyszących potworów, ale ja się nie boję.{#mtl}{#tl}"

# game/characters/savenia/ev_3.rpy:54
translate polish savenia_3_part2_9bbe5648:

    # me "Whatever. Let's go back. You sho.."
    me "Cokolwiek. Wracajmy. jesteś..{#mtl}{#tl}"
...
translate polish savenia_3_part2_e8f1bc60:
    ...
    savenia "Dobra, nie marudź. Co sprawiło, że byłeś tak rozgoryczony w tak młodym wieku?{#mtl}{#tl}"
...
translate polish savenia_3_part2_9e97bd61:
    ...
    savenia "Prosisz o zbyt wiele..{#mtl}{#tl}"
...
translate polish savenia_3_part2_67b85240:
    ...
    me "Czy ktoś ci kiedyś powiedział, że jesteś irytujący?{#mtl}{#tl}"
...
translate polish savenia_3_part2_b5805bef:
    ...
    me "Nie martw się, jestem pewien, że w końcu go odzyskasz, ale jeśli chcesz go używać, musisz zadbać o swoją nogę.{#mtl}{#tl}"

# game/characters/savenia/ev_3.rpy:95
translate polish savenia_3_part2_333bc4fa:

    # savenia "I know.."
    savenia "Ja wiem..{#mtl}{#tl}"
...
translate polish savenia_3_part2_79934ff0:
    ...
    me "Zabijasz się teraz. Powinieneś wiedzieć, co oznacza taki upośledzenie na zewnątrz.{#mtl}{#tl}"
...
translate polish savenia_3_part2_c50a71df:
    ...
    savenia "Też się trzymaj.{#mtl}{#tl}"
