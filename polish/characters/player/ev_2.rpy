...
translate polish main_2_25ec53a9:
    ...
    "Podczas podróży przez mgłę zauważasz przed sobą humanoidalną sylwetkę. Myślisz o ukryciu się, ale postać już jest przy tobie." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:6
translate polish main_2_cd027b56:

    # th "Fast!"
    th "Szybko!" # TL # Victorius - AI
...
translate polish main_2_0fae2285:
    ...
    "To mężczyzna z sztyletem! Natychmiast zauważasz, że jest w nim coś nie tak." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:8
translate polish main_2_635432e5:

    # me "Hello."
    me "Cześć." # TL # Victorius - AI
...
translate polish main_2_7ab96f70:
    ...
    madman "Hahaha cześć chłopcze. Nie powinieneś tu być, to niebezpieczne." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:11
translate polish main_2_1179116b:

    # "The man's smile gives you the creeps."
    "Uśmiech mężczyzny przyprawia cię o dreszcze." # TL # Victorius - AI
...
translate polish main_2_531376b8:
    ...
    madman "Wciąż nie rozumiesz niebezpieczeństwa, które cię otacza [me]." # TL # Victorius - AI
...
translate polish main_2_993f0c12:
    ...
    "Po usłyszeniu swojego imienia czujesz, jakby świat wokół ciebie stał się ciemniejszy." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:22
translate polish main_2_7e3c5b78:

    # me "How do you know my name?!"
    me "Skąd znasz moje imię?!" # TL # Victorius - AI
...
translate polish main_2_a2597142:
    ...
    madman "Nie ma potrzeby się martwić chłopcze. My haha wszyscy znamy twoje imię hahaha." # TL # Victorius - AI
...
translate polish main_2_9146a33c:
    ...
    madman "Hahaha tylko nędznym robakiem podążającym za przeznaczeniem zapisanym przez Nich." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:27
translate polish main_2_d9ab78d5:

    # me "Are you some kind of priest?"
    me "Jesteś jakimś kapłanem?" # TL # Victorius - AI
...
translate polish main_2_4cc6f041:
    ...
    madman "Kapłanem? Nie.. Dla Nich nie możemy być niczym więcej niż robakami. Dla Nich jesteśmy tylko sługami, żyjącymi i umierającymi dla Ich woli." # TL # Victorius - AI
...
translate polish main_2_8ffb0486:
    ...
    "Cienie stają się jeszcze ciemniejsze, jakby ożywały. Twój instynkt przetrwania mówi ci, żeby uciekać, ale nie możesz się ruszyć. Twoje ciało jest zamrożone, jakby było odlane ze stali." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:32
translate polish main_2_203a79a4:

    # me "T-Then w-what do you want?"
    me "T-To czego chcesz?" # TL # Victorius - AI
...
translate polish main_2_c766eeae:
    ...
    madman "Kiedy przynieśliśmy Jego wolę do rzeczywistości, nie spodziewaliśmy się, że wszystko potoczy się w ten sposób." # TL # Victorius - AI
...
translate polish main_2_abbd13d5:
    ...
    th "Kult!!! On jest jednym z tych szaleńców! Muszę uciekać, TERAZ!" # TL # Victorius - AI
...
translate polish main_2_41af3537:
    ...
    "Chcesz uciec z całej siły, ale bez względu na to, co robisz, nie możesz nawet odwrócić wzroku." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:36
translate polish main_2_c0d13d30:

    # th "I need to find a way out of this!"
    th "Muszę znaleźć wyjście z tego!" # TL # Victorius - AI
...
translate polish main_2_1fcc7b82:
    ...
    me "N-Nie wiedzieliście, że nadejdzie Koniec? Rozsiewaliście plotki o tym długo przed tym, jak się wydarzył." # TL # Victorius - AI
...
translate polish main_2_26c6823c:
    ...
    "Po wspomnieniu przywódcy kultu, szaleniec zdaje się przypominać sobie coś strasznego i wpada w histerię. Jego tragiczny śmiech przyprawia cię o dreszcze." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:53
translate polish main_2_90f32666:

    # me "W-Wait! S-Stop! We can talk!"
    me "C-Czekaj! Z-Zatrzymaj się! Możemy porozmawiać!" # TL # Victorius - AI
...
translate polish main_2_4b194e9c:
    ...
    "Cios, którego się spodziewasz, nigdy nie nadchodzi, zamiast tego podcina sobie gardło, spryskując cię krwią." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:58
translate polish main_2_04bc8a81:

    # th "H-He just killed h-himself."
    th "O-On właśnie się zabił." # TL # Victorius - AI
...
translate polish main_2_14b212db:
    ...
    "Po chwili odzyskujesz kontrolę nad swoim ciałem i uciekasz z miejsca w przerażeniu. Biegniesz ile sił, w końcu docierając do bezpiecznego hotelu." # TL # Victorius - AI
...
translate polish main_2_fdbd976a:
    ...
    "Wpadłeś do hotelu, szokując [lexi], i natychmiast poszedłeś pod prysznic, aby zmyć krew z siebie." # TL # Victorius - AI
...
translate polish main_2_c705100b:
    ...
    "Chwilę później [lexi] wraca, niosąc czysty zestaw ubrań." # TL # Victorius - AI
...
translate polish main_2_d3c48893:
    ...
    "[lexi] zdaje się nie zauważać, że jesteś nagi, oglądając cię od góry do dołu, sprawdzając, czy nie masz żadnych obrażeń." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:86
translate polish main_2_bd8026da:

    # me "I'm fine [lexi]."
    me "W porządku [lexi]." # TL # Victorius - AI
...
translate polish main_2_31ea497e:
    ...
    lexi "Dobrze, ale jeśli będziesz chciał porozmawiać, wiesz gdzie mnie znaleźć." # TL # Victorius - AI

# game/characters/player/ev_2.rpy:89
translate polish main_2_538ea2fc:

    # me "I know. Thanks."
    me "Wiem. Dzięki." # TL # Victorius - AI
...
translate polish main_2_0e11d432:
    ...
    "Nie mówiąc nic więcej, zostawia cię samego. Po długim prysznicu wracasz do swojego pokoju." # TL # Victorius - AI

translate polish strings:

    # game/characters/player/ev_2.rpy:93
    old "Me"
    new "Me" # TL # Victorius - AI
    ...
    new "Spotkałem kultystę. Znał moje imię. Zadziwiająco powiedział, że nie wiedzieli, jak będzie wyglądał Koniec; zostali oszukani przez swojego przywódcę. Niemniej jednak, to spotkanie mnie przeraża. Kultysta popełnił samobójstwo po pomyśleniu o przywódcy kultu, jak bardzo przerażający on jest?" # TL # Victorius - AI
