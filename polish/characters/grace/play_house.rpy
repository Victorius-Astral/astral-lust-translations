...
translate polish grace_play_house_75c58c44:
    ...
    me "Wezmę to za tak." # TL # Victorius - AI
...
translate polish grace_play_house_454c8579:
    ...
    grace "Będziemy grać cały dzień, prawda? Prawda?" # TL # Victorius - AI
...
translate polish grace_play_house_eaff2be8:
    ...
    th "Nie chciałem spędzić aż tyle czasu... ale nie mogę powiedzieć 'nie' tym oczom." # TL # Victorius - AI

# game/characters/grace/play_house.rpy:25
translate polish grace_play_house_2e0ad989:

    # me "Of course [grace], of course. Go change."
    me "Oczywiście [grace], oczywiście. Idź się przebrać." # TL # Victorius - AI
...
translate polish grace_play_house_change_8e56d88d:
    ...
    me "Bo jesteś piękna." # TL # Victorius - AI
...
translate polish grace_play_house_change_45aeff41:
    ...
    grace "Wciąż jednak nie rozumiem." # TL # Victorius - AI
...
translate polish grace_play_house_change_657c79e7:
    ...
    me "Twoje ciało jest dorosłe, ale twój umysł jest wciąż zbyt niewinny i beztroski." # TL # Victorius - AI
...
translate polish grace_play_house_change_5b0c8ad1:
    ...
    grace "Ale naprawdę jestem dorosła. Przysięgam!" # TL # Victorius - AI
...
translate polish grace_play_house_nochange_5067c278:
    ...
    th "To do niej niepodobne, by tak powiedzieć..." # TL # Victorius - AI
...
translate polish grace_play_house_changed_d3362501:
    ...
    me "Kto będzie kim?" # TL # Victorius - AI
...
translate polish grace_play_house_changed_03abe10f:
    ...
    grace "Ja będę Autumn. Ty zagraj jako [teddy] i Gracie." # TL # Victorius - AI
...
translate polish grace_play_house_changed_4c1831d6:
    ...
    me "Jesteś pewna, że nie chcesz zagrać również jako Gracie?" # TL # Victorius - AI
...
translate polish grace_play_house_changed_9ae780a4:
    ...
    # grace "I will try."
    grace "Spróbuję." # TL # Victorius - AI
...
translate polish grace_play_house_changed_a7361f33:
    ...
    me "To jest determinacja, którą powinnaś mieć, [grace]. Tak trzymaj." # TL # Victorius - AI
...
translate polish grace_play_house_changed_3c5ae085:
    ...
    "Autumn" "Cześć, [teddy]. Witaj w domu." # TL # Victorius - AI
...
translate polish grace_play_house_changed_95e796cd:
    ...
    me "To całkiem sztywne powitanie [grace]." # TL # Victorius - AI
...
translate polish grace_play_house_changed_49c8a9e0:
    ...
    "[teddy]" "Hej żono. Jak ci minął dzień?" # TL # Victorius - AI
...
translate polish grace_play_house_changed_43f1a48c:
    ...
    "Gracie" "Czy pomożesz mi z zadaniem domowym?" # TL # Victorius - AI
...
translate polish grace_play_house_changed_5ba2d9dd:
    ...
    th "Czy ona wie o zadaniu domowym?" # TL # Victorius - AI
...
translate polish grace_play_house_changed_ab95d167:
    ...
    "[teddy]" "Tak, powiedziałem, żeby dawać. Nie martw się, tata jest mądry." # TL # Victorius - AI
...
translate polish grace_play_house_changed_4a51ec8d:
    ...
    th "Zastanawiam się, czy zna mnożenie. Uczyła się w domu, powinna znać przynajmniej podstawy." # TL # Victorius - AI
...
translate polish grace_play_house_stupor_96ceb557:
    ...
    "Gracie" "Nie wiem... Mama mnie nauczyła." # TL # Victorius - AI
...
translate polish grace_play_house_stupor_8915b62d:
    ...
    th "Czy ona zna odpowiedź?" # TL # Victorius - AI
...
translate polish grace_play_house_stupor_4399682f:
    ...
    "Gracie" "W porządku, jeśli nie wiesz, tato. Myślę, że mama by mi pomogła, gdybym ją zapytała." # TL # Victorius - AI
...
translate polish grace_play_house_stupor_01a6ed0c:
    ...
    "Gracie" "W porządku tato, ja też jestem w tym kiepska." # TL # Victorius - AI
...
translate polish grace_play_house_question1_aaa76910:
    ...
    "Gracie" "Na pokazie psów spotykają się psy i ich właściciele. Razem mieli 62 głowy i 206 nóg. Ile było psów?" # TL # Victorius - AI
...
translate polish grace_play_house_question1_6629cbda:
    ...
    grace "Mama mnie tego nauczyła. Pozwól, że wyjaśnię." # TL # Victorius - AI
...
translate polish grace_play_house_question1_d2c0ae22:
    ...
    grace "Najpierw dzielimy nogi (206) przez dwa. Otrzymamy 103 pary nóg." # TL # Victorius - AI
...
translate polish grace_play_house_question1_03adeec6:
    ...
    grace "Jest 62 głowy. I każdy ma przynajmniej jedną parę nóg." # TL # Victorius - AI
...
translate polish grace_play_house_question1_aa1efbaf:
    ...
    grace "Robimy pary nóg minus głowy (103 - 62), i otrzymujemy 41. To są pozostałe pary nóg." # TL # Victorius - AI
...
translate polish grace_play_house_question1_10b2d224:
    ...
    grace "Każdy pies ma dwie pary nóg. Więc 41 zapasowych par nóg oznacza, że mamy 41 psów. A 62 głowy - 41 psów oznacza, że mamy 21 właścicieli." # TL # Victorius - AI
...
translate polish grace_play_house_question1_f7a59f07:
    ...
    grace "Możemy sprawdzić. 41 psów * 4 nogi = 164 nogi psów. 21 właścicieli * 2 nogi = 42 nogi właścicieli. 164 + 42 = 206 nóg." # TL # Victorius - AI
...
translate polish grace_play_house_question1_95a379f7:
    ...
    me "To jest poprawne. Dzięki za naukę." # TL # Victorius - AI
...
translate polish grace_play_house_question2_0eeb1763:
    ...
    "Gracie" "Mamy pudełko o szerokości 1 cm, długości 8 cm, wysokości 8 cm. Ile kul możemy przechować w środku, jeśli każda kula ma średnicę 1 cm." # TL # Victorius - AI
...
translate polish grace_play_house_question2_9b729887:
    ...
    me "Czemu nie? Ile kul się zmieści?" # TL # Victorius - AI
...
translate polish grace_play_house_question2_b93dc038:
    ...
    me "Jak to policzyłaś." # TL # Victorius - AI
...
translate polish grace_play_house_question2_90456959:
    ...
    grace "Cóż. Mamy pudełko o długości 8 cm. Możemy zmieścić 8 kul w pierwszym rzędzie. Potem możemy zmieścić tylko 7 kul w drugim rzędzie." # TL # Victorius - AI
...
translate polish grace_play_house_question2_724e7105:
    ...
    grace "Wyobraź to sobie. Możemy umieścić kule tylko pomiędzy innymi kulami." # TL # Victorius - AI
...
translate polish grace_play_house_question2_fa9187e6:
    ...
    grace "Trzeci rząd to znowu 8 kul, potem 7, 8, 7, 8, 7, 8 kul. Jeśli to policzymy, to 5*8 + 4*7 = 40 + 28 = 68 kul." # TL # Victorius - AI
...
translate polish grace_play_house_question2_a1375db3:
    ...
    me "Pudełko ma 8 cm wysokości, ale masz 9 rzędów kul. Czy nie powinno być 8 rzędów, jeśli kule mają średnicę 1 cm?" # TL # Victorius - AI
...
translate polish grace_play_house_question2_85cd6061:
    ...
    grace "Wcale nie. Jak już powiedziałam, wyobraź to sobie. Kiedy umieszczasz kule pomiędzy innymi kulami, nakładają się. Kule wypełniają luki między dolnym rzędem. Więc w rzeczywistości każdy rząd zajmuje mniej niż 1 cm wysokości." # TL # Victorius - AI
...
translate polish grace_play_house_question2_61a42408:
    ...
    me "Skąd wzięłaś te 0,866 cm?" # TL # Victorius - AI
...
translate polish grace_play_house_question2_e4078711:
    ...
    grace "Mama mi powiedziała. W każdym razie, możesz uzyskać tę odpowiedź, jeśli masz dobrą percepcję przestrzenną i wyobraźnię." # TL # Victorius - AI
...
translate polish grace_play_house_question2_8649be31:
    ...
    grace "Możesz spróbować zrobić to sam, jeśli mi nie wierzysz. Po prostu znajdź pudełko i kule." # TL # Victorius - AI
...
translate polish grace_play_house_question2_d88d858e:
    ...
    me "Wezmę to na słowo.." # TL # Victorius - AI
...
translate polish grace_play_house_question3_4cce9ca2:
    ...
    "Gracie" "Matka jest o 21 lat starsza od swojego dziecka. Za 6 lat dziecko będzie 5 razy młodsze od matki. Gdzie jest ojciec?" # TL # Victorius - AI
...
translate polish grace_play_house_question3_964ff828:
    ...
    me "Jaka jest poprawna odpowiedź? Bez względu na to, jak o tym myślę, to nie ma sensu." # TL # Victorius - AI

# game/characters/grace/play_house.rpy:274
translate polish grace_play_house_question3_ecd064fc:

    # grace "He's with the mother."
    grace "Jest z matką." # TL # Victorius - AI
...
translate polish grace_play_house_question3_f1b2a259:
    ...
    grace "Załóżmy, że wiek dziecka to x, więc wiek matki to x+21." # TL # Victorius - AI
...
translate polish grace_play_house_question3_8876fc0e:
    ...
    grace "Za sześć lat wiek dziecka będzie x+6, a wiek matki będzie x+27." # TL # Victorius - AI
...
translate polish grace_play_house_question3_dffde9b8:
    ...
    grace "Dziecko będzie 5 razy młodsze od matki, więc: x+27 = 5 * (x+6). Licząc to, x+27 = 5x + 30." # TL # Victorius - AI
...
translate polish grace_play_house_question3_985169f4:
    ...
    grace "Ostatecznie, po przeniesieniu x i liczb: \n x - 5x = 30 - 27 \n -4x = 3" # TL # Victorius - AI
...
translate polish grace_play_house_question3_263dfad0:
    ...
    grace "I odpowiedź brzmi, że dziecko ma teraz -3/4 roku. Czyli minus 9 miesięcy." # TL # Victorius - AI
...
translate polish grace_play_house_question3_766b90d2:
    ...
    me "Oh. Więc dziecko dopiero zostało poczęte.. To było sprytne." # TL # Victorius - AI
...
translate polish grace_play_house_question3_3ed87a4d:
    ...
    th "Albo właśnie uprawiają seks." # TL # Victorius - AI
...
translate polish grace_play_house_question3_c342b426:
    ...
    me "Totalnie do ciebie niepodobne.." # TL # Victorius - AI
...
translate polish grace_play_house_part2_4de6d66d:
    ...
    "Autumn" "Czy zrobiłaś zadanie domowe, Gracie?" # TL # Victorius - AI
...
translate polish grace_play_house_part2_60668f43:
    ...
    th "Czy ona mnie wyśmiewa?" # TL # Victorius - AI
...
translate polish grace_play_house_part2_9d55af36:
    ...
    "Audrey" "Teraz idź się pobawić sama. Mama musi porozmawiać z tatą." # TL # Victorius - AI

# game/characters/grace/play_house.rpy:312
translate polish grace_play_house_part2_e107b491:

    # "Gracie" "Okay!"
    "Gracie" "Dobrze!" # TL # Victorius - AI
...
translate polish grace_play_house_part2_6f6e33dc:
    ...
    "[teddy]" "Musimy coś z tym zrobić." # TL # Victorius - AI
...
translate polish grace_play_house_part2_c8d469aa:
    ...
    "[teddy]" "Tak, chodźmy do sypialni." # TL # Victorius - AI
...
translate polish grace_play_house_part2_0414d765:
    ...
    "Audrey" "Sypialnia? Nie do ośrodka adopcyjnego?" # TL # Victorius - AI
...
translate polish grace_play_house_part2_3ba8d501:
    ...
    me "Chcesz się dowiedzieć, jak powstają dzieci? Mogę ci pokazać." # TL # Victorius - AI
...
translate polish grace_play_house_part2_8b4af29d:
    ...
    me "Co to za rumieniec? Coś wiesz." # TL # Victorius - AI
...
translate polish grace_play_house_part2_e23a9c87:
    ...
    me "Co za niespodzianka. Mama cię nauczyła?" # TL # Victorius - AI
...
translate polish grace_play_house_part2_aba53e6e:
    ...
    me "Tak, po zajściu w ciążę zaczynają produkować mleko w piersiach, aby móc karmić swoje dziecko." # TL # Victorius - AI
...
translate polish grace_play_house_part2_848f081f:
    ...
    grace "To interesujące, choć bardzo dziwne." # TL # Victorius - AI
...
translate polish grace_play_house_part2_67ae1c4b:
    ...
    me "Psy czy koty. W zasadzie wszystkie ssaki produkują mleko." # TL # Victorius - AI
...
translate polish grace_play_house_part2_a4b54de6:
    ...
    me "Jak myślisz, skąd wzięli mleko, żeby napełnić karton?" # TL # Victorius - AI

# game/characters/grace/play_house.rpy:362
translate polish grace_play_house_part2_426bbbe3:

    # grace "From cows."
    grace "Od krów." # TL # Victorius - AI
...
translate polish grace_play_house_part2_93fea559:
    ...
    me "Nie musisz go lubić. To twoje dziecko ma je pić." # TL # Victorius - AI
...
translate polish grace_play_house_part2_60838160:
    ...
    grace "Czy nie mogę po prostu karmić go jogurtem?" # TL # Victorius - AI
...
translate polish grace_play_house_part2_3315f5fa:
    ...
    me "Są trudne części, ale większość uważa, że warto." # TL # Victorius - AI

# game/characters/grace/play_house.rpy:378
translate polish grace_play_house_part2_4fa6df8d:

    # grace "You too?"
    grace "Ty też?" # TL # Victorius - AI
...
translate polish grace_play_house_part2_10e98a7a:
    ...
    me "Żyjesz dzięki swojej matce, która cię urodziła, wychowała i karmiła. Więc powiedz mi. Czy warto?" # TL # Victorius - AI

# game/characters/grace/play_house.rpy:385
translate polish grace_play_house_part2_a3202632:

    # grace "I see. It makes sense."
    grace "Rozumiem. To ma sens." # TL # Victorius - AI
...
translate polish grace_play_house_part2_84649691:
    ...
    grace "Chociaż są pewne poświęcenia, warto. Może bycie matką nie jest takie złe, jak myślałam." # TL # Victorius - AI
...
translate polish grace_play_house_part2_c9282564:
    ...
    me "To nie jest trudne. Zasysam twoje sutki." # TL # Victorius - AI
...
translate polish grace_play_house_part2_bda96825:
    ...
    th "Oh dziewczyno, nie mogę powiedzieć 'nie', kiedy jestem zaproszony." # TL # Victorius - AI
...
translate polish grace_play_house_part2_dc7f48c6:
    ...
    grace "En. To przyjemne. Trochę." # TL # Victorius - AI
...
translate polish grace_play_house_part2_c656573c:
    ...
    grace "Czy możesz mnie pocałować na dobranoc?" # TL # Victorius - AI
...
translate polish strings:
    ...
    new "Spójrz, jak się zmienia" # TL # Victorius - AI

    # game/characters/grace/play_house.rpy:35
    old "No need, change quickly"
    new "Nie ma potrzeby, zmień się szybko" # TL # Victorius - AI

    # game/characters/grace/play_house.rpy:198
    old "mother"
    new "matka" # TL # Victorius - AI
    ...
    new "Na pokazie psów spotykają się psy i ich właściciele. Razem mieli 62 głowy i 206 nóg. Ile było psów?" # TL # Victorius - AI
    ...
    new "Mamy pudełko o szerokości 1 cm, długości 8 cm, wysokości 8 cm. Ile kul możemy przechować w środku, jeśli kula ma średnicę 1 cm." # TL # Victorius - AI
