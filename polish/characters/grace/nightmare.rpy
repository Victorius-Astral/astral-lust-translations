...
translate polish grace_nightmare_1a69ad5d:
    ...
    "Pukanie budzi cię ze snu.{#mtl}{#tl}"
...
translate polish grace_nightmare_part2_b90b4f54:
    ...
    grace "Nie chcesz mnie tutaj?{#mtl}{#tl}"
...
translate polish grace_nightmare_part2_d4869b17:
    ...
    me "To nie tak, Alice może porozmawiać z dziewczyną.{#mtl}{#tl}"
...
translate polish grace_nightmare_part2_852078f5:
    ...
    grace "Możesz mnie tam zabrać?{#mtl}{#tl}" nointeract
...
translate polish grace_nightmare_part2_7a0b015d:
    ...
    alice "Bez problemu. Mówiłem Ci. Zawsze możesz przyjść ze mną na nockę.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_00529add:
    ...
    me "W porządku. Chodź, przytulimy się.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_1b11674b:
    ...
    grace "W moim śnie.. Mama zniknęła i zostawiła mnie samą. Było ciemno i przerażająco.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_1a828917:
    ...
    me "To był tylko sen. Wszystko będzie dobrze.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_a53744f5:
    ...
    me "A teraz zapomnijmy o złych rzeczach. Chodź, czas na przytulanie.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_ec84d0f3:
    ...
    grace "Biegł za mną potwór. Złapał mnie i- i-{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_6e08ac32:
    ...
    me "Rozumiem i przepraszam. To był jednak tylko sen.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_1f90c0ce:
    ...
    me "Nie masz miejsca pod łóżkiem, nic się tam nie schowa.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_5a916d10:
    ...
    grace "A jeśli coś jest w środku?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_9914f0f3:
    ...
    grace "Może powinienem obudzić Alice, żeby cię chronić?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_7e729dc9:
    ...
    me "Nie przeszkadzaj jej. To tylko moja garderoba.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_6ab43c9d:
    ...
    "W końcu znalazłeś odwagę i zdecydowałeś się otworzyć drzwi.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_944faf4d:
    ...
    grace "Umm.. Zajrzysz do szafy?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_43c0f402:
    ...
    me "Zapomnijmy o tym. Co powiesz na przytulanie?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_a0b757f6:
    ...
    me "Nie myśl o tym, [grace]. Musisz walczyć ze swoimi lękami.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_e41ef23e:
    ...
    grace "Przyszedłem z tobą do łóżka i poprosiłem, żebyś sprawdził garderobę, tak jak ostatnim razem. Sprawdziłeś to.{#mtl}{#tl}"

# game/characters/grace/nightmare.rpy:229
translate polish grace_nightmare_part3_4159ff27:

    # me "And there was something inside?"
    me "A coś było w środku?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_d887a9e1:
    ...
    grace "Nie, był pusty. Byłem szczęśliwy. Poszliśmy spać. Kiedy się obudziłem, nigdzie cię nie było. Nigdy cię nie znaleźliśmy..{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_f0f532cc:
    ...
    me "Czy często masz koszmary?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_ae649623:
    ...
    grace "Mam je raz na kilka dni.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_3a05951e:
    ...
    grace "mmm Sypiam głównie z Alice, ale lubię też spać z Miną i Lexi.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_694a2b74:
    ...
    grace "Zawsze czuję się bezpiecznie i ciepło, kiedy mnie przytulają, a złe sny znikają.{#mtl}{#tl}"

# game/characters/grace/nightmare.rpy:263
translate polish grace_nightmare_part3_8209f4de:

    # me "Do you feel safe now?"
    me "Czy czujesz się teraz bezpiecznie?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_df183ffd:
    ...
    me "Haha, dobrze to słyszeć.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_3798f45b:
    ...
    th "Wydaje się [grace] bardzo mi ufa. To dobrze, ciężko pracowałem na to zaufanie.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_7f57ac7c:
    ...
    "Wkrótce jedyną rzeczą, którą możesz usłyszeć, jest cichy odgłos oddechu [grace].{#mtl}{#tl}"

# game/characters/grace/nightmare.rpy:277
translate polish grace_nightmare_part3_206ac5c8:

    # me "How adorable.."
    me "Jak uroczo..{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_8f823a96:
    ...
    "Zasypianie nie zajmuje dużo czasu.{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_7ff3e543:
    ...
    me "Dlaczego jednak czuję się mokra?{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_733c97a6:
    ...
    grace "Oczywiście do mojego pokoju.{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_c6b3e655:
    ...
    grace "Dziękuję, że pozwoliłeś mi zostać.{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_d3c090b3:
    ...
    me "Jasne, [grace]. Cieszę się, że mogę ci pomóc.{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_8613f421:
    ...
    me "Jaka śliczna, żywa dziewczyna.{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_9f94b2ae:
    ...
    me "W ogóle nie pasuje do tego zepsutego świata.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_ea0de456:
    ...
    "Budzi cię głośne skrzypienie drzwi.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_8456e0d1:
    ...
    th "Ten dźwięk... Dochodził zza moich pleców.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_831d4be4:
    ...
    "Gdy masz gęsią skórkę na plecach, tuż za tobą pojawiają się odgłosy kroków.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_a10dbe84:
    ...
    th "To nie jest moja wyobraźnia. Jest tu ktoś... To brzmi jak szpilki. kobieta?{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_0b6c9ba3:
    ...
    "Kroki zatrzymują się tuż za twoim łóżkiem, możesz poczuć na sobie czyjś wzrok. Możesz przysiąc, że usłyszałeś chichot tuż obok swojego ucha.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_menu_741bbedd:
    ...
    th "Co mam kurwa zrobić?{#mtl}{#tl}" nointeract
...
translate polish grace_nightmare_horror_menu_dfb9a757:
    ...
    me "Hej? Czy ktoś tam jest? [alice]?{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_menu_ff4f2237:
    ...
    "Czekasz chwilę, ale nikt ci nie odpowiada.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_menu_b0dcf46b:
    ...
    "Zamykasz oczy udając, że nic nie słyszysz i nie czujesz.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_menu_8c27f961:
    ...
    "Po godzinie twoje plecy są mokre od potu, a serce ma wrażenie, że zaraz wyskoczy ci z piersi.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_menu_bae95342:
    ...
    "Ale potem uczucie bycia obserwowanym zniknęło. Jakby go nigdy nie było.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_menu_9e60c288:
    ...
    "Znów słychać odgłosy przesuwanych drzwi szafy.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_menu_57791025:
    ...
    th "Lepiej po prostu zapomnieć o tym, co usłyszałem. Ciekawość może być niebezpieczna..{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_end_1585036d:
    ...
    "Kiedy tracisz przytomność i życie, odgłosy młota uderzającego w twoją czaszkę rozbrzmiewają, zanim wszystko powoli ucichnie.{#mtl}{#tl}"
...
translate polish strings:
    ...
    new "Porozmawiaj o tym, jak się z tego wyplątać{#mtl}{#tl}"
    ...
    # game/characters/grace/nightmare.rpy:395
    old "Look behind you"
    new "Oglądaj się za siebie{#mtl}{#tl}"

    # game/characters/grace/nightmare.rpy:395
    old "Try to ignore it, and return to sleep"
    new "Spróbuj to zignorować i ponownie zasnąć{#mtl}{#tl}"
