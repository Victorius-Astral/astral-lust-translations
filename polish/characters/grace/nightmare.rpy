...
translate polish grace_nightmare_part2_d4869b17:
    ...
    me "Nie o to chodzi, Alice może pogadać z tobą jak dziewczyna." # TL # Victorius - AI

# game/characters/grace/nightmare.rpy:54
translate polish grace_nightmare_part2_53a7a13d:

    # grace "But I don't want to talk."
    grace "Ale ja nie chcę rozmawiać." # TL # Victorius - AI
...
translate polish grace_nightmare_part2_852078f5:
    ...
    grace "Możesz mnie tam zaprowadzić?" nointeract # TL # Victorius - AI
...
translate polish grace_nightmare_part2_31442cbf:
    ...
    alice "Gracie? Wejdź, kochanie." # TL # Victorius - AI
...
translate polish grace_nightmare_part2_7a0b015d:
    ...
    alice "Nie ma sprawy. Mówiłam ci. Zawsze możesz przyjść na nocleg do mnie." # TL # Victorius - AI
...
translate polish grace_nightmare_part2_6ef951b1:
    ...
    # th "Time to go sleep."
    th "Czas iść spać." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_c76c69c7:
    ...
    me "O czym śniłaś?" # TL # Victorius - AI
...
translate polish grace_nightmare_part3_50680ccb:
    ...
    grace "Nie chcę o tym rozmawiać.." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_1b11674b:
    ...
    grace "W moim śnie.. Mama zniknęła i zostawiła mnie całkiem samą. Było ciemno i strasznie." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_392074ae:
    ...
    me "Musiała coś załatwić. Pamiętaj, twoja mama cię kocha." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_a53744f5:
    ...
    me "Teraz zapomnijmy o złych rzeczach. Chodź, czas na przytulanie." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_ec84d0f3:
    ...
    grace "Potwór biegł za mną.. Złapał mnie, i- i-" # TL # Victorius - AI
...
translate polish grace_nightmare_part3_6e08ac32:
    ...
    me "Rozumiem i przepraszam. To był jednak tylko sen." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_1f90c0ce:
    ...
    me "Nie masz miejsca pod łóżkiem, nic się tam nie schowa." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_a012a546:
    ...
    me "Poczujesz się lepiej, jeśli sprawdzę?" # TL # Victorius - AI
...
translate polish grace_nightmare_part3_7e729dc9:
    ...
    me "Nie kłopocz jej. To tylko moja szafa." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_6ab43c9d:
    ...
    "W końcu znalazłeś odwagę i zdecydowałeś się otworzyć drzwi." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_ac2eee1a:
    ...
    me "Co to było, do cholery?!" # TL # Victorius - AI
...
translate polish grace_nightmare_part3_6f753f36:
    ...
    grace "O czym mówisz? Coś się stało?" # TL # Victorius - AI
...
translate polish grace_nightmare_part3_43c0f402:
    ...
    me "Zapomnijmy o tym. Może się przytulimy?" # TL # Victorius - AI
...
translate polish grace_nightmare_part3_a0b757f6:
    ...
    me "Nie myśl o tym, [grace]. Musisz walczyć ze swoimi lękami." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_b95bf90a:
    ...
    me "Zamiast się martwić, jest coś lepszego do zrobienia. Chcesz się przytulić?" # TL # Victorius - AI

# game/characters/grace/nightmare.rpy:219
translate polish grace_nightmare_part3_5e837654:

    # grace "I dreamed about you."
    grace "Śniłam o tobie." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_cd9071f7:
    ...
    me "I to nazywasz koszmarem? Dzięki, chyba." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_e41ef23e:
    ...
    grace "Przyszłam spać z tobą i poprosiłam, żebyś sprawdził szafę jak ostatnim razem. Sprawdziłeś ją." # TL # Victorius - AI

# game/characters/grace/nightmare.rpy:225
translate polish grace_nightmare_part3_4159ff27:

    # me "And there was something inside?"
    me "I coś tam było?" # TL # Victorius - AI
...
translate polish grace_nightmare_part3_d887a9e1:
    ...
    grace "Nie, była pusta. Byłam szczęśliwa. Poszliśmy spać. Kiedy się obudziłam, nie było cię nigdzie. Nigdy cię nie znaleźliśmy.." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_f0f532cc:
    ...
    me "Czy często masz koszmary?" # TL # Victorius - AI
...
translate polish grace_nightmare_part3_3a05951e:
    ...
    grace "Mm. Najczęściej śpię z Alice, ale lubię też spać z Miną i Lexi." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_694a2b74:
    ...
    grace "Zawsze czuję się bezpiecznie i ciepło, kiedy mnie przytulają, a złe sny znikają." # TL # Victorius - AI

# game/characters/grace/nightmare.rpy:259
translate polish grace_nightmare_part3_8209f4de:

    # me "Do you feel safe now?"
    me "Czy teraz czujesz się bezpiecznie?" # TL # Victorius - AI
...
translate polish grace_nightmare_part3_df183ffd:
    ...
    me "Haha, miło to słyszeć." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_3798f45b:
    ...
    th "Wygląda na to, że [grace] bardzo mi ufa. To dobrze, ciężko pracowałem, żeby zdobyć to zaufanie." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_7f57ac7c:
    ...
    "Wkrótce jedyną rzeczą, którą słyszysz, jest cichy oddech [grace]." # TL # Victorius - AI

# game/characters/grace/nightmare.rpy:273
translate polish grace_nightmare_part3_206ac5c8:

    # me "How adorable.."
    me "Jakie to urocze.." # TL # Victorius - AI
...
translate polish grace_nightmare_part3_cd837ffa:
    ...
    me "Szkoda, że ma te sny. Czuję się źle z jej powodu." # TL # Victorius - AI

# game/characters/grace/nightmare.rpy:278
translate polish grace_nightmare_part3_c594f3d1:

    # me "Anyway, I should go sleep myself."
    me "W każdym razie, sam powinienem iść spać." # TL # Victorius - AI
...
translate polish grace_nightmare_part4_0c650e21:
    ...
    grace "Dlaczego mnie obudziłeś? Miałam świetny sen." # TL # Victorius - AI
...
translate polish grace_nightmare_part4_8c74e0e2:
    ...
    me "Śliniłaś się na mnie.." id grace_nightmare_part4_8c74e0e2 # TL # Victorius - AI
...
translate polish grace_nightmare_part4_c6b3e655:
    ...
    grace "Dziękuję, że pozwoliłeś mi zostać." # TL # Victorius - AI
...
translate polish grace_nightmare_part4_d3c090b3:
    ...
    me "Jasne, [grace]. Cieszę się, że mogłem ci pomóc." # TL # Victorius - AI
...
translate polish grace_nightmare_horror_ea0de456:
    ...
    "Głośny dźwięk skrzypiących drzwi budzi cię." # TL # Victorius - AI
...
translate polish grace_nightmare_horror_831d4be4:
    ...
    "Gdy gęsia skórka pokrywa twoje plecy, dźwięk kroków pojawia się tuż za tobą." # TL # Victorius - AI
...
translate polish grace_nightmare_horror_a10dbe84:
    ...
    th "To nie moja wyobraźnia. Ktoś tu jest.. To brzmi jak obcasy. Kobieta?" # TL # Victorius - AI
...
translate polish grace_nightmare_horror_0b6c9ba3:
    ...
    "Kroki zatrzymują się tuż za twoim łóżkiem, czujesz na sobie spojrzenie. Przysięgasz, że słyszałeś chichot tuż przy swoim uchu." # TL # Victorius - AI
...
translate polish grace_nightmare_horror_menu_741bbedd:
    ...
    th "Co do cholery powinienem zrobić?" nointeract # TL # Victorius - AI
...
translate polish grace_nightmare_horror_menu_dfb9a757:
    ...
    me "Hej? Czy ktoś tam jest? [alice]?" # TL # Victorius - AI
...
translate polish grace_nightmare_horror_menu_ff4f2237:
    ...
    "Czekasz minutę, ale nikt ci nie odpowiada." # TL # Victorius - AI
...
translate polish grace_nightmare_horror_menu_b0dcf46b:
    ...
    "Zamykasz oczy, udając, że nic nie słyszysz i nie czujesz." # TL # Victorius - AI
...
translate polish grace_nightmare_horror_menu_8c27f961:
    ...
    "Po godzinie twoje plecy są mokre od potu, a serce wydaje się, że zaraz wyskoczy z piersi." # TL # Victorius - AI
...
translate polish grace_nightmare_horror_menu_bae95342:
    ...
    "Ale potem, uczucie bycia obserwowanym zniknęło. Jakby nigdy go nie było." # TL # Victorius - AI
...
translate polish grace_nightmare_horror_menu_9e60c288:
    ...
    "Ponownie pojawiają się dźwięki poruszających się drzwi szafy." # TL # Victorius - AI
...
translate polish grace_nightmare_horror_menu_57791025:
    ...
    th "Lepiej zapomnieć o tym, co słyszałem. Ciekawość może być niebezpieczna.." # TL # Victorius - AI
