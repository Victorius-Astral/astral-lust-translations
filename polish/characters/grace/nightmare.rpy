...
translate polish grace_nightmare_1a69ad5d:
    ...
    "Stukanie budzi cię ze snu.{#mtl}{#tl}"
...
translate polish grace_nightmare_part2_d7248a2a:
    ...
    me "Rozumiem. nie martw się, to tylko sen.{#mtl}{#tl}"
...
translate polish grace_nightmare_part2_852078f5:
    ...
    grace "Czy możesz mnie tam zabrać?{#mtl}{#tl}" nointeract
...
translate polish grace_nightmare_part2_31442cbf:
    ...
    alice "Gracie? wejdź, kochanie.{#mtl}{#tl}"
...
translate polish grace_nightmare_part2_7a0b015d:
    ...
    alice "Nie ma sprawy. mówiłam ci, że zawsze możesz przyjść do mnie na noc.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_50680ccb:
    ...
    grace "Nie chcę o tym rozmawiać...{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_1b11674b:
    ...
    grace "We śnie... mama zniknęła i zostawiła mnie samą. było ciemno i strasznie.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_392074ae:
    ...
    me "Musiała mieć coś do zrobienia. pamiętaj, twoja mama cię kocha.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_a53744f5:
    ...
    me "Teraz zapomnijmy o złych rzeczach. chodź, czas na przytulanie.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_ec84d0f3:
    ...
    grace "Potwór gonił mnie... złapał mnie i... i...{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_6e08ac32:
    ...
    me "Rozumiem i przepraszam. to tylko sen, jednak.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_1f90c0ce:
    ...
    me "Nie ma miejsca pod łóżkiem, tam nic nie może się ukryć.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_a012a546:
    ...
    me "Czy poczujesz się lepiej, jeśli sprawdzę?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_7e729dc9:
    ...
    me "Nie zawracaj jej głowy. to tylko moja szafa.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_6ab43c9d:
    ...
    "W końcu zebrałaś odwagę i postanowiłaś otworzyć drzwi.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_ac2eee1a:
    ...
    me "Co do cholery się stało?!{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_6f753f36:
    ...
    grace "O czym mówisz? czy coś się stało?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_43c0f402:
    ...
    me "Zapomnijmy o tym. a może przytulimy się?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_a0b757f6:
    ...
    me "Nie myśl o tym, [grace]. musisz stawić czoła swoim lękom.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_b95bf90a:
    ...
    me "Jest coś lepszego do zrobienia niż martwić się. chcesz się przytulić?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_d887a9e1:
    ...
    grace "Dziewczyny są dobrymi przyjaciółkami.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_d8769c30:
    ...
    # grace "Mm!"
    grace "Haha, dobrze to słyszeć.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_3a05951e:
    ...
    grace "W każdym razie, powinienem też iść spać.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_694a2b74:
    ...
    grace "Nie zajmuje ci dużo czasu, aby zasnąć.{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_3798f45b:
    ...
    th "Dlaczego jednak czuję się mokro?{#mtl}{#tl}"
...
translate polish grace_nightmare_part3_4a0fbf65:
    ...
    # grace "You too!"
    grace "Dlaczego mnie obudziłeś? miałam świetny sen.{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_c6b3e655:
    ...
    grace "Głośne skrzypienie drzwi budzi cię.{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_d3c090b3:
    ...
    me "Ten dźwięk... pochodził zza mnie.{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_5021510c:
    ...
    # me "That was nice."
    me "Kiedy na twoim plecach pojawiają się gęsi, dźwięk kroków pojawia się tuż za tobą.{#mtl}{#tl}"

# game/characters/grace/nightmare.rpy:348
translate polish grace_nightmare_part4_548cdb3b:

    # grace "Alice told me guys like it."
    grace "To nie moja wyobraźnia. ktoś jest tutaj... to brzmi jak obcasy. kobieta?{#mtl}{#tl}"

# game/characters/grace/nightmare.rpy:349
translate polish grace_nightmare_part4_2daeab2b:

    # me "You didn't like it?"
    me "Kroki zatrzymują się tuż za twoim łóżkiem, czujesz spojrzenie spoczywające na tobie. przysięgasz, że słyszysz chichot tuż przy uchu.{#mtl}{#tl}"

# game/characters/grace/nightmare.rpy:355
translate polish grace_nightmare_part4_dae62df0:

    # grace "I did, hehe~"
    grace "Co do cholery mam zrobić?{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_69e8fca2:
    ...
    # me "Haha, bye."
    me "Czekasz minutę, ale nikt ci nie odpowiada.{#mtl}{#tl}"

# game/characters/grace/nightmare.rpy:364
translate polish grace_nightmare_part4_8613f421:

    # me "What a cute, lively girl."
    me "Zamykasz oczy, udając, że nie słyszysz i nie czujesz niczego.{#mtl}{#tl}"
...
translate polish grace_nightmare_part4_9f94b2ae:
    ...
    me "Po godzinie twoje plecy są przemoczone potem, a serce czujesz, że wypadnie ci z klatki piersiowej.{#mtl}{#tl}"

# game/characters/grace/nightmare.rpy:380
translate polish grace_nightmare_horror_48c1e588:

    # "*Creak*"
    "Ale potem uczucie bycia obserwowanym zniknęło. Jakby go tam nigdy nie było.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_8456e0d1:
    ...
    th "Dźwięk przesuwających się drzwi szafy pojawia się ponownie.{#mtl}{#tl}"

# game/characters/grace/nightmare.rpy:386
translate polish grace_nightmare_horror_53d369b6:

    # th "The wardrobe?"
    th "Cokolwiek tam się wygrzebało, wróciło do szafy.{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_a10dbe84:
    ...
    th "Lepiej zapomnieć o tym, co słyszałem. ciekawość może być niebezpieczna...{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_menu_9e60c288:
    ...
    "Dlaczego nie pójdziesz spać z alice?{#mtl}{#tl}"
...
translate polish grace_nightmare_horror_menu_2539b451:
    ...
    th "Sprawdź szafę{#mtl}{#tl}" nointeract
