...
translate polish speak_grace_1cb97f49:

    # th "Seems she's angry at me.."
    th "Wygląda na to, że jest na mnie zła.." # TL # Victorius - AI
...
translate polish speak_grace_fun_b50ba9c2:
    ...
    grace "Nie dostaniesz się do moich majtek!" # TL # Victorius - AI
...
translate polish speak_grace_fingering_9d2d3ac0:
    ...
    th "Zastanawiam się, czy bardziej cieszy ją róża, czy to, że bawię się jej kotkiem.." # TL # Victorius - AI

# game/characters/grace/speak.rpy:266
translate polish speak_grace_fingering_1ccc40b4:

    # me "Sorry, I don't have any."
    me "Przepraszam, nie mam żadnej." # TL # Victorius - AI
...
translate polish speak_grace_fingering_62b3f61a:
    ...
    th "O czym ona myśli?" # TL # Victorius - AI
...
translate polish speak_grace_fingering_6192f284:
    ...
    # th "I'm lost."
    th "Jestem zagubiony." # TL # Victorius - AI
...
translate polish speak_grace_fingering_c6e059ba:
    ...
    grace "Więc mimo że nie masz róży, nadal ci zapłacę. Żeby ci pomóc.. Musimy sobie pomagać, prawda?" # TL # Victorius - AI
...
translate polish speak_grace_fingering_24eb705e:
    ...
    grace "Więc możesz pobawić się moim kotkiem, nie potrzebuję, żebyś dał mi różę, pomagam ci." # TL # Victorius - AI
...
translate polish speak_grace_fingering_59acfe01:
    ...
    th "Spójrz na nią.. Prosi mnie, żebym ją palcował z takim poczuciem sprawiedliwości.. I sprawiła, że brzmi to jakby mi pomagała.." # TL # Victorius - AI
...
translate polish speak_grace_fingering_7150badd:
    ...
    th "Kto ją tego nauczył? Nie mów, że sama na to wpadła.. Jestem naprawdę pod wrażeniem." # TL # Victorius - AI
...
translate polish speak_grace_boobjob_96b66108:
    ...
    grace "Nie chcę się pobrudzić.." # TL # Victorius - AI
...
translate polish speak_grace_boobjob_7cbd3365:
    ...
    grace "Chcesz, żebym się przebrała?" # TL # Victorius - AI
...
translate polish speak_grace_flowers_269a6960:
    ...
    "Oboje szybko zaczynacie pracować." # TL # Victorius - AI
...
translate polish speak_grace_flowers_30262b93:
    ...
    grace "Pij, pij i rośnij tak duży jak ja~" # TL # Victorius - AI
...
translate polish speak_grace_flowers_b1e02715:
    ...
    "[grace] nuci i śpiewa dziwne piosenki pod nosem, podlewając kwiaty." # TL # Victorius - AI

# game/characters/grace/speak.rpy:351
translate polish speak_grace_flowers_db249b8e:

    # th "What a silly song.."
    th "Jaka głupia piosenka.." # TL # Victorius - AI
...
translate polish speak_grace_question1_d91dc239:
    ...
    grace "Pokojówka? Nikt mnie tak wcześniej nie nazywał." # TL # Victorius - AI
...
translate polish speak_grace_question1_1b1cdc4f:
    ...
    grace "Co robi programista?" # TL # Victorius - AI
...
translate polish speak_grace_question2_23e72364:
    ...
    me "Co mógłbym zrobić z tą informacją?" # TL # Victorius - AI
...
translate polish speak_grace_question2_b9914670:
    ...
    grace "Mama mówiła, że mężczyźni lubią młode dziewczyny jak ja. Oszukają i skrzywdzą mnie, więc muszę być ostrożna." # TL # Victorius - AI
...
translate polish speak_grace_question3_a38e9307:
    ...
    th "Chyba powinienem się tego spodziewać.." # TL # Victorius - AI
...
translate polish speak_grace_question_jack_ea6a034f:
    ...
    grace "Oh.. Był dla mnie miły od momentu, gdy się tu pojawiłam." # TL # Victorius - AI
...
translate polish speak_grace_question_jack_9303bab5:
    ...
    grace "Ale chciałabym, żeby mama też tu została, żeby go poznać.." # TL # Victorius - AI
...
translate polish speak_grace_question_jack_9abe26ea:
    ...
    me "Co masz na myśli? Wiem, że wolałabyś mieć ją tu przy sobie, ale żeby go poznać?" # TL # Victorius - AI
...
translate polish speak_grace_question_jack_db1198b3:
    ...
    grace "Po prostu pomyślałam, że byłoby miło.." # TL # Victorius - AI
...
translate polish speak_grace_question_jack_6b8c28f7:
    ...
    me "Myślisz, że by się dogadali?" # TL # Victorius - AI
...
translate polish speak_grace_question_jack_af8f55a9:
    ...
    grace "Myślę, że mama też by go polubiła. Cóż, odpowiadając na twoje pytanie, Jack po prostu wychodził i szukał jak Lexi." # TL # Victorius - AI
...
translate polish speak_grace_question_jack_836ff1d4:
    ...
    grace "Kiedy gotowałam dla niego. Zawsze chwalił moje jedzenie." # TL # Victorius - AI
...
translate polish speak_grace_question_jack_68f13cdb:
    ...
    me "To ma sens. Zastanawiałem się, jak miał szansę być dla ciebie miły, jeśli go unikałaś." # TL # Victorius - AI

# game/characters/grace/speak.rpy:481
translate polish speak_grace_question_jack_c9d6f63f:

    # grace "I didn't really mean to, but.."
    grace "Nie naprawdę chciałam, ale.." # TL # Victorius - AI
...
translate polish speak_grace_question_jack_55385ad2:
    ...
    me "Był mężczyzną, tak. Przynajmniej miał okazję jeść twoje przysmaki." # TL # Victorius - AI
...
translate polish speak_grace_question_jack_d4e25f43:
    ...
    grace "Mimo to, nie jestem pewna, dlaczego mama po prostu zostawiła mnie tu z mężczyzną.." # TL # Victorius - AI

# game/characters/grace/speak.rpy:491
translate polish speak_grace_question_jack_905b2ca2:

    # me "Yeah, that's weird."
    me "Tak, to dziwne." # TL # Victorius - AI
...
translate polish speak_grace_question_jack_92ff5187:
    ...
    me "Ale przynajmniej poznałaś dobrego mężczyznę." # TL # Victorius - AI
...
translate polish speak_grace_question_peed_d2d9ebea:
    ...
    grace "Nie próbuj znowu na mnie sikać. Albo znowu się zmoczysz." # TL # Victorius - AI

# game/characters/grace/speak.rpy:509
translate polish speak_grace_question_peed_685d0266:

    # me "Is that a threat?"
    me "To groźba?" # TL # Victorius - AI
...
translate polish speak_grace_apology_rose_01a0cb8d:
    ...
    me "Wiem, że tego chcesz." # TL # Victorius - AI
...
translate polish speak_grace_apology_rose_b7d6b3b0:
    ...
    me "[grace], róża. Żywa i piękna jak ty." # TL # Victorius - AI
...
translate polish speak_grace_apology_rose_730ffbec:
    ...
    me "Więc powinnaś ją wziąć, tym bardziej, nie pozwól, żeby wpadła w złe ręce." # TL # Victorius - AI
...
translate polish speak_grace_apology_b6616c50:
    ...
    me "Możesz przynajmniej na mnie spojrzeć?" # TL # Victorius - AI
...
translate polish speak_grace_apology_913b1252:
    ...
    me "Wiem. Zrobiłem źle, ale nie mogę się poprawić sam. Potrzebuję cię, żebyś uczyniła mnie lepszym człowiekiem." # TL # Victorius - AI
...
translate polish speak_grace_apology_960a60a5:
    ...
    me "Tak, nie mogę tego zrobić sam." # TL # Victorius - AI
...
translate polish speak_grace_apology_744a58bd:
    ...
    grace "Lexi powiedziała mi, że powinniśmy sobie pomagać." # TL # Victorius - AI

# game/characters/grace/speak.rpy:567
translate polish speak_grace_apology_1603e86f:

    # me "You see?"
    me "Widzisz?" # TL # Victorius - AI
...
translate polish speak_grace_apology_e0b768cd:
    ...
    grace "Dobrze, dam ci szansę, ale musisz ją cenić! [[{cha}Test charyzmy{/cha} {trust}zdany{/trust}]" # TL # Victorius - AI
...
translate polish speak_grace_apology_664443c7:
    ...
    # me "Thanks [grace]!"
    me "Dzięki [grace]!" # TL # Victorius - AI
...
translate polish speak_grace_apology_816d1fb8:
    ...
    grace "Więc, o czym chciałeś porozmawiać?" # TL # Victorius - AI
...
translate polish speak_grace_apology_8b75b555:
    ...
    me "Wszyscy popełniamy błędy. To, co zrobiłem, było tylko błędem." # TL # Victorius - AI

# game/characters/grace/speak.rpy:586
translate polish speak_grace_apology_10a50ae0:

    # grace "You're just bad."
    grace "Jesteś po prostu zły." # TL # Victorius - AI
...
translate polish speak_grace_apology_cffb0b45:
    ...
    grace "Zrobiłeś to, bo jesteś złośliwy, nie chcę z tobą rozmawiać. [[{cha}Test charyzmy{/cha} {bad}nieudany{/bad}]" # TL # Victorius - AI

# game/characters/grace/speak.rpy:589
translate polish speak_grace_apology_a586aebf:

    # th "Seems it won't be that easy."
    th "Wygląda na to, że to nie będzie takie łatwe." # TL # Victorius - AI

translate polish strings:

    # game/characters/grace/speak.rpy:9
    old "Give her a rose as an apology {#visible}"
    new "Daj jej różę jako przeprosiny {#visible}" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:27
    old "Tell her about the date"
    new "Powiedz jej o randce" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:27
    old "I need you to cook a dinner for me and Lexi"
    new "Potrzebuję, żebyś ugotowała kolację dla mnie i Lexi" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:27
    old "Do you like roses? {gold}(Story){/gold}"
    new "Czy lubisz róże? {gold}(Story){/gold}" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:27
    old "I've got a toy for you {gold}(Story){/gold}"
    new "Mam dla ciebie zabawkę {gold}(Story){/gold}" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:27
    old "Want me to help you with your flowers? {gold}(Story){/gold}"
    new "Chcesz, żebym pomógł ci z twoimi kwiatami? {gold}(Story){/gold}" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:27
    old "Want me to help you with your flowers? {trust}(Trust+){/trust}"
    new "Chcesz, żebym pomógł ci z twoimi kwiatami? {trust}(Zaufanie+){/trust}" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:27
    old "Do you want to play home again? {trust}(Trust+){/trust}{lust}(Lust+){/lust}"
    new "Chcesz znowu bawić się w dom? {trust}(Zaufanie+){/trust}{lust}(Pożądanie+){/lust}" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:27
    old "Do you need help with cleaning? {trust}(Trust+){/trust}"
    new "Potrzebujesz pomocy przy sprzątaniu? {trust}(Zaufanie+){/trust}" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:27
    old "Do you need help with cooking? {trust}(Trust+){/trust}"
    new "Potrzebujesz pomocy przy gotowaniu? {trust}(Zaufanie+){/trust}" # TL # Victorius - AI
    ...
    # game/characters/grace/speak.rpy:59
    old "Massage breasts"
    new "Masuj piersi" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:59
    old "Fingering"
    new "Palcowanie" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:59
    old "Boobjob"
    new "Lodzik" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:61
    old "Bunny >{#visible}"
    new "Króliczek >{#visible}" # TL # Victorius - AI
    ...
    new "Ty.. Ty.. nasikałaś na mnie.." # TL # Victorius - AI

    # game/characters/grace/speak.rpy:109
    old "How old are you?"
    new "Ile masz lat?" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:109
    old "Have you ever had a boyfriend?"
    new "Czy miałaś kiedyś chłopaka?" # TL # Victorius - AI
    ...
    new "Ugotuj kolację (Czas trwania: [graceTasks.cookDiner.duration]) {vit}(Zdrowie+){/vit}{trust}(Bufor+){/trust} {#visible}" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:206
    old "Standing"
    new "Stojąco" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:206
    old "Bed"
    new "Łóżko" # TL # Victorius - AI

    # game/characters/grace/speak.rpy:369
    old "She is the maid at the Jade Hotel. She cooks and cleans."
    new "Jest pokojówką w hotelu Jade. Gotuje i sprząta." # TL # Victorius - AI

    # game/characters/grace/speak.rpy:411
    old "She is 21 years old."
    new "Ona ma 21 lat." # TL # Victorius - AI
