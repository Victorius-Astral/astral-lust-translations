...
translate polish alice_1_9364b9d6:
    ...
    "Gdy masz zamiar otworzyć drzwi, słyszysz dziwne dźwięki dochodzące z wnętrza." # TL # Victorius - AI
...
translate polish alice_1_1_ec40802e:
    ...
    "Dziewczyna leży na kanapie.. Bawiąc się sobą.." # TL # Victorius - AI
...
translate polish alice_1_1_3bacd45d:
    ...
    "Słysząc jej słodkie jęki, z twoich ust wydobywa się ciche westchnienie. To nie uszło uwadze dziewczyny!" # TL # Victorius - AI
...
translate polish alice_1_1_66fe3ee0:
    ...
    "Dziewczyna patrzy na ciebie zszokowana, oboje patrzycie na siebie w milczeniu przez chwilę." # TL # Victorius - AI

# game/characters/alice/ev_1.rpy:59
translate polish alice_1_1_fcefa0e3:

    # u_alice "Get out!!"
    u_alice "Wynocha!!" # TL # Victorius - AI
...
translate polish alice_1_1_18563a57:
    ...
    "Nie zastanawiasz się dwa razy i natychmiast wychodzisz z jej pokoju, gdy właśnie zamykasz drzwi, słyszysz, jak na ciebie krzyczy." # TL # Victorius - AI

# game/characters/alice/ev_1.rpy:62
translate polish alice_1_1_2b1cfc68:

    # u_alice "Wait outside!"
    u_alice "Czekaj na zewnątrz!" # TL # Victorius - AI
...
translate polish alice_1_1_9e39cfd5:
    ...
    # th "Should I run?"
    th "Czy powinienem uciekać?" # TL # Victorius - AI
...
translate polish alice_1_1_e1923206:
    ...
    th "Cholera! Gdzie mam w ogóle uciekać. Chyba będę musiał stawić temu czoła." # TL # Victorius - AI

# game/characters/alice/ev_1.rpy:73
translate polish alice_1_1_2572a6ad:

    # th "It's not like there is a place to run to anyway."
    th "I tak nie ma gdzie uciekać." # TL # Victorius - AI
...
translate polish alice_1_2_5651ca6d:
    ...
    "Ogląda cię od góry do dołu." # TL # Victorius - AI
...
translate polish alice_1_2_07475d9e:
    ...
    alice "Hmmm.. {size=-20}nieźle.{/size} Jestem Alice. Następnym razem zapukaj." # TL # Victorius - AI

# game/characters/alice/ev_1.rpy:95
translate polish alice_1_2_8850b4e3:

    # th "Wait.. that's it?"
    th "Czekaj.. to wszystko?" # TL # Victorius - AI
...
translate polish alice_1_2_8ee83b15:
    ...
    "Patrząc na twoją najwyraźniej zszokowaną twarz, widzisz ślad figlarności w jej oczach." # TL # Victorius - AI

# game/characters/alice/ev_1.rpy:98
translate polish alice_1_2_661f2a87:

    # alice "What, you thought I would eat you?"
    alice "Co, myślałeś, że cię zjem?" # TL # Victorius - AI
...
translate polish alice_1_2_11791089:
    ...
    "Gdy zastanawiasz się, co powiedzieć, ona kontynuuje w zupełnie innym tonie." # TL # Victorius - AI
...
translate polish alice_1_2_1fcfaa2e:
    ...
    alice "Wpadłeś na niewinną małą dziewczynkę jak ja.." # TL # Victorius - AI

# game/characters/alice/ev_1.rpy:103
translate polish alice_1_2_811d26b4:

    # th "What?"
    th "Co?" # TL # Victorius - AI
...
translate polish alice_1_2_c31e4a0c:
    ...
    "Gdy znowu sprawia, że nie wiesz, co powiedzieć, zaczynasz czuć się bezsilny." # TL # Victorius - AI
...
translate polish alice_1_2_f0a9dfb9:
    ...
    "Czując się psychicznie zmęczony, wracasz do swojego pokoju na szybką drzemkę." # TL # Victorius - AI

translate polish strings:

    # game/characters/alice/ev_1.rpy:66
    old "Run!"
    new "Uciekaj!" # TL # Victorius - AI

    # game/characters/alice/ev_1.rpy:66
    old "Wait"
    new "Czekaj" # TL # Victorius - AI
    ...
    new "Kiedy spotkałem ją po raz pierwszy, masturbowała się. Przyłapała mnie, ale zamiast robić z tego aferę, powiedziała, że jestem jej winien przysługę. Wydaje się przebiegła i sprytna, Niebezpieczna kombinacja." # TL # Victorius - AI
