...
translate polish alice_11_5e930aad:
    ...
    alice "Tak, pewnie, bądź szczera, jesteś z siebie dumna, co nie?{#mtl}{#tl}"
...
translate polish alice_11_4e3af0ca:
    ...
    alice "Nie mówiłam o tobie, panie narcyzie. dwa zestawy wystarczą dla ciebie.{#mtl}{#tl}"
...
translate polish alice_11_64ec7548:
    ...
    alice "Lexi zdecydowanie potrzebuje czegoś nowego, mina też. grace sobie poradzi, ale mogłaby mieć więcej.{#mtl}{#tl}"
...
translate polish alice_11_5c0dfe33:
    ...
    me "Czy to nie jest za wcześnie w naszym związku na szantaż?{#mtl}{#tl}"
...
translate polish alice_11_09e44c27:
    ...
    alice "Jaki szantaż, obaj wiemy, kto najbardziej skorzysta na nowych strojach.{#mtl}{#tl}"
...
translate polish alice_11_c01d5466:
    ...
    alice "Hmm.. nie wiem, muszę je najpierw zaprojektować. to może trochę potrwać, więc pamiętaj, żeby wrócić, gdy będę gotowa.{#mtl}{#tl}" id alice_11_c01d5466

# game/characters/alice/ev_11.rpy:87
translate polish alice_11_8a815fb0:

    # me "Come back when you're ready? How would I know that?"
    me "Wrócić, gdy będziesz gotowa? jak mam to wiedzieć?{#mtl}{#tl}"

# game/characters/alice/ev_11.rpy:91
translate polish alice_11_aea25f1d:

    # alice "Read the changelog."
    alice "Przeczytaj changelog.{#mtl}{#tl}"
