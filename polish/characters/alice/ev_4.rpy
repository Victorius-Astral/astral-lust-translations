...
translate polish alice_4_4098db4f:
    ...
    "Gdy [alice] nadal obejmuje twoją męskość swoim miękkim, delikatnym ustami, czujesz niewyobrażalną przyjemność.{#mtl}{#tl}"
...
translate polish alice_4_7a7cdb4b:
    ...
    "Po tym wraca do twojej męskości.{#mtl}{#tl}"
...
translate polish alice_4_89025964:
    ...
    me "To wszystko, co chcesz powiedzieć? Nie żebym narzekał.{#mtl}{#tl}"
...
translate polish alice_4_eee7258e:
    ...
    "Ignoruje twoje pytanie i kontynuuje cię zaspokajać z jeszcze większym zapałem.{#mtl}{#tl}"
...
translate polish alice_4_55fb9cd8:
    ...
    th "Kurwa, to jakby być w niebie!{#mtl}{#tl}"
...
translate polish alice_4_1_5683bc63:
    ...
    "[alice] robi ci loda jeszcze bardziej namiętnie, doprowadzając cię na skraj!{#mtl}{#tl}"
...
translate polish alice_4_1_77cf2f99:
    ...
    "Czujesz się tak dobrze, że ledwo możesz myśleć trzeźwo.{#mtl}{#tl}"
...
translate polish alice_4_1_c69dd89e:
    ...
    "Słysząc, że dochodzisz, [alice] bierze cię jeszcze głębiej!{#mtl}{#tl}"
...
translate polish alice_4_1_366b9cf9:
    ...
    "Wygląda na to, że twoja ilość była zbyt duża dla [alice], bo wyraźnie się dławi.{#mtl}{#tl}"
...
translate polish alice_4_1_9a2d86a0:
    ...
    "[alice] pokazuje ci swoje puste usta i patrzy na ciebie oczekująco, jakby czekała na pochwałę.{#mtl}{#tl}"

# game/characters/alice/ev_4.rpy:107
translate polish alice_4_1_42d922c5:

    # th "She actually swallowed it all!"
    th "Naprawdę wszystko połknęła!{#mtl}{#tl}"
...
translate polish alice_4_1_409ae55d:
    ...
    th "Mogłaby się tak ze mną bawić częściej.. jak codziennie.{#mtl}{#tl}"
...
translate polish alice_4_1_9dcfa7da:
    ...
    "Na twoje słowa [alice] uroczo się dąsa, ale jest niezadowolona.{#mtl}{#tl}"
...
translate polish strings:
    ...
    new "Dobra dziewczynka, to było niesamowite!{#mtl}{#tl}"

    # game/characters/alice/ev_4.rpy:108
    old "Could be better"
    new "Mogłoby być lepiej{#mtl}{#tl}"
