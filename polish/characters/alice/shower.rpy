...
translate polish shower_alice_ea30ab2d:
    ...
    th "Jeśli zostanę tu dłużej, zauważy mnie.{#mtl}{#tl}"
...
translate polish shower_alice_f06e3081:
    ...
    th "Chyba nigdy więcej nie powinienem powiedzieć dziewczynie, że jest gruba.{#mtl}{#tl}"
...
translate polish shower_alice_a901fa57:
    ...
    alice "Dobrze. jeśli masz coś jeszcze do powiedzenia, to szybko. chcę wziąć prysznic.{#mtl}{#tl}"
...
translate polish shower_alice_07eb243a:
    ...
    "Nic nie powiedziała, zamiast tego zaczęła się bawić, opierając się o ścianę.{#mtl}{#tl}" id shower_alice_07eb243a
...
translate polish shower_alice_masturbate_be97a00c:
    ...
    me "Twoje jęki zawsze mnie doprowadzają do szaleństwa.{#mtl}{#tl}"
...
translate polish shower_alice_masturbate_1f291146:
    ...
    th "Może muszę zdobyć jej większe zaufanie, albo bardziej ją podniecić.{#mtl}{#tl}"
...
translate polish shower_alice_anal_f64eae46:
    ...
    "{color=#FF958F}[tes]{/color} Jej policzki zrobiły się głęboko czerwone, ale nie widać żadnych oznak odrzutu w jej wyrazie twarzy.{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_c164498d:
    ...
    me "Co powiesz na to, żeby go wyjąć?{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_73df1ec9:
    ...
    me "Boże, nie! kurwa. dziewczyno, nie chcę wiedzieć, co jest w tej twojej niebieskiej głowie.{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_2b371272:
    ...
    me "Powiem to bezpośrednio. ssij mnie, jednocześnie ruchając swojego dilda.{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_d7d3aba1:
    ...
    alice "Moglibyśmy ominąć zakłopotanie, gdybyś od samego początku była tak bezpośrednia.{#mtl}{#tl}" id shower_alice_dildo_bj_d7d3aba1
...
translate polish shower_alice_dildo_bj_17f73ef7:
    ...
    alice "Jestem trochę zaskoczony, kochanie. myśleć, że nie chciałabyś ruchać swojej małej dziewczynki~{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_1d7512e4:
    ...
    me "Cóż, daję ci szansę, żebyś ruchała zarówno siebie, jak i mnie jednocześnie.{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_59b7bc34:
    ...
    alice "Czy ssanie jest uważane za ruchanie ciebie?{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_ee79b7a1:
    ...
    me "Tak. naprawdę uwielbiam się moknąć, gdy mnie ssiesz.{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_7ee6e566:
    ...
    alice "Ale czy wiesz, że jesteś większym zboczencem ode mnie?{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_b2c3d45f:
    ...
    me "Cóż. jestem hojnym facetem, więc pozwolę ci na twoje.{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_f164847e:
    ...
    me "Ja też, jeszcze chwila.{#mtl}{#tl}" id shower_alice_dildo_bj_f164847e
...
translate polish shower_alice_dildo_bj_2708c06f:
    ...
    alice "Spójrzmy, jak razem skończymy, będzie tak gorąco~{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_e7c2fd75:
    ...
    me "Czy mogę skończyć w środku?{#mtl}{#tl}" id shower_alice_dildo_bj_e7c2fd75
...
translate polish shower_alice_dildo_bj_219d27c5:
    ...
    th "Czy mam skończyć w środku czy na zewnątrz?{#mtl}{#tl}" nointeract
...
translate polish shower_alice_dildo_bj_33222d7b:
    ...
    alice "Było tego dużo, tatusiu!~{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_7910bd31:
    ...
    me "Byłaś grzeczną dziewczynką, więc dałem ci dużą nagrodę.{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_3b8b759d:
    ...
    alice "Hehe~ to było bardzo zabawne!{#mtl}{#tl}"
...
translate polish shower_alice_dildo_bj_744a9b31:
    ...
    alice "No cóż, jesteśmy pod prysznicem, kochanie. spodziewałaś się czegoś innego?{#mtl}{#tl}"
...
translate polish shower_alice_after_sdb_249f0e51:
    ...
    th "Jej usta naprawdę smakują jak wiśnie.{#mtl}{#tl}" id shower_alice_after_sdb_249f0e51
...
translate polish shower_alice_after_sdb_c2e1f91a:
    ...
    me "Kocham cię też, [alice].{#mtl}{#tl}"
...
translate polish shower_alice_after_sdb_d82f158d:
    ...
    "Wy zostajecie w objęciach przez resztę prysznica, ciesząc się tym uczuciem.{#mtl}{#tl}"
...
translate polish strings:
    ...
    new "Pokryj jej twarz spermą.{#mtl}{#tl}"
