...
translate polish alice_7_1_fdc44ce5:
    ...
    alice "Wiesz co? mam pomysł. zagrajmy w grę.{#mtl}{#tl}"
...
translate polish alice_7_1_1420afa3:
    ...
    me "Jeśli odpowiem źle, zadasz mi to samo pytanie drugi raz?{#mtl}{#tl}"
...
translate polish al_7_me_23e68f81:
    ...
    alice "Znajdź mnie ponownie, gdy zmienisz zdanie.{#mtl}{#tl}"
...
translate polish al_7_me_cfe76ef9:
    ...
    alice "Możesz mi jednak coś dać.{#mtl}{#tl}"
...
translate polish al_7_questions_78b65674:
    ...
    alice "Wróć, gdy będziesz miał coś do zaoferowania.{#mtl}{#tl}"
...
translate polish al_7_questions_14137979:
    ...
    alice "Jakiego rodzaju drzewo można nosić w dłoni?{#mtl}{#tl}"
...
translate polish al_7_questions_6671e4cd:
    ...
    alice "Niektóre miesiące mają 31 dni, inne mają 30 dni. ile z nich ma 28 dni?{#mtl}{#tl}"

# game/characters/alice/ev_7.rpy:242
translate polish al_7_questions_d5b6cc22:

    # alice "Which room has no walls?"
    alice "Który pokój nie ma ścian?{#mtl}{#tl}"
...
translate polish al_7_questions_e5aef61a:
    ...
    alice "Tak, zacząłem się nad tobą litować jakiś czas temu.{#mtl}{#tl}"
...
translate polish al_7_questions_win_5a38e81b:
    ...
    me "Och, co się dzieje z twoją twarzą? czy wszystko w porządku?{#mtl}{#tl}"
...
translate polish al_7_questions_fail_6ae81f13:
    ...
    alice "Przegrywaj tak dalej, a będę łagodny dla ciebie.{#mtl}{#tl}"
...
translate polish al_7_questions_reward_1be97641:
    ...
    me "Co się dzieje z twoją twarzą?{#mtl}{#tl}"
...
translate polish al_7_questions_reward_98de0dd2:
    ...
    me "Co tym razem? znowu blowjob?{#mtl}{#tl}"
...
translate polish al_7_questions_reward_6a58dab5:
    ...
    alice "Nie, pomyślałam o czymś innym. połóż się.{#mtl}{#tl}"
...
translate polish al_7_questions_ask_39888bac:
    ...
    me "Nie, po prostu daję ci czas na przygotowanie nagród.{#mtl}{#tl}"
