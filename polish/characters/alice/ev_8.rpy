...
translate polish alice_8_54226dc9:
    ...
    "Po wejściu do łazienki wita cię cudowny widok.{#mtl}{#tl}"
...
translate polish alice_8_c063322e:
    ...
    th "Znowu na nią zerkam. Zastanawiam się, czy kiedyś mnie za to znienawidzi.{#mtl}{#tl}"
...
translate polish alice_8_5a73f1cc:
    ...
    "Nie trwa długo, zanim zda sobie sprawę, że nie jest sama.{#mtl}{#tl}"
...
translate polish alice_8_7e21126d:
    ...
    "Ku zaskoczeniu, używa rąk, by się zakryć.{#mtl}{#tl}"
...
translate polish alice_8_bbf2ab96:
    ...
    me "Od kiedy jesteś taka nieśmiała.{#mtl}{#tl}"
...
translate polish alice_8_3684eb43:
    ...
    alice "Wynoś się, zanim kopnę cię w jaja.{#mtl}{#tl}"
...
translate polish alice_8_755f1b67:
    ...
    me "Czy to nie ten, który wzięłaś z tego sklepu erotycznego?{#mtl}{#tl}"
...
translate polish alice_8_41ae283d:
    ...
    me "Więc czemu nagle jesteś taka nieśmiała? To nie pierwszy raz, kiedy widzę cię bawiącą się sama ze sobą.{#mtl}{#tl}"
...
translate polish alice_8_6513b521:
    ...
    "Nigdy wcześniej nie widziałeś jej takiej bezbronnej. Z jakiegoś powodu tym razem była naprawdę zawstydzona.{#mtl}{#tl}"
...
translate polish alice_8_a9e9f977:
    ...
    me "Hej, tylko żartowałem, co się z tobą dzieje dzisiaj?{#mtl}{#tl}"
...
translate polish alice_8_c2c1ae3e:
    ...
    me "[alice], byłaś jeszcze w liceum, kiedy świat się skończył. Szczerze, nie wiem, czemu jestem aż tak zaskoczony.{#mtl}{#tl}"
...
translate polish alice_8_42b27750:
    ...
    alice "Więc, nie myślisz, że jestem dziwna czy.. nie wiem.. po prostu..{#mtl}{#tl}"
...
translate polish alice_8_978fb13d:
    ...
    me "Lubię cię za to, kim jesteś. Jesteś mądra, zabawna i piękna. Prawie sprawiasz, że warto budzić się w czasie apokalipsy.{#mtl}{#tl}"
...
translate polish alice_8_bb114a05:
    ...
    alice "Powinieneś przestać marzyć o byciu moim facetem.{#mtl}{#tl}"

# game/characters/alice/ev_8.rpy:122
translate polish alice_8_c7a7618e:

    # me "As if I did."
    me "Jakbym to robił.{#mtl}{#tl}"
...
translate polish alice_8_part2_94b06af1:
    ...
    alice "Więc, wyjdziesz, czy mam cię wyrzucić.{#mtl}{#tl}"
...
translate polish alice_8_menu1_3f702ddf:
    ...
    "{color=#FF958F}[tes]{/color} Krew napływa jej do policzków, ale nie widzisz żadnych oznak odrzucenia w jej wyrazie twarzy.{#mtl}{#tl}"

# game/characters/alice/ev_8.rpy:164
translate polish alice_8_menu1_c2112f1d:

    # alice "A-Alright. Be gentle."
    alice "D-Dobrze. Bądź delikatny.{#mtl}{#tl}"
...
translate polish alice_8_menu1_c44d808d:
    ...
    "Przyciskasz główkę swojego członka do niej. Jest już rozciągnięta i nasmarowana po użyciu dildo, więc wślizgujesz się z niewielkim oporem.{#mtl}{#tl}"
...
translate polish alice_8_menu1_b09091bb:
    ...
    "Mimo to, jej tyłek jest niesamowicie ciasny, co sprawia, że tracisz się w swoim pożądaniu.{#mtl}{#tl}"
...
translate polish alice_8_menu1_6015a7a4:
    ...
    me "Jej dzikie jęki sprawiają, że twoje pragnienie płonie jeszcze bardziej intensywnie.{#mtl}{#tl}"
...
translate polish alice_8_menu1_f8d4a858:
    ...
    alice "Twoją dziewczyną! Jestem twoja~{#mtl}{#tl}"
...
translate polish alice_8_menu1_cc3b93af:
    ...
    "Nie czujesz się zmęczony po szczytowaniu, ale [alice] wygląda na całkowicie wyczerpaną.{#mtl}{#tl}"
...
translate polish alice_8_menu1_dd017547:
    ...
    "Po ubraniu się i przykryciu [alice] ręcznikiem, niesiesz ją na plecach.{#mtl}{#tl}"
...
translate polish alice_8_menu1_34cff1b3:
    ...
    "Delikatnie kładziesz ją do odpoczynku.{#mtl}{#tl}"
...
translate polish alice_8_menu1_8d5c5cb3:
    ...
    th "Wygląda teraz tak niewinnie, zupełnie inaczej niż zwykle figlarna.{#mtl}{#tl}"

# game/characters/alice/ev_8.rpy:242
translate polish alice_8_menu1_6025bf98:

    # "You kiss her goodnight."
    "Całujesz ją na dobranoc.{#mtl}{#tl}"
...
translate polish alice_8_part3_73b3c848:
    ...
    alice "Może teraz nauczysz się nie podglądać niewinne, małe dziewczynki takie jak ja.{#mtl}{#tl}"

# game/characters/alice/ev_8.rpy:291
translate polish alice_8_part3_48c25620:

    # th "Innocent my ass!"
    th "Niewinna moja dupa!{#mtl}{#tl}"
...
translate polish strings:
    ...
    new "Co to za rzecz za tobą?{#mtl}{#tl}"

    # game/characters/alice/ev_8.rpy:77
    old "You're kidding me!"
    new "Żartujesz sobie!{#mtl}{#tl}"
    ...
    new "Żartujesz sobie, to fantastyczne!{#mtl}{#tl}"
    ...
    new "Zastanowię się nad tym{#mtl}{#tl}"

    # game/characters/alice/ev_8.rpy:102
    old "Stop dreaming"
    new "Przestań marzyć{#mtl}{#tl}"
    ...
    new "A może zastąpię ten dildo?{#mtl}{#tl}"
