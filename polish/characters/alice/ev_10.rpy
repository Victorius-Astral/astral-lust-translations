...
translate polish alice_10_a318e8a3:
    ...
    alice "Nie przyszedłeś, żeby prosić tę małą dziewczynkę o coś niegrzecznego, prawda, panie?{#mtl}{#tl}"

# game/characters/alice/ev_10.rpy:19
translate polish alice_10_0faaa5ed:

    # me "Ha, you wish."
    me "Ha, marzysz.{#mtl}{#tl}"
...
translate polish alice_10_647087e1:
    ...
    alice "Więc nie chcesz? to dobrze, prawie się dla ciebie rozebrałam..{#mtl}{#tl}"
...
translate polish alice_10_cad5c0e5:
    ...
    me "Nie mów mi, że teraz nie jesteś podniecony.{#mtl}{#tl}"
...
translate polish alice_10_1854abac:
    ...
    alice "Hmmm.. a może połóż się, tatusiu? [alice], się tobą zajmę.{#mtl}{#tl}"
...
translate polish alice_10_9c6fbd7b:
    ...
    alice "Podoba ci się moja koszula nocna, tatusiu?{#mtl}{#tl}"

# game/characters/alice/ev_10.rpy:71
translate polish alice_10_4befe67e:

    # me "It's lovely."
    me "Jest urocza.{#mtl}{#tl}"
...
translate polish alice_10_1073ebf4:
    ...
    "[alice] zaczęła cię zadowalać ustami. Jej mały język tańczy wokół twojego członka jak wąż.{#mtl}{#tl}"
...
translate polish alice_10_4989fe05:
    ...
    me "W porządku. dziękuję, że to powiedziałaś.{#mtl}{#tl}" id alice_10_4989fe05
...
translate polish alice_10_part3_aa93b10c:
    ...
    # me "Good girl."
    me "Nie czekasz i wchodzisz w jej mokrą cipkę w mgnieniu oka.{#mtl}{#tl}"
...
translate polish alice_10_part3_1e0a78fd:
    ...
    "Pieprz~ Pieprz mnie, tatusiu! Pieprz swoją małą dziewczynkę~ Jest tak dobrze!{#mtl}{#tl}"

# game/characters/alice/ev_10.rpy:185
translate polish alice_10_part3_38c341ab:

    # alice "Mhmnhn~"
    alice "Ahh! jesteś tak ciasna..{#mtl}{#tl}"
...
translate polish alice_10_part3_a80d6c56:
    ...
    alice "Jej cipka jest wyjątkowo ciasna, trudno się poruszać, ale jednocześnie jest niesamowicie przyjemna.{#mtl}{#tl}"
...
translate polish alice_10_part3_40976ab2:
    ...
    # me "Ohh.."
    me "Pieprz mnie więcej, mocniej!{#mtl}{#tl}"
...
translate polish alice_10_part3_b4257d71:
    ...
    alice "Jak mogę odmówić mojej małej dziewczynce.{#mtl}{#tl}"
...
translate polish alice_10_part3_7459a238:
    ...
    # alice "Ahmnn~"
    alice "T-tak dobre, tatusiu~{#mtl}{#tl}"

# game/characters/alice/ev_10.rpy:235
translate polish alice_10_part3_5d2f0ca8:

    # alice "Ahh.."
    alice "Cieszę się, że sprawiłem mojej małej dziewczynce radość.{#mtl}{#tl}"
