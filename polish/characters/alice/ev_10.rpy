...
translate polish alice_10_f60efb3c:
    ...
    alice "Mhm, czuję się teraz o wiele lepiej, dziękuję." # TL # Victorius - AI
...
translate polish alice_10_a318e8a3:
    ...
    alice "Nie przyszedłeś, żeby poprosić tę małą dziewczynkę o zrobienie czegoś niegrzecznego, prawda, panie?" # TL # Victorius - AI

# game/characters/alice/ev_10.rpy:19
translate polish alice_10_0faaa5ed:

    # me "Ha, you wish."
    me "Ha, chciałabyś." # TL # Victorius - AI
...
translate polish alice_10_647087e1:
    ...
    alice "Nie chcesz więc? To dobrze, prawie się dla ciebie rozebrałam.." # TL # Victorius - AI
...
translate polish alice_10_cad5c0e5:
    ...
    me "Nie mów mi, że teraz nie jesteś napalona." # TL # Victorius - AI
...
translate polish alice_10_1854abac:
    ...
    alice "Hmmm.. Co powiesz na to, żebyś się położył, tatusiu? [alice] się tobą zajmie." # TL # Victorius - AI

# game/characters/alice/ev_10.rpy:60
translate polish alice_10_da600f48:

    # "You lie down."
    "Kładziesz się." # TL # Victorius - AI
...
translate polish alice_10_5ea2f352:
    ...
    alice "Daj mi chwilę, tatusiu! Nie patrz!" # TL # Victorius - AI

# game/characters/alice/ev_10.rpy:63
translate polish alice_10_cd1dda61:

    # me "Take your time, but don't make daddy wait too long."
    me "Nie spiesz się, ale nie każ tatusiowi czekać zbyt długo." # TL # Victorius - AI
...
translate polish alice_10_1073ebf4:
    ...
    "[alice] zaczęła cię zaspokajać. Jej mały języczek tańczy wokół twojego członka jak wąż." # TL # Victorius - AI

# game/characters/alice/ev_10.rpy:88
translate polish alice_10_4feccafa:

    # me "Mmm. Good girl."
    me "Mmm. Dobra dziewczynka." # TL # Victorius - AI
...
translate polish alice_10_9ee2f291:
    ...
    me "Jesteś moją dziewczyną, [alice], chcę, żebyśmy byli jeszcze bliżej." # TL # Victorius - AI
...
translate polish alice_10_6c5774fc:
    ...
    alice "W porządku. Dziękuję, że to powiedziałeś." # TL # Victorius - AI
...
translate polish alice_10_a33519d3:
    ...
    alice "W porządku. Wiedziałam to już od jakiegoś czasu." # TL # Victorius - AI

# game/characters/alice/ev_10.rpy:159
translate polish alice_10_part2_365e3b53:

    # me "Will you let me be your man?"
    me "Czy pozwolisz mi być twoim mężczyzną?" # TL # Victorius - AI
...
translate polish alice_10_part3_974176ba:
    ...
    alice "Pieprz swoją małą dziewczynę, tatusiu~" # TL # Victorius - AI
...
translate polish alice_10_part3_f32f628a:
    ...
    "Nie czekasz i zamiast tego wchodzisz w jej mokrą cipkę w mgnieniu oka." # TL # Victorius - AI
...
translate polish alice_10_part3_1e0a78fd:
    ...
    "[alice] wydała głośny krzyk wypełniony odrobiną bólu stłumionego przez przyjemność." # TL # Victorius - AI
...
translate polish alice_10_part3_a80d6c56:
    ...
    alice "Pieprz~ Pieprz mnie, tatusiu! Pieprz swoją małą dziewczynkę~ To takie przyjemne!" # TL # Victorius - AI

# game/characters/alice/ev_10.rpy:190
translate polish alice_10_part3_3951cfbc:

    # me "Ahh! You're so tight.."
    me "Ahh! Jesteś taka ciasna.." # TL # Victorius - AI
...
translate polish alice_10_part3_8bf5efba:
    ...
    "Jej cipka jest wyjątkowo ciasna, trudno się poruszać, ale jednocześnie jest to niesamowicie przyjemne." # TL # Victorius - AI
...
translate polish alice_10_part3_b4257d71:
    ...
    alice "Pieprz mnie więcej, mocniej!" # TL # Victorius - AI
...
translate polish alice_10_part3_4ff42f79:
    ...
    me "Jak mógłbym odmówić mojej małej dziewczynce." # TL # Victorius - AI
...
translate polish alice_10_part3_79dfe51e:
    ...
    # alice "I'm close!~"
    alice "Jestem blisko!~" # TL # Victorius - AI
...
translate polish alice_10_part3_8e0312e6:
    ...
    "Zostawiasz ją, aby odpoczęła." # TL # Victorius - AI
...
translate polish strings:
    ...
    new "Teraz jest oficjalnie moją dziewczyną." # TL # Victorius - AI

    # game/characters/alice/ev_10.rpy:140
    old "Of course, only you matter to me"
    new "Oczywiście, tylko ty się dla mnie liczysz" # TL # Victorius - AI

    # game/characters/alice/ev_10.rpy:140
    old "Sorry, I can't do this"
    new "Przepraszam, nie mogę tego zrobić" # TL # Victorius - AI

    # game/characters/alice/ev_10.rpy:219
    old "Cum inside"
    new "Do środka" # TL # Victorius - AI

    # game/characters/alice/ev_10.rpy:219
    old "Cum outside"
    new "Na zewnątrz" # TL # Victorius - AI
