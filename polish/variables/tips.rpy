translate polish strings:
    ...
    new "Coś mi mówi, że będę miał niezły sen."

    # game/variables/tips.rpy:4
    old "Who knows what awaits me outside?"
    new "Kto wie co czeka mnie na zewnątrz?"

    # game/variables/tips.rpy:4
    old "I need to take care of my mental health."
    new "Muszę zatroszczyć się o moje zdrowie psychiczne."

    # game/variables/tips.rpy:4
    old "Maybe someone can answer my questions out there."
    new "Może ktoś na zewnątrz jest w stanie odpowiedzieć na moje pytania."

    # game/variables/tips.rpy:4
    old "I wonder if I would turn insane if it spoke to me again.."
    new "Zastanawiam się, czy stałbym się szalony, gdyby to coś do mnie znowu przemówiło.."

    # game/variables/tips.rpy:4
    old "My dreams are becoming more disturbing as of late."
    new "Moje sny stają się coraz bardziej niepokojące."

    # game/variables/tips.rpy:4
    old "I need to ask Kiara about this.. being.."
    new "Muszę zapytać Kiarę, o tę.. istotę.."

    # game/variables/tips.rpy:4
    old "I should wait for her to return, I hope, she's safe."
    new "Powinienem zaczekać do jej powrotu, mam nadzieję, że jest bezpieczna."
    ...
    new "Może potrzebować trochę pomocy."

    # game/variables/tips.rpy:4
    old "Maybe I should go out?"
    new "Może powinienem wyjść na zewnątrz?"

    # game/variables/tips.rpy:4
    old "Maybe I'll find something she likes outside, should I ask her?"
    new "Może znajdę coś co lubi na zewnątrz? Może powinienem ją zapytać?"

    # game/variables/tips.rpy:4
    old "I have trouble falling asleep at night."
    new "Mam problem zasnąć w nocy."

    # game/variables/tips.rpy:4
    old "I think I should hang out with Mina."
    new "Myślę, że powinienem spędzić nieco czasu z Miną."

    # game/variables/tips.rpy:4
    old "She seems to have something on her mind recently. I should ask."
    new "Wygląda jakby ostatnio coś zaprzątało jej głowę. Powinienem zapytać."

    # game/variables/tips.rpy:4
    old "Maybe she knows another café nearby."
    new "Może zna jakąś inną kawiarnię w okolicy."

    # game/variables/tips.rpy:4
    old "We should talk about last events."
    new "Powinniśmy porozmawiać o ostatnich wydarzeniach."

    # game/variables/tips.rpy:4
    old "Let's say hello and wait for her to find me."
    new "Czas się przywitać, potem dam jej czas aż ona przyjdzie do mnie."

    # game/variables/tips.rpy:4
    old "Something tells me that she will need me in near future."
    new "Coś mi podpowiada, że będzie potrzebować mnie w bliskiej przyszłości."

    # game/variables/tips.rpy:4
    old "I should go out off my room sometimes."
    new "Powinienem czasem wyjść z pokoju."

    # game/variables/tips.rpy:4
    old "When Alice likes me enough (Affection > 4, Trust > 0) I should talk with Mina and then Alice at the evening."
    new "Gdy Alice dość mnie lubi (Bliskość > 4, Zaufanie > 0) powinienem pogadać z Miną, a potem, wieczorem, z Alice."

    # game/variables/tips.rpy:4
    old "I wonder what's up with Lexi."
    new "Zastanawiam się co jest z Lexi."

    # game/variables/tips.rpy:4
    old "I should check on her."
    new "Powinienem sprawdzić jak się ma."

    # game/variables/tips.rpy:4
    old "It would be nice to accompany her a little."
    new "Miło by było z mojej strony, gdym spędził z nią nieco czasu."
    ...
    new "Powinienem dać jej kilka dni do namysłu."

    # game/variables/tips.rpy:4
    old "I should focus on my relationship with Lexi."
    new "Powinienem skupić się na mojej relacji z Lexi."

    # game/variables/tips.rpy:4
    old "I should talk with Lexi."
    new "Powinienem porozmawiać z Lexi."

    # game/variables/tips.rpy:4
    old "I should hang out with her."
    new "Powinienem się z nią spotkać."

    # game/variables/tips.rpy:4
    old "I kind of liked sitting with her at the sofa, we should do this again. I think she would find some time at the evening."
    new "Całkiem lubię siedzieć z nią na sofie, powinniśmy to powtórzyć. Myślę, że znajdzie nieco czasu wieczorem."

    # game/variables/tips.rpy:4
    old "I should wait for her to settle her own thing with Alice."
    new "Powinienem dać jej trochę czasu na ogarnięcie sprawy z Alice."

    # game/variables/tips.rpy:4
    old "I should prepare before coming out of my room."
    new "Powinienem się przygotować przed wyjściem z mojego pokoju."

    # game/variables/tips.rpy:4
    old "I should find her when she is in her room."
    new "Powinienem ją znaleźć, gdy jest u siebie w pokoju."

    # game/variables/tips.rpy:4
    old "I wonder what she does in her room during evenings."
    new "Ciekawe co robi u siebie w pokoju wieczorami."

    # game/variables/tips.rpy:4
    old "I suddenly feel like seeing her, should I check if she is at home?"
    new "Mam nagłą ochotę ją zobaczyć, może sprawdzę czy jest w domu?"

    # game/variables/tips.rpy:4
    old "Maybe she needs my help again."
    new "Może znów potrzebuje mojej pomocy."

    # game/variables/tips.rpy:4
    old "I could use a meal, maybe Grace left something for me in the fridge."
    new "Wrzuciłbym coś na ząb, może Grace zostawiła dla mnie coś w lodówce."

    # game/variables/tips.rpy:4
    old "I wonder if she is cooking this afternoon."
    new "Zastanawia mnie czy będzie gotować popołudniu."

    # game/variables/tips.rpy:4
    old "Maybe there are some beautiful flowers outside. I'm sure she would appreciate them."
    new "Może znajdę jakieś kwiaty na zewnątrz. Jestem pewien że je doceni."

    # game/variables/tips.rpy:4
    old "I should go and say hello."
    new "Powinienem pójść się przywitać."

    # game/variables/tips.rpy:4
    old "I should wait and see."
    new "Mógłbym poczekać i zobaczyć co się wydarzy.."

    # game/variables/tips.rpy:4
    old "I should go out sometimes."
    new "Powinienem czasem wyjść."

    # game/variables/tips.rpy:4
    old "Maybe I should wait \"for it\" a few days."
    new "Hmm.. Myślę, że powinienem zaczekać \"na to\", kilka dni."

    # game/variables/tips.rpy:4
    old "I wonder how she deals with lust after blowing me so much."
    new "Ciekawe jak radzi sobie z pożądaniem po zrobieniu mi tylu lodów? Musi być nieźle napalona."

    # game/variables/tips.rpy:4
    old "I should train from time to time."
    new "Powinienem czasem nieco poćwiczyć."

    # game/variables/tips.rpy:4
    old "She looks down lately, I should speak with her."
    new "Ostatni wygląda na smutną, powinienem z nią o tym porozmawiać."

    # game/variables/tips.rpy:4
    old "She takes a shower sometimes during the evening, it might be fun if she likes me enough."
    new "Czasem bierze prysznic wieczorem, mogłoby być zabawnie, gdyby mnie dość lubiła."

    # game/variables/tips.rpy:4
    old "I should check on her again in a while."
    new "Za jakiś czas powinienem sprawdzić co u niej."

    # game/variables/tips.rpy:4
    old "It was her first time, I should ask her how she's feeling."
    new "To był jej pierwszy raz, miło by było zapytać jak się czuje."

    # game/variables/tips.rpy:4
    old "Who knows what awaits me in the morning."
    new "Kto wie co czeka na mnie o poranku."

    # game/variables/tips.rpy:4
    old "Perhaps only death could make her more interested in me."
    new "Być może jedynie śmierć sprawiłaby, że Kiara się mną zainteresuje."

    # game/variables/tips.rpy:4
    old "I wonder if she has any way to help me?"
    new "Ciekawe, czy jest w stanie mi jakoś pomóc?"
...
translate polish strings:
    ...
    new "Może ktoś mnie zauważy jeśli będę często podróżował?"
