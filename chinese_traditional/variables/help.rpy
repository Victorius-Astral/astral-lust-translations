...
translate chinese_traditional strings:
    ...
    new "敏捷訓練設施最容易注意到，在左邊，有一個跳馬，你可以跳過，還有很多墊子。" # TL # Victorius - AI

    # game/variables/help.rpy:3
    old "Here you can.. store things! Surprising, I know."
    new "在這裡你可以.. 存放東西！驚訝吧，我知道。" # TL # Victorius - AI

    # game/variables/help.rpy:3
    old "You can store both items and cards, per level of vault:"
    new "你可以根據保險庫的等級存放物品和卡牌：" # TL # Victorius - AI

    # game/variables/help.rpy:3
    old " • {color=#45B6FE}[exp_vault_space_per_lvl] items{/color}"
    new " • {color=#45B6FE}[exp_vault_space_per_lvl] 件物品{/color}" # TL # Victorius - AI

    # game/variables/help.rpy:3
    old " • {color=#45B6FE}[exp_vault_cards_per_lvl] cards{/color}"
    new " • {color=#45B6FE}[exp_vault_cards_per_lvl] 張卡牌{/color}" # TL # Victorius - AI
    ...
    new "這是角色菜單，在這裡你可以檢查你的狀態。大多數屬性都有它們的用途，大多數可以幫助戰鬥，許多可以幫助你通過成功檢查解鎖額外內容。" # TL # Victorius - AI

    # game/variables/help.rpy:3
    old "You can check what any given thing does, just hover over it, and tooltip explaining this stat will appear."
    new "你可以檢查任何給定事物的作用，只需將鼠標懸停在上面，解釋此屬性的工具提示就會出現。" # TL # Victorius - AI
