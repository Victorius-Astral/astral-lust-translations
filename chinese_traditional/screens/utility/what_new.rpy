...
translate chinese_traditional strings:
    ...
    new "{a=https://astral-lust-documentation.readthedocs.io/en/latest/changelogs/full.html#changelog-full}{color=#2839fc}{i}閱讀完整更新日誌{/i}{/color}{/a}" # TL # Victorius - AI
    ...
    new "您可以在{a=https://www.patreon.com/Victorius}{color=#2839fc}{i}Patreon{/i}{/color}{/a}和{a=https://discord.gg/rvnBC39USx}{color=#2839fc}{i}Discord{/i}{/color}{/a}上查看更多新聞、預覽和內容。" # TL # Victorius - AI
    ...
    new "{b}我們聽到了你的聲音！{/b} 0.3.0版本的最大變化來自於您的建議！探索被分為多個區域，每個區域都有自己的事件，故事事件也需要您探索相應的區域。別擔心，地圖的功能已擴展到探索地圖中，會高亮顯示有事件的地點。" # TL # Victorius - AI
    ...
    new "{b}更多性愛場景有音效！{/b} 包括：Alice、Kiara 和 Lexi 的場景，以及部分 Grace 的場景。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:222
    old "{b}Wanderer Hideout{/b}"
    new "{b}流浪者藏身處{/b}" # TL # Victorius - AI
    ...
    new "一個新的地點等你發現！與武術家戰鬥，學習他們的技能，並用新的卡牌類型——武術來擊敗你的敵人！" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:268
    old "{b}New Enemies, Arenas & AI Improvements{/b}"
    new "{b}新敵人、競技場和AI改進{/b}" # TL # Victorius - AI
    ...
    new "增加了十三個新的狀態效果！其中許多與新的武術卡牌有關。新敵人也會使用它們，龍的再生能力被改為天生再生。" # TL # Victorius - AI
    ...
    new "做了一些其他事件、功能、機制、生活品質改善、修復和更改。您可以在以下的更新日誌中找到它們。" # TL # Victorius - AI
    ...
    new "{b}我們開始添加性愛聲音！{/b} 隨著戰鬥聲音，聲音設置中新增了兩個音量條。您可以在那裡調整NSFW聲音的音量。目前僅為Alice和Savenia添加了一些聲音。更多聲音，包括呻吟，將很快推出。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:651
    old "{b}Rituals{/b}"
    new "{b}儀式{/b}" # TL # Victorius - AI
    ...
    new "執行各種儀式和咒語，將為您帶來各種效果。有兩個儀式和四個可以祈禱的存在。一個儀式將操控您夜晚的夢境，另一個將改善或降低您的心理狀態。保持安全！不要祈禱邪惡的存在！主線故事到第12章後，或者從惡夢天使女孩Demeter學到神秘學後，去找Kiara學習。儀式在玩家房間的祭壇上進行。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:663
    old "{b}Control Your Dreams{/b}"
    new "{b}控制你的夢境{/b}" # TL # Victorius - AI
    ...
    new "您可以使用新物品和儀式來控制您是否會在夜晚做夢！您還可以決定您會有什麼樣的夢。小提示：與魅魔做愛會讓您當晚做春夢。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:667
    old "{b}Explore with Little Fox{/b}"
    new "{b}與小狐狸一起探索{/b}" # TL # Victorius - AI
    ...
    new "您現在可以帶小狐狸去冒險！在探索中找到她，然後通過與她交談帶她出去。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:678
    old "{b}Postpone Deal With The Devil{/b}"
    new "{b}推遲與惡魔的交易{/b}" # TL # Victorius - AI
    ...
    new "我們已將大多數遊戲內容添加到重播菜單中。與0.2.3相比，現在增加了177個重播，總共達到357個重播。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:704
    old "{b}Grace - Bunny Outfit{/b}"
    new "{b}Grace - 兔女郎服裝{/b}" # TL # Victorius - AI
    ...
    new "增加了兩個新夢境！都不太友好，呵呵~ 兩個新的惡夢撕裂你的理智！" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:721
    old "{b}Lola's 3rd event{/b}"
    new "{b}Lola的第三個事件{/b}" # TL # Victorius - AI
    ...
    new "Lola終於有了一個新事件！涉及兩條路徑和三個成人場景。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:730
    old "{b}New Buffs & Items{/b}"
    new "{b}新增強和物品{/b}" # TL # Victorius - AI
    ...
    new "增加了很多新的增強效果，還有一些減益效果。還增加了三個新物品。此外，某些物品現在可以消耗以獲得增強效果（酒精類）。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:734
    old "{b}Card Sounds{/b}"
    new "{b}卡牌聲音{/b}" # TL # Victorius - AI
    ...
    new "大多數卡牌現在使用時會播放聲音！希望您喜歡！點擊下面的卡牌試試。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:745
    old "{b}A lot of changes{/b}"
    new "{b}大量更改{/b}" # TL # Victorius - AI
    ...
    new "遊戲的主要字體已更改！收藏品在保存之間保留。物品通知現在顯示物品圖標。還有許多其他更改，請查看底部的完整更新日誌。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:762
    old "{b}A lot of new Grace content{/b}"
    new "{b}大量新的Grace內容{/b}" # TL # Victorius - AI
    ...
    new "Gracie有三個新的故事事件，新'憤怒與道歉'機制，新睡眠內容（包括兩個足交），秘密事件等等。她的新故事事件的最後一個與Alice和小狐狸的事件合併。哦，這是一個有趣的事件 ;)" # TL # Victorius - AI
    ...
    new "姐妹們各有兩個新的故事事件！Lexi還有一個超大的事件——廚房約會，您需要為此做準備。隨著得分的提高，您可以解鎖大量的熱辣內容。這是迄今為止最長的事件，也是新的'約會'系統的首次。玩得開心！" # TL # Victorius - AI
    ...
    new "如上所述，小狐狸有一個與Alice和Gracie合併的事件，Rachel也有一個事件（終於有她的行動了 :P），Rhainda有兩個故事事件！" # TL # Victorius - AI
    ...
    new "其中四個可以在新事件中使用，有兩個消耗品（和一個新增強），以及用於打開它們的袋子和箱子。您會一夜暴富嗎？去尋找或購買它們來試試運氣！嘗試代碼{b}{i}NewPouches{/i}{/b}來獲得一些獎勵袋 :)" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:834
    old "{b}Redone prologue{/b}"
    new "{b}重製的序章{/b}" # TL # Victorius - AI
    ...
    new "序章從頭開始製作，變得更大、更具信息性和吸引力。查看重播或開始新遊戲以查看。您可能會遇到意想不到的人。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:846
    old "{b}A lot of other changes & additions{/b}"
    new "{b}大量其他更改和新增內容{/b}" # TL # Victorius - AI
    ...
    new "更新日誌長得要命，修復了大約30個錯誤，進行了很多生活品質改進，其中一些是社區建議的。還有一些其他新機制，例如Mina可能會宿醉，拒絕與您進行任何有意義的對話，並停止她的工作。廢棄車輛的戰利品大幅增加，敵人攻擊的第一批聲音已添加。從下面的鏈接查看完整的更新日誌。" # TL # Victorius - AI
    ...
    new "一位新的Kitsune來到了Asthar，她非常火辣！她喜歡性愛，也喜歡女孩。她有（可切換的）與[lil_fox]的女同性戀內容。此外，她是以一個真實人物為原型設計的，加入我們的{a=https://discord.gg/rvnBC39USx}Discord{/a}伺服器，與她聊天！希望您的崇拜不會讓她得意忘形 :P" # TL # Victorius - AI
    ...
    new "Kiara有新的故事事件，解釋了非凡存在所信仰的創世神話。不要忘記之後享受樂趣，6個新的性愛場景，3個新服裝，將近300個動畫！您曾經與自己的克隆人做愛嗎？" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:889
    old "{b}Alice Shower Event{/b}"
    new "{b}Alice 洗澡事件{/b}" # TL # Victorius - AI
    ...
    new "[alice]的洗澡事件擴展了一個新場景。與您的小女孩一起享受樂趣，幫助她洗背！" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:901
    old "{b}Gracie Nightmare{/b}"
    new "{b}Gracie 惡夢{/b}" # TL # Victorius - AI
    ...
    new "哦不！我們的小女孩做了個噩夢！我們需要在我們的懷抱中保護她 :) 做一個好人，讓Gracie留下來。您能在這個事件中找到隱藏的秘密嗎？提示：此事件有幾個變體，看一次還不夠看完所有內容並找到秘密。最好在找到秘密前一小時不要保存 :)" # TL # Victorius - AI
    ...
    new "Astral Lust界面的全面改造已經開始！許多最重要的菜單已經採用，或至少部分採用。庫存和角色菜單現在是一個單一的菜單，完全採用新的風格。物品現在有工具提示和圖標。整個物品系統被全面改造，右鍵點擊物品將允許您使用滑塊選擇移動多少個，您還可以排序庫存，並只需一次點擊即可移動所有物品！通知現在完全不同，您可以在設置中切換兩種不同的樣式。主界面主題字體 - {font=fonts/FrederickatheGreat-Regular.ttf}Fredericka{/font}也可以在設置中切換。可擴展的菜單圖標已更改，並且所有使用它們打開的菜單至少部分採用新主題。交易場景已完全採用，具有顯示交易中聲望增加等新選項，還為商人添加了一些新機制——例如良好的利潤關係獎勵。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:917
    old "{b}Lexi Brings Food{/b}"
    new "{b}Lexi 帶來食物{/b}" # TL # Victorius - AI
    ...
    new "還有無數其他更改——所有動畫都可以在設置中開啟/關閉，修復了數十個問題，添加了對所有沒有支持的動畫的支持，刪除了一些動畫，如看起來奇怪的射精動畫。添加了遊戲結束字幕。Hollow Market提供了更多庫存，並每週補貨。其他商人也進行了調整。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:945
    old "{b}Unique Cards!{/b}"
    new "{b}獨特卡牌！{/b}" # TL # Victorius - AI
    ...
    new "這次發布中，Asthar出現了四張新的獨特卡牌！這些都是Astral Lust一週年紀念的一部分。煙火卡牌在{a=https://www.patreon.com/Victorius}{patreon1}Patreon{/patreon1}{/a}和{a=https://discord.gg/rvnBC39USx}{patreon1}Discord{/patreon1}{/a}上對所有人開放，其餘三張卡牌則是為所有Patrons準備的。其中一張卡牌可以召喚各種女孩作為盟友——妄想！" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:959
    old "{b}Interactions Menu{/b}"
    new "{b}互動菜單{/b}" # TL # Victorius - AI
    ...
    new "這裡有一個大幅的生活品質提升！現在您不需要一個一個地檢查哪些是可點擊的。除了秘密，其他可互動的元素在自由漫遊中現在在左下角有一個按鈕！這個窗口可以在設置中禁用，也可以用'I'鍵禁用。" # TL # Victorius - AI
    ...
    new "在眾多變化中，最引人注目的可能是現在選擇菜單位於屏幕的右側（可以在設置中更改），任務菜單現在可以用'T'鍵或在設置中禁用。還新增了一個新的競技場，水蛭攻擊現在有了新的意圖圖標。這次發布修復了很多錯誤，還有數百個拼寫和語法問題。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:981
    old "{b}Christmas Event{/b}"
    new "{b}聖誕節事件{/b}" # TL # Victorius - AI
    ...
    new "出現了一個限時事件！玩一系列7個聖誕主題事件並擊敗聖誕精神！一旦事件被看到，直到第二天（實時）才能看到另一個。您有時間到1月10日擊敗精神！" # TL # Victorius - AI
    ...
    new "Mina的腳得到了按摩，現在輪到另一個妹妹享受你的按摩技巧了！有很多服裝與新的熱辣H場景搭配！" # TL # Victorius - AI
    ...
    new "認識Rachel，第二位介紹的狐狸女孩！與小狐狸一起，有11個新的故事事件和3個可重複的事件。建造狐狸神社，讓這兩隻狐狸住在你家！還有小狐狸的新服裝！" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1029
    old "{b}New Grace activities{/b}"
    new "{b}新的Grace活動{/b}" # TL # Victorius - AI
    ...
    new "曾經想幫助Grace做酒店的家務嗎？也許你想和她一起玩家庭遊戲？現在這一切都成為可能！幫助她，她一定會感激不盡。{b}告訴她這個世界上有好男人！{/b} {i}她可能會問一些奇怪的數學問題，您已被警告。{/i}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1042
    old "{b}Adventure with Lexi{/b}"
    new "{b}與Lexi的冒險{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1043
    old "Go out and get some supplies with Lexi, be prepared for trouble!"
    new "和Lexi一起出去獲取一些補給，準備好迎接麻煩！" # TL # Victorius - AI
    ...
    new "Savenia有三個新的故事事件！她的腿好轉後會發生什麼？她會離開嗎？" # TL # Victorius - AI
    ...
    new "有四個全新的探索事件等著你！拯救女士，被欺騙，獵龍，逃離巨人。特邀角色登場——商人的女兒和'閃亮'的女強盜。還有一位懷孕的女士處於危險中！拯救她和她未出生的孩子！" # TL # Victorius - AI
    ...
    new "有一個有趣的夢境在等著你！曾經想像過未來為你準備了什麼嗎？投入Alice的溫暖懷抱，享受你的新生活。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1089
    old "{b}Decks{/b}"
    new "{b}卡組{/b}" # TL # Victorius - AI
    ...
    new "您現在可以進行真正的卡組構建！建立最多三個卡組，根據敵人改變您的戰術。卡片庫存儲已被移除，取而代之的是無限卡組存儲。卡組允許根據各種標準對卡牌進行排序，並提供各種顯示選項。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1094
    old "{b}Combat tutorial{/b}"
    new "{b}戰鬥教程{/b}" # TL # Victorius - AI
    ...
    new "引入了一個新的戰鬥教程。讓Lexi帶你了解戰鬥的基礎！可以從大廳外的門口啟動。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1099
    old "{b}Tasks{/b}"
    new "{b}任務{/b}" # TL # Victorius - AI
    ...
    new "曾經想知道為什麼Lexi不會從外面帶些東西給你嗎？別再想了，直接讓她去做吧！目前任務可以分配給Lexi、Mina、Alice和Grace。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1104
    old "{b}Buffs{/b}"
    new "{b}增強效果{/b}" # TL # Victorius - AI
    ...
    new "您現在可以獲得各種增強效果！它們將在戰鬥中幫助您，通過分配任務給女孩來獲得。活動增強效果將出現在角色菜單中。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1109
    old "{b}Combat additions{/b}"
    new "{b}戰鬥新增內容{/b}" # TL # Victorius - AI
    ...
    new "三個新的強盜敵人等著你。踢他們的屁股！你可以藉助新狀態效果——獵人印記，和兩張新卡牌狙擊和破片手榴彈來做到這一點。" # TL # Victorius - AI
    ...
    new "對前酒店老闆感到好奇嗎？問問女孩們，也許她們會說些有用的事。Grace、Mina和Alice有新的對話主題！" # TL # Victorius - AI
    ...
    new "這裡還有很多其他的小添加和更改。日誌/法典的GUI已更改，以提高可讀性。有很多生活品質的改變，比如製作也使用庫存材料。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1145
    old "{b}Mina at the Vault{/b}"
    new "{b}Mina在庫房{/b}" # TL # Victorius - AI
    ...
    new "Mina現在可以出現在庫房！她有一個新的話題可以與我們交談。那裡還有兩個H場景。" # TL # Victorius - AI
    ...
    new "主線故事的新支線事件！這個事件似乎分享了更多內容。這是關於Asthar真相的序幕。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1170
    old "{b}Damsel in Distress{/b}"
    new "{b}陷入困境的少女{/b}" # TL # Victorius - AI
    ...
    new "有五個新的探索事件！全都以陷入困境的少女為主題。您可以嘗試擊敗怪物，看看這些少女有多感激。" # TL # Victorius - AI
    ...
    new "有一個新的狀態效果和賦予它的卡牌。火焰之心使燃燒減益效果變為治療而非造成傷害。效果和卡牌都可以在龍上找到。" # TL # Victorius - AI
    ...
    new "{b}戰鬥2.0{/b}\n這是這次發布的主要焦點，徹底改變了Astral Lust的玩法。戰鬥和所有相關內容都被完全重做。現在戰鬥分開敵人，允許多種組合的敵人。此外，當您尋找敵人時，現在可以選擇要弱敵還是強敵。您可以更清楚地看到敵人會做什麼，大多數敵人已重新平衡。" # TL # Victorius - AI
    ...
    new "{b}卡牌2.0{/b}\n卡牌被完全重做，現在顯示它們影響的目標類型。目標指示器位於左下角。 \n\n• {color=#9d0000}紅色{/color} - 敵人， \n• {color=#018000}綠色{/color} - 盟友/玩家， \n• {color=#0013d7}藍色{/color} - 玩家。\n\n卡牌現在計算其效果，因此當您獲得力量增強卡牌時，將顯示您將對敵人造成多少傷害，考慮到目標的所有狀態效果。此外，許多卡牌已重新平衡或更改了效果。" # TL # Victorius - AI
    ...
    new "{b}午夜之吻{/b}\n這個新事件從市場探索事件中觸發，當我們尋找補給時有12%%的機會發生。這是基於一個朋友告訴我的故事，據說是美國的舊都市傳說。此事件可以教您很多關於背景知識的內容，如果您選擇合適的選擇。數百行的背景知識。要觸發它，您需要先完成主線故事的第12個事件。" # TL # Victorius - AI
    ...
    new "{b}卡組視圖大修{/b}\n現在檢查您的卡組或抽牌/棄牌堆時，您將看到工具提示解釋懸停卡牌的狀態效果。這個功能是社區強烈要求的。此外，這個功能在熔爐和庫房中也能使用。您可以在上面的卡牌中檢查。" # TL # Victorius - AI
    ...
    new "{b}查看所有卡牌{/b}\n 電腦上新增了一個功能。它允許您檢查遊戲中的所有卡牌！您可以查看構建夢想卡組所需的卡牌，還可以查看版本之間的元數據變更。" # TL # Victorius - AI
    ...
    new "{b}親吻{/b}\n這個版本的重點放在小事件和新的生活品質功能上。最顯著的新增內容是親吻事件。其中一些是小事件，但有些是更長且更複雜的場景。這些事件引入了許多新的H場景，特別是對Grace而言。那就是——如果您能獲得它們的話。新事件中可以做的事情並不都是顯而易見的。有些選項需要您被腐化，甚至達到60%%，有些需要活力或智力。親吻事件主要在SFW模式下可用。嘗試在不同的地方和條件下親吻女孩以揭開所有場景。" # TL # Victorius - AI
    ...
    new "{b}撫摸寵物{/b}\n寵物終於被記住了。您現在可以撫摸您的小朋友。寵物出現的所有地方都有不同的場景。" # TL # Victorius - AI
    ...
    new "{b}Savenia{/b}\n這次發布為Savenia帶來了三個新的故事事件。在此期間，我們將推進我們的關係，超越最初的尷尬。還有一個新的可重複H場景。她的故事事件增加了地圖支持。" # TL # Victorius - AI
    ...
    new "{b}新設置{/b}\n有許多新的設置供您自定義遊戲。您可以強制顯示可互動的遮罩，即使沒有懸停。您可以更改文本框的不透明度、字體輪廓等。選項之一是選擇您的主菜單圖像集。" # TL # Victorius - AI
    ...
    new "{b}庫房{/b}\n庫房可以再次擴展！有4個新層級，配有特殊效果，如貨幣不佔空間或空間倍增器。T8庫房可以存儲600個物品、32張卡牌和無限貨幣。" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:1336
    old "{b}Experience{/b}\nCharacters experience is now collected & displayed in their stats. (not in SFW mode)"
    new "{b}經驗{/b}\n角色的經驗現在會被收集並顯示在他們的統計數據中。（不在SFW模式下）" # TL # Victorius - AI
