...
translate spanish strings:
    ...
    new "No es muy abrigador, pero al menos cubrirá las áreas privadas." # TL

    # game/variables/outfits.rpy:84
    old "Come, daddy~ Your little girl has homework to do~"
    new "Vamos, papi~ Tu pequeña tiene tarea que hacer~" # TL

    # game/variables/outfits.rpy:84
    old "It's [grace]'s job to clean the place, but [alice] is always happy to learn new stuff!"
    new "Limpiar el lugar es el trabajo de [grace], ¡pero [alice] siempre está feliz de aprender cosas nuevas!" # TL
    ...
    new "Nadie quiere que [lexi] se corrompa, pero apuesto a que te gustaría saber cómo se vería con algunos tentáculos en su cuerpo." # TL

    # game/variables/outfits.rpy:84
    old "She's an Angel. Literally. She doesn't seem to grow wings, though. Let's change that."
    new "Ella es un ángel. Literalmente. Aunque parece que no le crecen alas. Cambiemos eso." # TL
    ...
    new "A [kiara] definitivamente le encantarían las fiestas disco modernas. Puede que sea solo un sueño en Asthar, pero aún puedes darle el vestido apropiado." # TL

    # game/variables/outfits.rpy:84
    old "Hundreds of years of holding back, and now she's hornier than ever."
    new "Cientos de años de contenerse, y ahora está más excitada que nunca." # TL
...
translate spanish strings:
    ...
    new "Dale una zanahoria y hazla feliz." # TL
