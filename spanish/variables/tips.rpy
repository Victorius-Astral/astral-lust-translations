...
translate spanish strings:
    ...
    new "Tengo el presentimiento de que tendré un buen sueño."

    # game/variables/tips.rpy:4
    old "Who knows what awaits me outside?"
    new "¿Quién sabe lo que me espera afuera?"

    # game/variables/tips.rpy:4
    old "I need to take care of my mental health."
    new "Necesito cuidar mi salud mental."

    # game/variables/tips.rpy:4
    old "Maybe someone can answer my questions out there."
    new "Tal vez alguien ahí fuera pueda responder a mis preguntas."

    # game/variables/tips.rpy:4
    old "I wonder if I would turn insane if it spoke to me again.."
    new "Me pregunto si me volvería loco si me hablara de nuevo..."

    # game/variables/tips.rpy:4
    old "My dreams are becoming more disturbing as of late."
    new "Últimamente mis sueños se están volviendo más perturbadores."

    # game/variables/tips.rpy:4
    old "I should focus on my relationship with Lexi"
    new "Debería centrarme en mi relación con Lexi"

    # game/variables/tips.rpy:4
    old "I need to ask Kiara about this.. being.."
    new "Necesito preguntarle a Kiara sobre éste... ser..."

    # game/variables/tips.rpy:4
    old "I should wait for her to return, I hope, she's safe."
    new "Debería esperar a que ella regrese. Espero que esté a salvo."

    # game/variables/tips.rpy:4
    old "More coming soon."
    new "Más próximamente."

    # game/variables/tips.rpy:4
    old "She might need some help."
    new "Podría necesitar ayuda."

    # game/variables/tips.rpy:4
    old "Maybe I should go out?"
    new "¿Quizás debería salir?"

    # game/variables/tips.rpy:4
    old "Maybe I'll find something she likes outside, should I ask her?"
    new "Tal vez encuentre algo que le guste afuera, ¿debería preguntarle?"

    # game/variables/tips.rpy:4
    old "I have trouble falling asleep at night."
    new "Tengo problemas para conciliar el sueño por la noche."

    # game/variables/tips.rpy:4
    old "I think I should hang out with Mina."
    new "Creo que debería pasar el rato con Mina."

    # game/variables/tips.rpy:4
    old "She seems to have something on her mind recently. I should ask."
    new "Parece que recientemente tiene algo en mente. Debería preguntar."

    # game/variables/tips.rpy:4
    old "Maybe she knows another café nearby."
    new "Tal vez conozca otro café cercano."

    # game/variables/tips.rpy:4
    old "We should talk about last events."
    new "Deberíamos hablar de los últimos eventos."

    # game/variables/tips.rpy:4
    old "Let's say hello and wait for her to find me."
    new "Digamos hola y esperemos a que ella me encuentre."

    # game/variables/tips.rpy:4
    old "Something tells me that she will need me in near future."
    new "Algo me dice que me necesitará en un futuro próximo."

    # game/variables/tips.rpy:4
    old "I should go out off my room sometimes."
    new "A veces debería salir de mi habitación."

    # game/variables/tips.rpy:4
    old "When Alice likes me enough (Affection > 4, Trust > 0) I should talk with Mina and then Alice at the evening."
    new "Cuando le guste lo suficiente a Alice (Afecto > 4, Confianza > 0) debería hablar con Mina y luego con Alice en el anochecer."

    # game/variables/tips.rpy:4
    old "I wonder what's up with Lexi."
    new "Me pregunto qué pasa con Lexi."

    # game/variables/tips.rpy:4
    old "I should check on her."
    new "Debería ver cómo está."

    # game/variables/tips.rpy:4
    old "It would be nice to accompany her a little."
    new "Sería bueno acompañarla un poco."
    ...
    new "Debería darle unos días para pensar."
    ...
    new "Debería hablar con Lexi."

    # game/variables/tips.rpy:4
    old "I should hang out with her."
    new "Debería salir con ella."

    # game/variables/tips.rpy:4
    old "I kind of liked sitting with her at the sofa, we should do this again. I think she would find some time at the evening."
    new "Me gustaba sentarme con ella en el sofá, deberíamos hacerlo de nuevo. Creo que puedrá durante el anochecer."

    # game/variables/tips.rpy:4
    old "I should wait for her to settle her own thing with Alice."
    new "Debería esperar a que ella arregle lo suyo con Alice."

    # game/variables/tips.rpy:4
    old "I should prepare before coming out of my room."
    new "Debería prepararme antes de salir de mi habitación."

    # game/variables/tips.rpy:4
    old "I should find her when she is in her room."
    new "Debería encontrarla cuando esté en su habitación."

    # game/variables/tips.rpy:4
    old "I wonder what she does in her room during evenings."
    new "Me pregunto qué hace en su habitación durante el anochecer."

    # game/variables/tips.rpy:4
    old "I suddenly feel like seeing her, should I check if she is at home?"
    new "De repente tengo ganas de verla, ¿debería ver si está en casa?"

    # game/variables/tips.rpy:4
    old "Maybe she needs my help again."
    new "Tal vez necesite mi ayuda de nuevo."

    # game/variables/tips.rpy:4
    old "I could use a meal, maybe Grace left something for me in the fridge."
    new "Me vendría bien comer algo. Tal vez Grace me dejó algo en la nevera."

    # game/variables/tips.rpy:4
    old "I wonder if she is cooking this afternoon."
    new "Me pregunto si estará cocinando esta tarde."

    # game/variables/tips.rpy:4
    old "Maybe there are some beautiful flowers outside. I'm sure she would appreciate them."
    new "Tal vez haya algunas flores hermosas afuera. Estoy seguro de que ella las apreciaría."

    # game/variables/tips.rpy:4
    old "I should go and say hello."
    new "Debería ir a saludar."
    ...
    new "Me pregunto cómo lidia con la lujuria después de chuparme tanto."

    # game/variables/tips.rpy:4
    old "I should train from time to time."
    new "Debería entrenar de vez en cuando."

    # game/variables/tips.rpy:4
    old "She looks down lately, I should speak with her."
    new "Últimamente se ve decaída. Debería hablar con ella."
    ...
    new "Debería ver cómo está de nuevo en un rato."

    # game/variables/tips.rpy:4
    old "It was her first time, I should ask her how she's feeling."
    new "Era su primera vez, debería preguntarle cómo se siente."

    # game/variables/tips.rpy:4
    old "Who knows what awaits me in the morning."
    new "Quién sabe lo que me espera por la mañana."

    # game/variables/tips.rpy:4
    old "Perhaps only death could make her more interested in me."
    new "Quizás sólo la muerte podría hacerla interesarse más en mí."

    # game/variables/tips.rpy:4
    old "I wonder if she has any way to help me?"
    new "Me pregunto si tiene alguna forma de ayudarme."
...
translate spanish strings:
    ...
    new "¿Quizás alguien se fijará en mí si viajo a menudo?"
...
translate spanish strings:
    ...
    new "Tengo mucha curiosidad por su portátil. ¿Tal vez debería revisarla de nuevo y preguntarle?"

    # game/variables/tips.rpy:4
    old "She asked me to get 2 ice creams for our date, I should return to her when I get them to arrange a date."
    new "Ella me pidió que comprara 2 helados para nuestra cita, debería regresar con ella cuando los consiga para arreglar una cita."

    # game/variables/tips.rpy:4
    old "The last drinking session with her got us really drunk, maybe she wants another go?"
    new "La última vez que bebí con ella nos emborrachó mucho, ¿quizás quiere otra?"
...
translate spanish strings:
    ...
    new "Debería encontrarla cuando salga a tomar aire fresco."
