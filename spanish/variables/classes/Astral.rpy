...
translate spanish strings:
    ...
    new "Este es el final de la historia de {who} en {ver}. ¡Esta historia continuará pronto! Puede consultar las noticias y la nueva versión en mi {{patreon1}}{{a=https://www.patreon.com/Victorius}}Patreon{{/a}}{{/patreon1}}."

    # game/variables/classes/Astral.rpy:457
    old "Unique cards obtained: {}"
    new "Cartas únicas obtenidas: {}"

    # game/variables/classes/Astral.rpy:461
    old "Unique card obtained: {}"
    new "Carta única obtenida: {}"
...
translate spanish strings:
    ...
    new "Este es el fin da la historia de {who} en la versión {ver}. Sin embargo, el juego permanece en desarrollo activo! Si desea comprobar u obtener nuevas versiones, o simplemente apoyar a Astral Lust, consulte nuestro {{patreon1}}{{a=https://www.patreon.com/Victorius}}Patreon{{/a}}{{/patreon1}}! Diviértete :)"
