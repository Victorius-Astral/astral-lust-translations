...
translate spanish strings:
    ...
    new "Serás {{ef}}Vulnerable{{/ef}} por {vulnerable} turnos, pero tu equilibrio inestable te dará un {dodge}% de probabilidad de esquivar un ataque durante el combate. Este efecto se reduce en {sleep} cada vez que duermes y en 1 cada vez que luchas."

    # game/functions/buffs/list.rpy:38
    old "Succubi Hormones"
    new "Hormonas de Succubus"
    ...
    new "La ves cada vez que cierras los ojos, sus suaves gemidos reverberan en tus oídos. La lujuria desenfrenada te perseguirá incluso en tus sueños."
    ...
    new "Nada contamina tu mente, los sueños no aparecerán a atormentarte."
    ...
    new "Tus pensamientos no te dejan lugar para descansar, la noche va a ser larga... Esta noche seguramente vas a soñar."

    # game/functions/buffs/list.rpy:38
    old "Devil's Call"
    new "Llamado del diablo"

    # game/functions/buffs/list.rpy:38
    old "{evil}'He' is calling you.{/evil}"
    new "{evil}'Él' te está llamando.{/evil}"
    ...
    new "Sueños dichosos te esperan."
    ...
    new "Aterradoras pesadillas están a punto de acontecerte."

    # game/functions/buffs/list.rpy:38
    old "Spiritual Infusion"
    new "Infusión Espiritual"
    ...
    new "Tu espíritu está lleno de la espiritualidad remanente de los rituales. Si la pila es de 4 o más durante el sueño, se convertirá en {ef}Mancha Espiritual{/ef}, lo que te impedirá realizar rituales por x días. Si la pila está al máximo, cada ritual dañará tu cordura en un 10% + otro 10% por cada ritual siguiente. El sueño reduce la acumulación en 1."

    # game/functions/buffs/list.rpy:38
    old "Spiritual Taint"
    new "Mancha Espiritual"
    ...
    new "Tu espíritu estaba contaminado con una espiritualidad abrumadora que te hace delirar. Sonidos indescriptibles resuenan dentro de tu mente, y elusivas figuras sombrías contaminan tu vista. No puedes realizar rituales. El sueño reduce la acumulación en 1."
    ...
    new "Inflige al azar efectos negativos aleatorios al comienzo de la batalla. La cantidad y la gravedad de los efectos son mayores cuanto más alta la acumulación de {ef}Degeneración{/ef}."

    # game/functions/buffs/list.rpy:38
    old "Blessing - [effects['heart_of_flames'][0]!t]"
    new "Bendición - [effects['heart_of_flames'][0]!t]"

    # game/functions/buffs/list.rpy:38
    old "You have been imbued with certain effects. They will be triggered in combat."
    new "Has sido imbuido con ciertos efectos. Se activarán en combate."
