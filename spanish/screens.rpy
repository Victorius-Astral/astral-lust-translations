...
translate spanish strings:
    ...
    old "End Replay"
    new "Terminar Replay" # TL

    # game/screens.rpy:317
    old "Main Menu"
    new "Menú Principal" # TL
    ...
    old "{#auto_page}A"
    new "{#auto_page}A" # TL # Victorius - AI

    # game/screens.rpy:689
    old "{#quick_page}Q"
    new "{#quick_page}Q" # TL # Victorius - AI
    ...
    new "El historial de diálogo está vacío." # TL
    ...
    new "Avanza diálogo y activa la interface." # TL
    ...
    new "Avanza diálogo (si no hay opciones)." # TL

    # game/screens.rpy:982
    old "Arrow Keys"
    new "Teclas de dirección" # TL

    # game/screens.rpy:983
    old "Navigate the interface."
    new "Navegar por la interfaz." # TL
    ...
    new "Accede al menú de juego." # TL

    # game/screens.rpy:990
    old "Ctrl"
    new "Ctrl" # TL # Victorius - AI

    # game/screens.rpy:991
    old "Skips dialogue while held down."
    new "Omite el diálogo mientras está presionado." # TL

    # game/screens.rpy:994
    old "Tab"
    new "Tab" # TL # Victorius - AI

    # game/screens.rpy:995
    old "Toggles dialogue skipping."
    new "Alterna el salto de diálogo." # TL

    # game/screens.rpy:998
    old "Page Up"
    new "Página arriba (Re Pág)" # TL

    # game/screens.rpy:999
    old "Rolls back to earlier dialogue."
    new "Vuelve al diálogo anterior." # TL

    # game/screens.rpy:1002
    old "Page Down"
    new "Página abajo (Av Pág)" # TL

    # game/screens.rpy:1003
    old "Rolls forward to later dialogue."
    new "Avanza al diálogo posterior." # TL

    # game/screens.rpy:1007
    old "Hides the user interface."
    new "Oculta la interfaz de usuario." # TL

    # game/screens.rpy:1011
    old "Takes a screenshot."
    new "Captura de pantalla." # TL

    # game/screens.rpy:1015
    old "Toggles assistive {a=https://www.renpy.org/l/voicing}self-voicing{/a}."
    new "Alterna la {a=https://www.renpy.org/l/voicing}auto-voz{/a} asistida." # TL

    # game/screens.rpy:1021
    old "Left Click"
    new "Click Izquierdo" # TL
    ...
    old "Left Trigger\nLeft Shoulder"
    new "Gatillo Izquierdo\nHombro Izquierdo" # TL # Victorius - AI

    # game/screens.rpy:1052
    old "Right Shoulder"
    new "Hombro Derecho" # TL # Victorius - AI

    # game/screens.rpy:1057
    old "D-Pad, Sticks"
    new "D-Pad, Palancas" # TL # Victorius - AI

    # game/screens.rpy:1061
    old "Start, Guide"
    new "Inicio, Guía" # TL # Victorius - AI

    # game/screens.rpy:1065
    old "Y/Top Button"
    new "Y/Botón superior" # TL
...
translate spanish strings:
    ...
    new "{color=#FF424D}¡El juego puede desarrollarse gracias a todos mis patrocinadores.!{/color}" # TL

    # game/screens.rpy:596
    old "{color=#FF424D}\nHigh tier Patrons:{/color}"
    new "{color=#FF424D}\nPatrons de alto nivel:{/color}" # TL

    # game/screens.rpy:598
    old "{color=#00ffb6}\nEditor: Strectmar{/color}"
    new "{color=#00ffb6}\nEditor: Strectmar{/color}" # TL # Victorius - AI

    # game/screens.rpy:599
    old "{color=#DB3A17}\nPR: nickthewolf{/color}"
    new "{color=#DB3A17}\nPR: nickthewolf{/color}" # TL # Victorius - AI

    # game/screens.rpy:600
    old "{color=#c13a3a}\nCommunity: Denker{/color}"
    new "{color=#c13a3a}\nComunidad: Denker{/color}" # TL

    # game/screens.rpy:602
    old "{color=#b96d19}\nTranslation: Denker(Spanish), Victorius(Polish){/color}"
    new "{color=#b96d19}\nTraducción: Denker(Español), Victorius(Polaco){/color}" # TL

    # game/screens.rpy:604
    old "\n\nMusic: {a=https://www.bensound.com}www.bensound.com{/a}, {a=https://www.zapsplat.com}www.zapsplat.com{/a}"
    new "\n\nMúsica: {a=https://www.bensound.com}www.bensound.com{/a}, {a=https://www.zapsplat.com}www.zapsplat.com{/a}" # TL

    # game/screens.rpy:605
    old "\nSounds: {a=https://www.zapsplat.com}www.zapsplat.com{/a}"
    new "\nSonidos: {a=https://www.zapsplat.com}www.zapsplat.com{/a}" # TL
    ...
    new "\nIconos: {a=https://www.game-icons.net}Lorc, Dealpouite, Guard13007, sbed and Faithtoken (some icons merged with other icons) from Game-icons.net{/a} under {a=https://creativecommons.org/licenses/by/3.0/}CC BY 3.0{/a}, {a=https://www.iconpacks.net}iconpacks.net{/a}, {a=https://www.freepik.com}Freepik{/a} from {a=https://www.flaticon.com/}www.flaticon.com{/a}" # TL

    # game/screens.rpy:607
    old "\nArt: Niklaus, Victorius{a=https://www.pixabay.com}www.pixabay.com{/a}"
    new "\nArte: Niklaus, Victorius{a=https://www.pixabay.com}www.pixabay.com{/a}" # TL
    ...
    new "\nCreepypasta: Ashley Rose Wellman (llamadas telefónicas), Andrew LaBelle (ducha), Mycool of The Fear Collective (dormir), Ryan Brennaman (sepulturero)" # TL
    ...
    new "\nModelos hechos en {a=https://dlsoft.dmm.co.jp/detail/illusion_0030/}Honey Select 2{/a} por {a=http://www.illusion.jp}Illusion{/a}" # TL
...
translate spanish strings:
    ...
    new "{color=#00ffb6}\nEditor: {a=https://kasami-lee.carrd.co/}Kasami Lee{/a}, Strectmar{/color}" # TL # Victorius - AI

    # game/screens.rpy:670
    old "\nContributed Code: cuckoo4cocoapuffs"
    new "\nCódigo Contribuído: cuckoo4cocoapuffs" # TL
    ...
    new "\n\nMúsica: {a=https://www.bensound.com}www.bensound.com{/a}, {a=https://www.zapsplat.com}www.zapsplat.com{/a}, An Innermost Glow by The Longshore Striders" # TL
    ...
    new "\nIconos: {a=https://www.game-icons.net}Lorc, Dealpouite, Guard13007, sbed, Skoll and Faithtoken (algunos íconos fusionados con otros íconos) de Game-icons.net{/a} bajo {a=https://creativecommons.org/licenses/by/3.0/}CC BY 3.0{/a}, {a=https://www.iconpacks.net}iconpacks.net{/a}, {a=https://www.freepik.com}Freepik{/a} from {a=https://www.flaticon.com/}www.flaticon.com{/a}" # TL
...
translate spanish strings:
    ...
    new "¿Quieres reiniciar el juego? Si no lo haces, algunas cosas no cambiarán de lenguaje." # TL
