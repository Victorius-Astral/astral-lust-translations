...
translate spanish lexi_menu1_197a6b26:
    ...
    "Ella ya me dijo qué hacer. Tal vez debería volver, todavía podría haber comida allí."
...
translate spanish lexi_menu1_1f45fd8a:
    ...
    lexi "Sí, necesito buscar algo de comida, ¿quieres venir?"
...
translate spanish lexi_menu1_c319f7ba:
    ...
    lexi "Más gente significa ser más fácil de encontrar, y ser encontrado es a menudo sinónimo de muerte."
...
translate spanish lexi_menu1_6d1b0c17:
    ...
    me "Con más gente sería posible resistir algunos peligros."
...
translate spanish lexi_menu1_c6c040eb:
    ...
    lexi "Sí, pero muchos de los peligros del exterior están más allá de lo que los números pueden ayudar a superar. En una situación como esa, moriríamos más de nosotros. Si muero sola, todavía habrá alguien para salir a buscar comida."

# game/characters/lexi/speak.rpy:51
translate spanish lexi_menu1_b2c681a5:

    # th "How can she talk about her death so casually?"
    th "¿Cómo puede hablar de su muerte tan casualmente?"

# game/characters/lexi/speak.rpy:52
translate spanish lexi_menu1_72663b8c:

    # me "We are together, right now."
    me "Estamos juntos, ahora mismo."
...
translate spanish lexi_menu1_bfc3d94a:
    ...
    lexi "Sí, de esa manera podemos traer más cosas. Si ambos morimos, todavía queda Alice para salir a recolectar."

# game/characters/lexi/speak.rpy:54
translate spanish lexi_menu1_f68de440:

    # me "What about Mina and Grace?"
    me "¿Qué pasa con Mina y Grace?"
...
translate spanish lexi_menu1_d47016da:
    ...
    lexi "Sí, sería un espectáculo hilarante de contemplar."
...
translate spanish lexi_menu1_424de8a1:
    ...
    lexi "Llegamos a salvo. Yo traeré la comida. Tú busca cualquier otra cosa que pueda ser útil."
...
translate spanish lexi_menu1_e1cca951:
    ...
    lexi "Estoy lista, ¿qué hay de ti?"
...
translate spanish lexi_menu1_af81b1bc:
    ...
    me "Es tu mano la que no puedo olvidar."
...
translate spanish lexi_menu2_c0d10f05:
    ...
    lexi "Necesitamos muchas cosas para vivir, y sin mejor lugar para guardarlas, solo las ponemos en cajas."
...
translate spanish lexi_menu2_9c6a8b64:
    ...
    me "¿Por qué no los pusiste en mi habitación? No habrían estado en el camino de nadie allí."
...
translate spanish lexi_menu2_77c50307:
    ...
    lexi "En realidad, había alguien viviendo allí antes."
...
translate spanish lexi_menu2_e2a78ff3:
    ...
    me "Supongo que esta no es una historia feliz. ¿Quién era?"
...
translate spanish lexi_menu2_ade7a944:
    ...
    lexi "El dueño de este hotel, su nombre era Jack y fue muy amable con nosotras. Nos dejó quedarnos aquí cuando no teníamos a dónde ir."
...
translate spanish lexi_menu2_89519497:
    ...
    lexi "Salió una semana antes de que aparecieras... Nunca volvió..."
...
translate spanish lexi_menu2_7229f95d:
    ...
    lexi "Estaba asistiendo a la escuela. No me gustaba estudiar, y pensaba que mi vida era dura... Que ingenua fui..."

# game/characters/lexi/speak.rpy:142
translate spanish lexi_menu2_5758e325:

    # me "Student? Then how old are you?"
    me "¿Estudiante? Entonces, ¿cuántos años tienes?"
...
translate spanish lexi_menu2_8d40e353:
    ...
    lexi "No sé de lo que estás hablando."
...
translate spanish strings:
    ...
    new "¿Puedo ayudarte de alguna manera?"
    ...
    new "¿Necesitas a alguien que te cuide las espaldas afuera?"
    ...
    new "¿Por qué hay tantas cajas de cartón?"

    # game/characters/lexi/speak.rpy:118
    old "What were you doing before The End?"
    new "¿Qué estabas haciendo antes de El Fin?"
...
translate spanish speak_lexi_tasks_4e561a35:
    ...
    me "Sip. Cambiaron las circumstancias."
...
translate spanish speak_lexi_tasks_5c751c2c:
    ...
    lexi "Entiendo. ¿Necesitas que haga algo más?"
...
translate spanish speak_lexi_tasks_28863e87:
    ...
    lexi "No te preocupes. Estaré bien."
...
translate spanish strings:
    ...
    new "¿Quieres ir a explorar juntos? {gold}(Historia){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "How about we do it again? {gold}(Story){/gold}"
    new "¿Qué tal si lo hacemos de nuevo? {gold}(Historia){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "Let's go on a date {gold}(Story){/gold}"
    new "Tengamos una cita {gold}(Historia){/gold}"
    ...
    new "Pregúntale si está bien {gold}(Historia){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "Need some help? {gold}(Story){/gold}"
    new "¿Necesitas ayuda? {gold}(Historia){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "Can I help you somehow? {gold}(Story){/gold}"
    new "¿Puedo ayudarte de alguna manera? {gold}(Historia){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "I have the ice cream {gold}(Story){/gold}"
    new "Tengo el helado {gold}(Historia){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "Need someone to watch your back outside? {loot}(Materials+){/loot}{trust}(Trust+){/trust}"
    new "¿Necesitas a alguien que te cuide las espaldas afuera? {loot}(Materiales+){/loot}{trust}(Confianza+){/trust}"

    # game/characters/lexi/speak.rpy:12
    old "Do you want a massage? {#visible}"
    new "¿Quieres un masaje? {#visible}"
    ...
    new "Recolecta materiales (Duration: [lexiTasks.scavengeMaterials.duration]) {loot}(Materiales+){/loot} {#visible}"
...
translate spanish strings:
    ...
    new "Habla de su propia muerte con tranquilidad, como si hablara de otra persona."
