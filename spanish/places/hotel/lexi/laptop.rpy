...
translate spanish room_lexi_laptop_6f9990bf:
    ...
    "WiP, estará disponible en 0.1.6." # TL
...
translate spanish room_lexi_laptop_0ec44295:
    ...
    th "¿Debería preguntarles? Mejor no, tendría que explicar por qué estaba fisgoneando en su portátil cuando tengo mi propia PC..." # TL
...
translate spanish room_lexi_laptop_insert_4802d0af:
    ...
    th "Quizás debería dejarlo por ahora..." # TL

translate spanish strings:

    # game/places/hotel/lexi/laptop.rpy:18
    old "Insert password"
    new "Ingresar contraseña" # TL
...
translate spanish room_lexi_laptop_insert_f80bd77c:
    ...
    victorius "{gold}¡Buen intento! Puedes probar esto en otro juego.{/gold}" # TL
