...
translate spanish strings:
    ...
    new "La moneda básica utilizada por los Errantes. ¿Qué les hizo considerar esto precioso? Nadie sabe."
    ...
    new "Nadie sabe el origen ni el uso de estas monedas, pero hay un ser enloquecido dispuesto a cambiar varios tesoros por ellas."
    ...
    new "El recurso natural más duradero de la tierra, que consiste en carbono. Es conocido por su belleza, convirtiéndose en un gran regalo cuando se incrusta en la joyería."
    ...
    new "Material básico utilizado tanto para la construcción como para la elaboración. Hay mucho de eso por ahí."
    ...
    new "Material básico utilizado mayoritariamente para la construcción. Se puede encontrar en todas partes en la ciudad arruinada."
    ...
    new "Material muy útil utilizado en casi todas partes, está presente en todas partes en el mundo moderno."

    # game/screens/menu/inventory.rpy:344
    old "Material used in variety of clothing."
    new "Material usado en variedad de ropas."
    ...
    new "Comúnmente utilizado como combustible en fundición y generación de energía. También conocido como el 'oro negro' en la región de Silesia."
