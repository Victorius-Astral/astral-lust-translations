...
translate spanish strings:
    ...
    new "\n{color=#FFD700}--- Estadísticas Físicas ---{/color}" # TL
    ...
    new "\n{color=#FFD700}--- Estadísticas Mentales ---{/color}" # TL
    ...
    old "[player.luck]\n[player.card_draw]\n[player.max_hand]"
    new "[player.luck]\n[player.card_draw]\n[player.max_hand]" # TL # Victorius - AI
...
translate spanish strings:
    ...
    new "{b}{u}{color=#E4CA48}Suerte{/color}{/b}{/u}\n{small}Aumenta posibilidad de buenas cartas., disminuye la posibilidad de encontrarse con oponentes fuertes. Usa códigos de Discord o comercia con ciertos seres.{/small}" # TL
