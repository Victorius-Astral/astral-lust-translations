...
translate spanish strings:
    ...
    new "{a=https://astral-lust-documentation.readthedocs.io/en/latest/changelogs/full.html#changelog-full}{color=#2839fc}{i}Leer el registro de cambios completo{/i}{/color}{/a}" # TL
    ...
    new "Puedes ver más noticias, avances y contenido en {a=https://www.patreon.com/Victorius}{color=#2839fc}{i}Patreon{/i}{/color}{/a} y {a=https://discord.gg/rvnBC39USx}{color=#2839fc}{i}Discord{/i}{/color}{/a}." # TL
    ...
    new "¡En este lanzamiento aparecieron cuatro nuevas cartas únicas en Asthar! Todas son parte del 1er Aniversario de Astral Lust. La carta Fuegos Artificiales está disponible en {a=https://www.patreon.com/Victorius}{patreon1}Patreon{/patreon1}{/a} y {a=https://discord.gg/rvnBC39USx}{patreon1}Discord{/patreon1}{/a} para todos. Las tres restantes son para todos los Patrones. Una de ellas permite convocar a varias chicas como aliadas - ¡Delirios!" # TL

    # game/screens/utility/what_new.rpy:189
    old "{b}Interactions Menu{/b}"
    new "{b}Menú de interacciones{/b}" # TL
    ...
    new "¡Hay un gran cambio de calidad de vida aquí! Ahora no necesita verificar en qué se puede hacer clic cada vez. ¡Además de los secretos, los otros elementos para interactuar en el modo libre ahora tienen el botón en la esquina inferior izquierda! Esta ventana se puede desactivar en configuración, y con la tecla 'I'." # TL

    # game/screens/utility/what_new.rpy:194
    old "{b}Other Changes{/b}"
    new "{b}Otros Cambios{/b}" # TL
    ...
    new "De los muchos cambios, los más notables serían los menús de opciones que ahora están en la parte derecha de la pantalla (puede cambiarse en configuración), y el menú de tareas ahora se puede desactivar con la tecla 'T' o en la configuración. También se agregó una nueva arena, y los ataques de absorción ahora tienen un nuevo ícono de intención. Esta versión corrige muchos bugs, y cientos de errores tipográficos y problemas de gramática." # TL

    # game/screens/utility/what_new.rpy:211
    old "{b}Christmas Event{/b}"
    new "{b}Evento de Navidad{/b}" # TL
    ...
    new "¡Apareció un evento de tiempo limitado! ¡Juega una serie de 7 eventos con temas navideños y derrota al Espíritu Navideño! Una vez que se vio el evento, no puede ver otro hasta el día siguiente (tiempo real). ¡Tienes tiempo hasta el 10 de enero para derrotar al Espíritu!" # TL

    # game/screens/utility/what_new.rpy:224
    old "{b}Lexi's Massage{/b}"
    new "{b}Masajea a Lexi{/b}" # TL
    ...
    new "Mina tuvo su masaje de pies, ¡ahora es el momento de que la otra hermana tenga su parte de tus habilidades de masaje! ¡Muchos atuendos para combinar con las nuevas calientes escenas H!" # TL
    ...
    new "¡Conoce a Rachel, la segunda chica zorra introducida! Along with Little Fox there are 11 new story events and 3 repeatable events for the fox girls. Build the foxshrine and get the two vixens to live with you! There is also a new outfit for the Little Fox!" # TL

    # game/screens/utility/what_new.rpy:259
    old "{b}New Grace activities{/b}"
    new "{b}Nuevas activities con Grace{/b}" # TL
    ...
    new "¿Alguna vez quiso ayudar a Grace con las tareas del hotel? ¿Tal vez querías jugar a la casita con ella? ¡Ahora es posible! Ayúdala, y ella definitivamente estaría agradecida. {b}¡Muéstrale que hay hombres buenos en este mundo!{/b} {i}Ella podría hacer preguntas extrañas de matemáticas. Has sido advertido.{/i}" # TL

    # game/screens/utility/what_new.rpy:272
    old "{b}Adventure with Lexi{/b}"
    new "{b}Aventura con Lexi{/b}" # TL

    # game/screens/utility/what_new.rpy:273
    old "Go out and get some supplies with Lexi, be prepared for trouble!"
    new "¡Sal y consigue algunos suministros con Lexi y prepárate para los problemas!" # TL
    ...
    new "¡Tres nuevos eventos de historia con Savenia! ¿Qué pasaría una vez que su pierna mejore? ¿Se irá?" # TL

    # game/screens/utility/what_new.rpy:295
    old "{b}New exploration events{/b}"
    new "{b}Nuevos eventos de exploración{/b}" # TL
    ...
    new "¡Hay cuatro nuevos eventos de exploración listos para ti! Salva a las damas, sé engañado, caza dragones y huye de gigantes. Personajes pedidos aparecen - Hija del Comerciante y 'flashy' la bandida. ¡También hay una mujer embarazada en peligro! ¡Sálvala a ella y a su hijo por nacer!" # TL

    # game/screens/utility/what_new.rpy:307
    old "{b}New dream{/b}"
    new "{b}Nuevo sueño{/b}" # TL
    ...
    new "¡Hay un sueño divertido esperándote! ¿Alguna vez imaginaste lo que el futuro le depara? Cae en el cálido abrazo de Alice y disfruta de tu nueva vida." # TL
    ...
    new "¡Ahora puedes construir mazos en serio! Construye hasta tres mazos y elije tus tácticas según tus enemigos. Se eliminó el almacenamiento de cartas en la Bodega, y en su lugar se agregó almacenamiento infinito. Los mazos permiten clasificar las cartas según varios criterios, con varias opciones de visualización." # TL

    # game/screens/utility/what_new.rpy:324
    old "{b}Combat tutorial{/b}"
    new "{b}Tutorial de combate{/b}" # TL
    ...
    new "Se introdujo un nuevo tutorial de combate. ¡Deja que Lexi te guíe por los conceptos básicos del combate! Se puede lanzar desde la puerta exterior del vestíbulo." # TL
    ...
    new "¿Alguna vez te preguntaste por qué Lexi no te trae cosas del exterior? ¡No lo pienses más, solo pídele que lo haga! Actualmente, se pueden asignar tareas a Lexi, Mina, Alice y Grace." # TL
    ...
    new "¡Ahora puedes obtener varios buffs! Te ayudarán en el combate, consíguelos asignando tareas a las chicas. Los buffs activos aparecerán en el menú del personaje." # TL

    # game/screens/utility/what_new.rpy:339
    old "{b}Combat additions{/b}"
    new "{b}Adiciones de combate{/b}" # TL
    ...
    new "Tres nuevos enemigos bandidos te esperan. ¡Patea sus traseros! Puedes hacerlo con la ayuda de un nuevo efecto de estado - Hunter's Mark, y las dos nuevas cartas Snipe y Frag Grenade." # TL
    ...
    new "¿Curioso sobre el antiguo dueño del hotel? Pregúntale a las chicas, tal vez dirán algo útil. ¡Grace, Mina y Alice tienen un nuevo tema de conversación!" # TL
    ...
    new "Hay muchas otras pequeñas adiciones y cambios aquí y allá. Interfaz gráfica del diario/códice cambió para hacerlo más legible. Hay muchos cambios de calidad de vida, como crafting usando materiales de la bóveda también." # TL

    # game/screens/utility/what_new.rpy:375
    old "{b}Mina at the Vault{/b}"
    new "{b}Mina en la Bóveda{/b}" # TL
    ...
    new "¡Mina ahora puede aparecer en la bóveda! Ella tiene un nuevo tema para hablar con nosotros. También hay unas dos escenas H por ahí." # TL

    # game/screens/utility/what_new.rpy:389
    old "{b}Past Lives{/b}"
    new "{b}Vidas pasadas{/b}" # TL
    ...
    new "¡Nuevo evento secundario para la historia principal! Este evento comparte más lo que parece a primera vista. Es el preludio a la verdad sobre Asthar." # TL

    # game/screens/utility/what_new.rpy:400
    old "{b}Damsel in Distress{/b}"
    new "{b}Damisela en apuros{/b}" # TL
    ...
    new "¡Hay cinco nuevos eventos de exploración! Todos con tema de damisela en apuros. Puedes intentar derrotar a los monstruos y ver lo agradecidas que pueden estar estas damiselas." # TL

    # game/screens/utility/what_new.rpy:412
    old "{b}Heart of Flames{/b}"
    new "{b}Corazón de Llamas{/b}" # TL
    ...
    new "Hay un nuevo efecto de estado, y una carta que lo otorga. Corazón de Llamas hace que daño recibido por el debuff 'ardiendo' te cure en lugar de dañarte. Tanto el efecto como la carta se pueden encontrar en el dragón." # TL
    ...
    new "{b}Combate 2.0{/b}\nEs el foco principal de esta versión, completamente cambiando la forma en que Astral Lust se juega. El combate y todo lo que involucra fue completamente rediseñado. Ahora se separa a los enemigos, lo que permite muchas combinaciones de equipos enemigos. Además, cuando buscas enemigos, ahora puedes seleccionar si quieres oponentes más débiles o más fuertes. Puedes ver lo que hará el enemigo mucho más claramente, con la mayoría habiendo sido reequilibrados." # TL
    ...
    new "{b}Cartas 2.0{/b}\nCartas fueron completamente rediseñadas, ahora mostrando que tipo de objetivo afectan. El indicador está abajo a la izquierda. \n\n• {color=#9d0000}Rojo{/color} - enemigo, \n• {color=#018000}Verde{/color} - aliado/jugador, \n• {color=#0013d7}Azul{/color} - jugador.\n\nAhora también calculan su efecto, así que cuando tienes un buff de Fuerza mostrarán cuanto daño harás al enemigo, después de tomar en cuenta todos los efectos de estado de un objetivo. Adicionalmente muchas cartas fueron reequilibradas, o tuvieron su efecto en sí cambiado." # TL
    ...
    new "{b}Beso de Medianoche{/b}\nEste nuevo evento ocurre en el de exploración del mercado, con un 12% de probabilidad de activarse cuando se buscan suministros. Está basado en una historia que me contó un amigo, aparentemente una vieja leyenda urbana de EE. UU. Este evento puede enseñarte mucho sobre el lore, si seleccionas las opciones adecuadas. Cientos de líneas de lore. Para que esté disponible, primero debes completar el 12º evento de la historia principal." # TL
    ...
    new "{b}Vista del Mazo Revisada{/b}\nAhora, al revisar su mazo, o tomar/descartar pilas, verás información sobre herramientas que explica los efectos de estado de la carta señalada. Esta característica fue muy solicitada por la comunidad. Adicionalmente esta función funciona en la forja y la bóveda. Puedes verlo en las cartas superiores." # TL
    ...
    new "{b}Ver Todas las Cartas{/b}\n Se agregó nueva función a la pc. ¡Te permite comprobar todas las cartas del juego! Puedes ver las cartas necesarias para construir el mazo de tus sueños y también verificar los meta cambios entre versiones." # TL
    ...
    new "{b}Besos{/b}\nEl enfoque de esta versión se centró en mini eventos y nuevas características de calidad de vida. Las adiciones más notables son los eventos de beso. Algunos de estos son mini eventos, pero otros son escenas mucho más largas y complejas. Estos presentan muchas escenas H nuevas, especialmente para Grace. Es decir, si puedes conseguirlos. No todo lo que puedes hacer en nuevos eventos es obvio. Algunas opciones necesitan que estés corrupto, incluso hasta un 60%, algunas requieren vitalidad o inteligencia. Los eventos de besos están mayoritariamente disponibles en modo SFW. Intenta besar a las chicas en varios lugares y condiciones para descubrir todas las escenas." # TL
    ...
    new "{b}Acariciar Mascotas{/b}\nLas mascotas fueron finalmente recordadas. Ahora puedes acariciar a tus amiguitos. Todos los lugares en los que aparecen las mascotas tienen una escena diferente." # TL
    ...
    new "{b}Savenia{/b}\nEste versión trae tres nuevos eventos de historia para Savenia, durante los cuales avanzaremos en nuestra relación más allá de la incomodidad inicial. También hay una nueva escena H repetible para ella. Se agregó compatibilidad con mapas para los eventos de su historia." # TL
    ...
    new "{b}Nuevas Opciones{/b}\nHay muchas configuraciones nuevas para que personalices tu juego. Puede forzar que se muestren máscaras interactivas incluso si los señalas con el mouse. Puede cambiar la opacidad del cuadro de texto, el contorno de la fuente y mucho más, una siendo poder elegir un conjunto de imágenes para el menú principal." # TL
    ...
    new "{b}Bóveda{/b}\n¡La bóveda se puede expandir de nuevo! Con 4 nuevos niveles, junto con efectos especiales, como las monedas no ocupando espacio, o multiplicadores de espacio. Bóveda T8 puede almacenar 600 artículos, 32 tarjetas y divisa ilimitada." # TL

    # game/screens/utility/what_new.rpy:566
    old "{b}Experience{/b}\nCharacters experience is now collected & displayed in their stats. (not in SFW mode)"
    new "{b}Experiencia{/b}\nLa experiencia de los personajes ahora se recopila y se muestra en sus estadísticas. (no en modo SFW)" # TL
...
translate spanish strings:
    ...
    new "Kiara obtuvo un nuevo evento de historia que explica el mito de la creación, creído por los seres extraordinarios. ¡No olvides divertirte después, 6 nuevas escenas de sexo, 3 nuevos atuendos y casi 300 animaciones! ¿Alguna vez te has tirado a una chica con tu clon?" # TL

    # game/screens/utility/what_new.rpy:195
    old "{b}Alice Shower Event{/b}"
    new "{b}Evento de Alice en la Ducha{/b}" # TL
    ...
    new "El evento de ducha de [alice] se amplió con una nueva escena. ¡Diviértete con tu chica y ayúdala a lavarse la espalda!" # TL

    # game/screens/utility/what_new.rpy:207
    old "{b}Lexi Brings Food{/b}"
    new "{b}Lexi Trae Comida{/b}" # TL
    ...
    new "Esta nueva interacción al azar entre [lexi] y [grace] te permitirá conocer a la chica un poco más. Hay cinco conversaciones diferentes." # TL

    # game/screens/utility/what_new.rpy:211
    old "{b}Outfit Crafting Menu{/b}"
    new "{b}Menú de Creación de Atuendos{/b}" # TL

    # game/screens/utility/what_new.rpy:212
    old "Now when asking [alice] to make outfit, you'll be able to use a new outfits menu!"
    new "¡Ahora, cuando le pidas a [alice] que haga un atuendo, podrás usar un nuevo menú de atuendos!" # TL
...
translate spanish strings:
    ...
    new "Hay innumerables otros cambios: TODAS las animaciones se pueden activar o desactivar en la configuración, se solucionaron docenas de problemas, no se agregó soporte de animación a todas las animaciones que no lo tenían, algunas animaciones se eliminaron, como animaciones de eyaculación de aspecto extraño. Se agregaron créditos finales del juego. Hollow Market ofrece mucho más stock y se reabastece semanalmente. Otros comerciantes también fueron modificados." # TL
...
translate spanish strings:
    ...
    old "{u}What's New{/u}"
    new "{u}Qué Hay de Nuevo{/u}" # TL

    # game/screens/utility/what_new.rpy:68
    old "Click outside to close this window, it can be entered again from the pc."
    new "Haz click afuera para cerrar esta ventana, puedes verla de nuevo desde la PC." # TL
...
translate spanish strings:
    ...
    new "{b}Mucho contenido nuevo de Grace{/b}" # TL
    ...
    new "Gracie tiene tres nuevos eventos de historia, una nueva mecánica de 'enojo y disculpa', nuevo contenido para cuando duerme (incluidos dos footjobs), un evento secreto y más. El último de sus nuevos eventos de historia se fusiona con los eventos de Alice y Little Fox. Oh, es un evento divertido ;)" # TL

    # game/screens/utility/what_new.rpy:191
    old "{b}New Lexi & Mina events{/b}"
    new "{b}Nuevos eventos de Lexi & Mina{/b}" # TL
    ...
    new "Como se mencionó anteriormente, Little Fox tiene un evento fusionado con Alice & Gracie. Rachel también consiguió un evento (finalmente algo de acción con ella: P), ¡Rhainda consiguió eventos de dos historias!" # TL

    # game/screens/utility/what_new.rpy:215
    old "{b}New items{/b}"
    new "{b}Nuevos objetos{/b}" # TL
    ...
    new "El prólogo fue hecho desde cero para ser mucho más grande, informativo e intrigante. Revisa las repeticiones o comienza un nuevo juego para verlo. Es posible que te encuentres con alguien inesperado ahí." # TL

    # game/screens/utility/what_new.rpy:258
    old "{b}A lot of other changes & additions{/b}"
    new "{b}Muchos otros cambios y adiciones{/b}" # TL
    ...
    new "El registro de cambios es muy largo. Hay alrededor de 30 errores corregidos, muchos cambios de calidad de vida, algunos sugeridos por la comunidad. Hay algunas otras mecánicas nuevas como que Mina puede tener resaca, negándose a entablar una conversación significativa, y dejar de trabajar en su tarea. El botín del auto abandonado se incrementó significativamente. Se agregaron los primeros sonidos de los ataques enemigos. Consulte el registro de cambios completo en este enlace." # TL
...
translate spanish strings:
    ...
    new "{b}Explora con Little Fox{/b}" # TL
    ...
    new "¡Ahora puedes llevar a Little Fox a una aventura! Encuéntrala durante la exploración, luego puedes salir con ella hablándole." # TL

    # game/screens/utility/what_new.rpy:187
    old "{b}Alice - Nun outfit{/b}"
    new "{b}Alice - Traje de monja{/b}" # TL

    # game/screens/utility/what_new.rpy:188
    old "In the corruption-filled Asthar, even the nuns are filled with unholy thoughts."
    new "En el Asthar lleno de corrupción, incluso las monjas están llenas de pensamientos impíos." # TL

    # game/screens/utility/what_new.rpy:196
    old "{b}Lola's 3rd event{/b}"
    new "{b}Tercer evento de Lola{/b}" # TL
    ...
    new "¡Lola finalmente tiene un nuevo evento! Se trata de dos caminos y tres escenas para adultos." # TL

    # game/screens/utility/what_new.rpy:205
    old "{b}A lot of changes{/b}"
    new "{b}Muchos cambios{/b}" # TL
    ...
    new "¡Se cambió la fuente del juego principal! Los coleccionables se guardan entre partidas. Las notificaciones de objetos ahora muestran su ícono. Hay muchos otros cambios, verifica el registro completo en la parte inferior para verlos." # TL
...
translate spanish strings:
    ...
    new "Realiza varios rituales y encantamientos que otorgan varios efectos. Hay dos rituales y cuatro seres a los que rezar. Uno manipulará lo que sueñas por la noche y el segundo mejorará o reducirá tu estado mental. ¡Mantente a salvo! ¡No reces a seres malignos! Busca a Kiara para aprenderlos una vez que la historia principal sea 12, o si aprendiste sobre el misticismo con Demeter, la chica ángel de pesadilla. Los rituales se realizarán en el altar de tu habitación." # TL

    # game/screens/utility/what_new.rpy:193
    old "{b}Control Your Dreams{/b}"
    new "{b}Controla Tus Sueños{/b}" # TL
    ...
    new "¡Puedes usar nuevos elementos y rituales para controlar si tendrás un sueño por la noche o no! También puede determinar qué tipo de sueño tendrás. Un consejo: sexo con una succubus te hace tener un sueño húmedo esa noche." # TL

    # game/screens/utility/what_new.rpy:208
    old "{b}Postpone Deal With The Devil{/b}"
    new "{b}Pospón EL Trato Con EL Diablo{/b}" # TL
    ...
    new "¿Cansado de tener este sueño antes de tener suficientes puntos? ¡Ya no! Ahora puedes firmar un pacto con el Diablo, en el que te comprometes a hacer un trato en otra ocasión. Obtendrás un nuevo elemento: Unholy Pact, usarlo hará que Devil aparezca cuando duermas. Este objeto no se perderá con la muerte, ¡está ligado a tu alma!" # TL
    ...
    new "{b}Grace - Traje de Conejita{/b}" # TL

    # game/screens/utility/what_new.rpy:222
    old "Super cute, adorable, and fuckin' sexy! Gracie in the new outfit here to steal your heart <3"
    new "Super linda, adorable, y jodidamente sexy! Gracie con un nuevo traje se robará tu corazón <3" # TL

    # game/screens/utility/what_new.rpy:230
    old "{b}New Dreams{/b}"
    new "{b}Nuevos Sueños{/b}" # TL
    ...
    new "¡Se agregaron dos nuevos sueños! Ninguno es agradable, hehehe~ ¡Dos nuevas pesadillas para despedazar tu cordura!" # TL

    # game/screens/utility/what_new.rpy:243
    old "{b}New Buffs & Items{/b}"
    new "{b}Nuevos Buffs & Objetos{/b}" # TL
    ...
    new "Muchos nuevos buffs, y unos debuffs fueron añadidos. También se agregaron tres nuevos elementos. Además, ahora se pueden consumir algunos artículos para obtener beneficios (alcohol)." # TL

    # game/screens/utility/what_new.rpy:247
    old "{b}Card Sounds{/b}"
    new "{b}Sonidos de Cartas{/b}" # TL
    ...
    new "¡La mayoría de las cartas ahora reproducirán el sonido cuando se usen! ¡Espero que te guste! Haz clic en las cartas a continuación para probarlo." # TL
...
translate spanish strings:
    ...
    new "Hemos agregado la mayor parte del contenido del juego al menú de reproducción. Ahora tiene 177 reproducciones más en comparación con 0.2.3, con  357 reproducciones en total." # TL
    ...
    new "Puedes encontrar a estas dos linduras trabajando juntas en las tardes." # TL
...
translate spanish strings:
    ...
    new "{b}Exploración Basada en Áreas{/b}" # TL # Victorius - AI
    ...
    new "{b}¡Los escuchamos!{/b} ¡El mayor cambio en 0.3.0 fue su sugerencia! La exploración se dividió en áreas, cada área tiene sus propios eventos, los eventos de la historia también requieren que explores el área adecuada. No te preocupes, la característica del mapa de resaltar lugares con eventos se amplió para funcionar en el Mapa de Exploración también." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:194
    old "{b}Exploration Events{/b}"
    new "{b}Eventos de Exploración{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:195
    old "A total of twelve new exploration events was introduced to expand upon the new exploration mechanic."
    new "Se introdujeron un total de doce nuevos eventos de exploración para expandir la nueva mecánica de exploración." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:204
    old "{b}Card Evolution System{/b}"
    new "{b}Sistema de Evolución de Cartas{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:205
    old "{b}Level Up your cards!{/b} Further improve your might to face new horrifying foes."
    new "{b}¡Sube de nivel tus cartas!{/b} Mejora aún más tu poder para enfrentar nuevos enemigos aterradores." # TL # Victorius - AI
    ...
    new "{b}¡Más escenas sexuales tienen efectos de sonido!{/b} Esto incluye: escenas de Alice, Kiara y Lexi, también parte de las escenas de Grace." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:222
    old "{b}Wanderer Hideout{/b}"
    new "{b}Escondite del Vagabundo{/b}" # TL # Victorius - AI
    ...
    new "{b}¡Un soplo de vida llegó al Escondite del Vagabundo!{/b} Se añadieron 12 nuevos personajes allí. Puedes hablar con todos ellos, 3 de ellos son comerciantes. ¡Hay 2 nuevas escenas sexuales allí!" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:232
    old "{b}Lexi 16th Event{/b}"
    new "{b}Evento 16 de Lexi{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:240
    old "{b}Mina 19th Event{/b}"
    new "{b}Evento 19 de Mina{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:248
    old "{b}New outfits{/b}"
    new "{b}Nuevos atuendos{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:249
    old "New outfits for Alice, Grace, Lexi & Mina! Each comes with 2 unique sex scenes."
    new "¡Nuevos atuendos para Alice, Grace, Lexi y Mina! Cada uno viene con 2 escenas sexuales únicas." # TL # Victorius - AI
    ...
    new "¡Una nueva ubicación para descubrir! Lucha contra artistas marciales, aprende sus habilidades y domina a tus enemigos con un nuevo tipo de carta: ¡Artes Marciales!" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:268
    old "{b}New Enemies, Arenas & AI Improvements{/b}"
    new "{b}Nuevos Enemigos, Arenas y Mejoras de IA{/b}" # TL # Victorius - AI
    ...
    new "Se introdujeron ocho nuevos enemigos y cuatro nuevas arenas de combate aleatorias. Los enemigos incluyen adversarios de fin de juego así como de inicio de juego. ¡La IA de los enemigos fue mejorada! Actualmente se han introducido 2 niveles de inteligencia." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:279
    old "{b}New Card Types{/b}"
    new "{b}Nuevos Tipos de Cartas{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:280
    old "24 new cards among two new card types - Summoning & Martial Art cards!"
    new "¡24 nuevas cartas entre dos nuevos tipos de cartas: cartas de Invocación y de Artes Marciales!" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:291
    old "{b}New status effects{/b}"
    new "{b}Nuevos efectos de estado{/b}" # TL # Victorius - AI
    ...
    new "¡Se añadieron trece nuevos efectos de estado! Muchos de ellos están relacionados con las nuevas cartas de Artes Marciales. Los nuevos enemigos también los usan, la regeneración del Dragón se cambió a regeneración innata." # TL # Victorius - AI
