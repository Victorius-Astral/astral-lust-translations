...
translate vietnamese d_Deal_with_the_Devil_3_d94f51a6:
    ...
    "Bạn thấy mình đang ở trong phòng của bạn, xung quanh là một ngọn lửa đang bốc cháy dữ dội."
...
translate vietnamese d_Deal_with_the_Devil_3_18010e2b:
    ...
    "Giường của bạn là nơi duy nhất không bị cháy. Trên ghế sofa là hình bóng đen với đôi mắt đỏ rực."
...
translate vietnamese d_Deal_with_the_Devil_3_8219b62f:
    ...
    devil "Ta có nhiều tên. Có người gọi là Thần, có người gọi là quỷ."
...
translate vietnamese d_Deal_with_the_Devil_3_435f125f:
    ...
    devil "Ta có một đề nghị cho ngươi."
...
translate vietnamese d_Deal_with_the_Devil_3_menu1_36d49e85:
    ...
    devil "Ngươi không có cái giá mà ta yêu cầu."
...
translate vietnamese d_Deal_with_the_Devil_3_menu1_fd1dac3b:
    ...
    devil "Ta sẽ làm suy yếu sự ảnh hưởng của ai đó đặt lên ngươi."
...
translate vietnamese d_Deal_with_the_Devil_3_menu1_dc4cc646:
    ...
    devil "Ngươi sẽ biết khi nào ngươi cần."
...
translate vietnamese d_Deal_with_the_Devil_3_menu1_9539ab5a:
    ...
    devil "Điều này sẽ cung cấp cho ngươi nhiều thời gian hơn. Hãy kiểm tra bản thân thường xuyên, vì một ngày nào đó, Hắn có thể thay thế ngươi nếu ngươi không cẩn thận."
...
translate vietnamese strings:
    ...
    new "Làm cho tôi may mắn [[Mất 40 điểm thuộc tính ngẫu nhiên. Nhận được +2 may mắn, tối đa 5] {#visible}"
    ...
    new "Tôi muốn trở thành người làm chủ vận mệnh của chính mình {#visible}"
    ...
    new "Ta không muốn gì từ ngươi"

    # game/events/dreams/deal_with_the_devil.rpy:74
    old "Sanity -50%\nCorruption -5%"
    new "-50 % Tỉnh táo, -5% sa đọa"
