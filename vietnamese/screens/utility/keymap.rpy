...
translate vietnamese strings:
    ...
    new "Hiển thị menu thống kê ký tự."

    # game/screens/utility/keymap.rpy:26
    old "Shows player deck."
    new "Hiển thị bộ bài của người chơi."
    ...
    new "Mở menu mối quan hệ nhân vật."

    # game/screens/utility/keymap.rpy:42
    old "End turn in combat."
    new "Kết thúc lượt trong chiến đấu."
