...
translate vietnamese strings:
    ...
    old "{a=https://astral-lust-documentation.readthedocs.io/en/latest/changelogs/full.html#changelog-full}{color=#2839fc}Read full changelog{/color}{/a}"
    new "{a=https://astral-lust-documentation.readthedocs.io/en/latest/changelogs/full.html#changelog-full}{color=#2839fc}Đọc toàn bộ nhật ký thay đổi{/color}{/a}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:144
    old "{b}{/b}"
    new "{b}{/b}"

    # game/screens/utility/what_new.rpy:168
    old "{b}Christmas Event{/b}"
    new "{b}Sự kiện giáng sinh{/b}" # TL

    # game/screens/utility/what_new.rpy:169
    ...
    new "Một sự kiện có giới hạn thời gian đã xuất hiện! Chơi một loạt 7 sự kiện theo chủ đề Giáng sinh và đánh bại Linh hồn Giáng sinh! Một khi sự kiện đã được nhìn thấy, bạn không thể nhìn thấy một sự kiện khác cho đến ngày hôm sau (thời gian thực). Bạn có thời gian cho đến ngày 10 tháng 1 để đánh bại nó!" # TL

    # game/screens/utility/what_new.rpy:181
    old "{b}Lexi's Massage{/b}"
    new "{b}Massage của Lexi{/b}" # TL # Victorius - AI
    ...
    new "Mina được massage chân, giờ là lúc những người chị kia chia sẻ kỹ năng massage của bạn! Rất nhiều trang phục phù hợp với những cảnh H nóng bỏng mới!" # TL
    ...
    new "Gặp Rachel, cô gái hồ ly thứ hai được giới thiệu! Có 11 sự kiện cốt truyện mới và 3 sự kiện lặp lại cho các cô gái cáo. Xây dựng Đên cáo và có được hai nàng cáo sống với bạn! Ngoài ra còn có một bộ trang phục mới cho cô Tiểu Cáo!" # TL

    # game/screens/utility/what_new.rpy:216
    old "{b}New Grace activities{/b}"
    new "{b}Hoạt động mới của Grace{/b}" # TL # Victorius - AI
    ...
    new "Bạn đã bao giờ muốn giúp Grace làm những công việc xung quanh khách sạn chưa? Có lẽ bạn muốn đến chơi với cô ấy? Bây giờ tất cả đều có thể! Giúp cô ấy, và cô ấy chắc chắn sẽ biết ơn bạn. {b} Hãy cho cô ấy thấy rằng vẫn tồn tại những người đàn ông tốt trên thế giới này!{/b}{i}Cô ấy có thể hỏi những câu hỏi kỳ lạ về toán học, bạn đã được cảnh báo.{/i}" # TL

    # game/screens/utility/what_new.rpy:229
    old "{b}Adventure with Lexi{/b}"
    new "{b}Phiêu lưu cùng Lexi{/b}" # TL

    # game/screens/utility/what_new.rpy:230
    old "Go out and get some supplies with Lexi, be prepared for trouble!"
    new "Đi ra ngoài lấy đồ với Lexi, và chuẩn bị cho những rắc rối bạn sẽ gặp!" # TL

    # game/screens/utility/what_new.rpy:240
    old "{b}Savenia{/b}"
    new "{b}Savenia{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:241
    old "Three new story events with Savenia! What would happen once her leg gets better? Will she leave?"
    new "Ba sự kiện mới với Savenia! Điều gì sẽ xảy ra khi chân của cô ấy trở nên tốt hơn? Liệu cô ấy có rời đi chứ?" # TL

    # game/screens/utility/what_new.rpy:252
    old "{b}New exploration events{/b}"
    new "{b}Sự kiện khám phá mới{/b}" # TL
    ...
    new "Có bốn sự kiện khám phá hoàn toàn mới đã sẵn sàng cho bạn! Cứu các quý cô, bị lừa, săn rồng, và chạy trốn khỏi những gã khổng lồ. Các nhân vật được yêu cầu được giới thiệu - Con gái của thương nhân và cô gái trộm cướp 'hào nhoáng'. Còn có một bà bầu gặp nguy hiểm! Cứu cô ấy và đứa con chưa chào đời của cô ấy!" # TL

    # game/screens/utility/what_new.rpy:264
    old "{b}New dream{/b}"
    new "{b}Giấc mơ mới{/b}" # TL

    # game/screens/utility/what_new.rpy:265
    ...
    new "Có một giấc mơ vui đang chờ bạn! Bạn đã bao giờ tưởng tượng tương lai có những gì trong kho cho bạn? Đắm mình trong vòng tay ấm áp của Alice và tận hưởng cuộc sống mới của bạn." # TL

    # game/screens/utility/what_new.rpy:276
    old "{b}Decks{/b}"
    new "{b}Bộ bài{/b}" # TL

    # game/screens/utility/what_new.rpy:277
    ...
    new "Bây giờ bạn có thể thực hiện một bộ bài thực sự! Xây dựng tối đa ba bộ bài và thay đổi chiến thuật của bạn theo kẻ thù của bạn. Bộ nhớ thẻ trong kho đã bị xóa và thay vào đó, bộ nhớ thẻ bài vô hạn đã được thêm vào. Bộ bài cho phép sắp xếp các thẻ theo nhiều tiêu chí khác nhau, với nhiều tùy chọn hiển thị khác nhau." # TL

    # game/screens/utility/what_new.rpy:281
    old "{b}Combat tutorial{/b}"
    new "{b}Hướng dẫn chiến đấu{/b}" # TL

    # game/screens/utility/what_new.rpy:282
    ...
    new "Một hướng dẫn chiến đấu mới đã được giới thiệu. Hãy để Lexi đưa bạn qua những kiến thức cơ bản về chiến đấu! Nó có thể được bắt đầu từ sảnh bên ngoài cửa." # TL

    # game/screens/utility/what_new.rpy:286
    old "{b}Tasks{/b}"
    new "{b}Nhiệm vụ{/b}" # TL

    # game/screens/utility/what_new.rpy:287
    ...
    new "Bạn đã bao giờ tự hỏi tại sao Lexi không mang cho bạn một số thứ từ bên ngoài? Không cần suy nghĩ nữa, chỉ cần yêu cầu cô ấy làm như vậy! Hiện tại nhiệm vụ có thể được giao cho Lexi, Mina, Alice và Grace." # TL

    # game/screens/utility/what_new.rpy:291
    old "{b}Buffs{/b}"
    new "{b}Tăng cường sức mạnh{/b}" # TL # Victorius - AI
    ...
    new "Bây giờ bạn có thể nhận được nhiều buff khác nhau! chúng sẽ hỗ trợ bạn trong chiến đấu, nhận chúng bằng cách giao nhiệm vụ cho các cô gái. Buff hoạt động sẽ xuất hiện trong menu nhân vật." # TL

    # game/screens/utility/what_new.rpy:296
    old "{b}Combat additions{/b}"
    new "{b}Bổ sung chiến đấu{/b}" # TL
    ...
    new "Ba kẻ cướp mới đang chờ bạn. Hãy đá vào mông chúng! Bạn có thể làm như vậy với sự trợ giúp của hiệu ứng trạng thái mới - Dấu ấn kẻ săn mồi, và hai thẻ mới Súng bắn tỉa và Lựu đạn." # TL

    # game/screens/utility/what_new.rpy:308
    old "{b}Jack{/b}"
    new "{b}Jack{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:309
    ...
    new "Tò mò về chủ sở hữu khách sạn trước đây? Hãy hỏi các cô gái, có thể họ sẽ nói điều gì đó hữu ích. Grace, Mina và Alice có chủ đề trò chuyện mới!" # TL
    ...
    new "Có rất nhiều bổ sung và thay đổi nhỏ khác ở đây và ở đó. GUI của tạp chí / codex đã được thay đổi để tăng khả năng đọc. Có rất nhiều thay đổi về QoL, chẳng hạn như chế tạo lấy vật liệu trong kho." # TL

    # game/screens/utility/what_new.rpy:332
    old "{b}Mina at the Vault{/b}"
    new "{b}Mina tại két sắt{/b}" # TL
    ...
    new "Mina bây giờ có thể xuất hiện tại hầm! Cô ấy có một chủ đề mới để nói chuyện với chúng ta. Ngoài ra còn có một số cảnh H." # TL

    # game/screens/utility/what_new.rpy:346
    old "{b}Past Lives{/b}"
    new "{b}tiền kiếp{/b}" # TL

    # game/screens/utility/what_new.rpy:347
    ...
    new "Sự kiện phụ mới cho cốt truyện chính! Sự kiện này chia sẻ nhiều hơn có vẻ như ở cái nhìn đầu tiên. Đó là khúc dạo đầu cho sự thật về Asthar." # TL

    # game/screens/utility/what_new.rpy:357
    old "{b}Damsel in Distress{/b}"
    new "{b}Thiếu nữ gặp nạn{/b}" # TL

    # game/screens/utility/what_new.rpy:358
    ...
    new "Có năm sự kiện khám phá mới! Tất cả đều có chủ Thiếu nữ gặp nạn. Bạn có thể cố gắng đánh bại những con quái vật và kiểm tra xem những cô gái này biết ơn như thế nào." # TL

    # game/screens/utility/what_new.rpy:369
    old "{b}Heart of Flames{/b}"
    new "{b}Trái tim của lửa{/b}" # TL
    ...
    new "Có một hiệu ứng trạng thái mới và cấp thẻ. Trái tim của lửa làm cho debuff đốt cháy hồi phục thay vì gây sát thương. Cả hiệu ứng và thẻ bài đều có thể tìm thấy trên con rồng." # TL
    ...
    new "{b}Combat 2.0{/b}\nNó là trọng tâm chính của phiên bản này, nó thay đổi hoàn toàn cách chơi của Astral Lust. Chiến đấu và mọi thứ liên quan đã được làm lại hoàn toàn. Giờ đây, chiến đấu tách biệt kẻ thù, cho phép tạo ra nhiều sự kết hợp của những kẻ thù đã chiến đấu. Ngoài ra, khi bạn tìm kiếm kẻ thù, bây giờ bạn có thể chọn xem bạn muốn đối thủ yếu hơn hay mạnh hơn. Bạn có thể thấy kẻ thù sẽ làm gì rõ ràng hơn nhiều, hầu hết kẻ thù đã được cân bằng lại." # TL
    ...
    new "{b}Thẻ bài 2.0{/b}\nCác thẻ đã được làm lại hoàn toàn, bây giờ chúng hiển thị loại mục tiêu mà chúng ảnh hưởng. Chỉ báo mục tiêu nằm ở góc dưới cùng bên trái. \n\n• {color=#9d0000}Đỏ{/color}- kẻ thù, \n• {color=#018000}Xanh lá{/color} - đồng minh/người chơi, \n•{color=#0013d7}Xanh lam{/color} - người chơi.\n\nCác thẻ hiện tính toán hiệu ứng của chúng, vì vậy khi bạn nhận được thẻ Cường Hóa sẽ cho bạn biết mức độ bạn sẽ đối phó với kẻ thù, sau khi tính đến tất cả các hiệu ứng trạng thái của mục tiêu. Ngoài ra, nhiều thẻ đã được cân bằng lại hoặc đã thay đổi tác dụng của chúng. " # TL

    # game/screens/utility/what_new.rpy:420
    ...
    new "{b}Nụ hôn lúc nửa đêm{/b}\n Sự kiện mới này được kích hoạt từ sự kiện thăm dò thị trường, nó có 12% cơ hội xảy ra khi chúng ta tìm kiếm đồ. Nó dựa trên một câu chuyện do một người bạn kể cho tôi, có vẻ như là một huyền thoại đô thị cũ từ Hoa Kỳ. Sự kiện này có thể dạy cho bạn rất nhiều điều về truyền thuyết, nếu bạn biết lựa chọn phù hợp. Hàng trăm dòng truyền thuyết. Để kích hoạt nó, trước tiên bạn cần hoàn thành sự kiện câu chuyện chính thứ 12." # TL

    # game/screens/utility/what_new.rpy:432
    ...
    new "{b}Đại tu Vẻ ngoài lá bài{/b}\nBây giờ khi kiểm tra bộ bài của bạn, hoặc rút/loại bỏ các cọc, bạn sẽ thấy các chú giải công cụ, giải thích các hiệu ứng trạng thái của lá bài được di chuột qua. Tính năng này đã được cộng đồng yêu cầu rất cao. Ngoài ra, tính năng này hoạt động trong lò rèn và kho. Bạn có thể kiểm tra nó ở các thẻ trên." # TL

    # game/screens/utility/what_new.rpy:442
    ...
    new "{b}Xem tất cả các thẻ{/b}\n Chức năng mới đã được thêm vào máy tính. Nó cho phép bạn kiểm tra tất cả các thẻ trong trò chơi! Bạn có thể xem các thẻ cần thiết để xây dựng bộ bài mơ ước của mình và cũng có thể kiểm tra các thay đổi meta giữa các phiên bản." # TL
    ...
    new "{b}Những nụ hôn{/b}\nPhiên bản này tập trung vào các sự kiện nhỏ và các tính năng QoL mới. Sự bổ sung đáng chú ý nhất là các sự kiện nụ hôn. Một số trong số này là các sự kiện nhỏ, nhưng một số là những cảnh phức tạp và dài hơn nhiều. Những sự kiện này giới thiệu rất nhiều cảnh H mới, đặc biệt là đối với Grace. Đó là - nếu bạn có thể lấy được chúng. Không phải tất cả mọi thứ bạn có thể làm trong các sự kiện mới là điều hiển nhiên. Một số tùy chọn cần bạn bị tha hóa, thậm chí lên đến 60%, một số yêu cầu Sinh lực hoặc trí thông minh. Sự kiện nụ hôn hầu hết có sẵn trong SFW mode. Thử hôn các cô gái ở nhiều nơi và điều kiện khác nhau để khám phá tất cả các cảnh." # TL

    # game/screens/utility/what_new.rpy:480
    ...
    new "{b}Vuốt ve thú cưng{/b}\nNhững con vật cưng cuối cùng đã được ghi nhớ. Bây giờ bạn có thể vỗ về những người bạn nhỏ của mình. Tất cả những nơi thú cưng xuất hiện đều có cảnh khác nhau." # TL
    ...
    new "{b}Savenia{/b}\nBản phát hành này mang đến ba sự kiện cốt truyện mới cho Savenia. Trong thời gian đó, chúng tôi sẽ thúc đẩy mối quan hệ của mình vượt qua những bỡ ngỡ ban đầu. Cũng có cảnh H lặp lại mới cho cô ấy. Hỗ trợ bản đồ đã được thêm vào cho các sự kiện cốt truyện của cô ấy." # TL

    # game/screens/utility/what_new.rpy:503
    ...
    new "{b}Cài đặt mới{/b}\n Có nhiều cài đặt mới để bạn tùy chỉnh trò chơi của mình. Bạn có thể buộc các mặt nạ tương tác hiển thị ngay cả khi không di chuột qua. Bạn có thể thay đổi độ mờ của hộp văn bản, đường viền phông chữ, v.v. Một trong các tùy chọn là chọn bộ hình ảnh menu chính của bạn." # TL

    # game/screens/utility/what_new.rpy:513
    ...
    new "{b}Kho chứa{/b}\nKho chứa có thể được mở rộng trở lại! Với 4 tầng mới, cùng với các hiệu ứng đặc biệt, chẳng hạn như tiền tệ không chiếm không gian hoặc số nhân không gian. T8 Vault có thể lưu trữ 600 vật phẩm, 32 thẻ và tiền tệ không giới hạn." # TL

    # game/screens/utility/what_new.rpy:523
    old "{b}Experience{/b}\nCharacters experience is now collected & displayed in their stats. (not in SFW mode)"
    new "{b}Kinh nghiệm{/b}\nKinh nghiệm của nhân vật hiện được thu thập và hiển thị trong số liệu thống kê của họ. (không ở chế độ SFW)" # TL
    ...
    new "{b}Các thay đổi khác{/b}\nCó rất nhiều thay đổi khác, cả lớn và nhỏ. Nhiều yếu tố gui đã được làm lớn hơn, một số thứ mới đã được thêm vào, bao gồm cả sự kiện bí mật. Hình nền và màn hình sưu tầm sẽ tải nhanh hơn 90% ngay bây giờ. Rất nhiều vấn đề đã được khắc phục." # TL
...
translate vietnamese strings:
    ...
    new "{a=https://astral-lust-documentation.readthedocs.io/en/latest/changelogs/full.html#changelog-full}{color=#2839fc}{i}Đọc bản cập nhật đầy đủ{/i}{/color}{/a}" # TL
    ...
    new "Bạn có thể xem thêm tin tức, bản xem trước và nội dung trên {a=https://www.patreon.com/Victorius}{color=#2839fc}{i}Patreon{/i}{/color}{/a} và {a=https://discord.gg/rvnBC39USx}{color=#2839fc}{i}Discord{/i}{/color}{/a}." # TL
    ...
    new "Một Hồ Ly mới mới vừa đặt chân đến Asthar, và cô ấy cực kỳ nóng bỏng nữa! Cô ấy yêu tình dục, và cũng thích con gái. Cô ấy có sẵn nội dung đồng tính nữ (có thể bật và tắt) với [lil_fox]. Hơn nữa, cô ấy được thiết kế dựa trên người thật, hãy tham gia máy chủ {a=https://discord.gg/rvnBC39USx} Discord {/a} của chúng tôi và trò chuyện với cô ấy! Hãy mong là sự ngưỡng mộ của bạn sẽ không khiến cô ấy ngại :P" # TL

    # game/screens/utility/what_new.rpy:183
    old "{b}Kiara event{/b}"
    new "{b}Sự kiện của Kiara{/b}" # TL
    ...
    new "Kiara có sự kiện câu chuyện mới giải thích Thần thoại Sáng tạo được tin tưởng bởi những thực thể phi thường. Nhưng đừng quên đi phần thú vị đấy, 6 cảnh chịch mới, 3 bộ trang phục mới và gần 300 hình ảnh động! Bạn đã bao giờ đụ một cô gái với bản sao của mình chưa?" # TL

    # game/screens/utility/what_new.rpy:195
    old "{b}Alice Shower Event{/b}"
    new "{b}Sự kiện Alice trong phòng tắm{/b}" # TL
    ...
    new "Sự kiện trong phòng tắm của [alice] đã được mở rộng với một cảnh mới. Hãy vui vẻ với cô gái dễ thương của bạn và giúp cô ấy tắm!" # TL

    # game/screens/utility/what_new.rpy:207
    old "{b}Lexi Brings Food{/b}"
    new "{b}Lexi Mang Đồ Ăn{/b}" # TL
    ...
    new "Tương tác ngẫu nhiên mới này giữa [lexi] và [grace] sẽ cho bạn biết thêm một chút về các cô gái. Có năm cuộc trò chuyện khác nhau." # TL

    # game/screens/utility/what_new.rpy:211
    old "{b}Outfit Crafting Menu{/b}"
    new "{b}Menu chế tạo trang phục{/b}" # TL

    # game/screens/utility/what_new.rpy:212
    old "Now when asking [alice] to make outfit, you'll be able to use a new outfits menu!"
    new "Giờ đây, khi yêu cầu [alice] may trang phục, bạn sẽ có thể sử dụng menu trang phục mới!" # TL

    # game/screens/utility/what_new.rpy:232
    old "{b}Unique Cards!{/b}"
    new "{b}Thẻ Độc Nhất!{/b}" # TL
    ...
    new "Bản cập nhật này sẽ có thêm bốn Thẻ Độc Nhất mới được ra lò trong Asthar! Tất cả những thứ này đều là một phần của Lễ kỷ niệm 1 năm Astral Lust. Thẻ pháo hoa có sẵn trên {a=https://www.patreon.com/Victorius}{patreon1}Patreon{/patreon1}{/a} và {a=https://discord.gg/rvnBC39USx}{patreon1}Discord{/patreon1}{/a} cho tất cả mọi người, ba thẻ còn lại dành cho tất cả Khách hàng trên patreon. Một trong số đó cho phép triệu hồi các cô gái khác nhau làm đồng minh - Ảo Mộng!" # TL

    # game/screens/utility/what_new.rpy:246
    old "{b}Interactions Menu{/b}"
    new "{b}Menu tương tác{/b}" # TL
    ...
    new "Có một sự thay đổi lớn ở đây! Bây giờ bạn không cần phải kiểm tra từng chỗ một chỉ để xem chỗ nào có thể nhấp được. Bên cạnh bí mật, các yếu tố có thể tương tác khác trong chỗ di chuyển sẽ có nút ở góc dưới cùng bên trái! Có thể tắt cửa sổ này trong cài đặt và bằng phím 'I'." # TL

    # game/screens/utility/what_new.rpy:251
    old "{b}Other Changes{/b}"
    new "{b}Các thay đổi khác{/b}" # TL
...
translate vietnamese strings:
    ...
    new "{b}Cơn ác mộng của Gracie{/b}" # TL
    ...
    old "{b}GUI 2.0{/b}"
    new "{b}Giao diện 2.0{/b}" # TL # Victorius - AI
    ...
    new "Quá trình đại tu giao diện Astral Lust đã bắt đầu! Nhiều menu quan trọng nhất đã được thông qua, hoặc ít nhất là được thông qua một phần. Hiện tại, menu nhân vật và kho đồ giờ là một, được áp dụng hoàn toàn theo phong cách mới. Các mục hiện có chú giải, công cụ và biểu tượng. Toàn bộ hệ thống vật phẩm đã được đại tu, nhấp chuột phải vào một vật phẩm sẽ cho phép bạn chọn số lượng vật phẩm cần di chuyển bằng thanh trượt, bạn cũng có thể sắp xếp túi đồ của mình và di chuyển tất cả các vật phẩm cùng một lúc chỉ với một cú nhấp chuột! Các thông báo hiện đã hoàn toàn khác, bạn có thể chuyển đổi hai kiểu khác nhau trong cài đặt. Phông chữ chủ đề giao diện chính - {font=fonts/FrederickatheGreat-Regular.ttf} Fredericka {/font} cũng có thể được chuyển đổi trong cài đặt. Các biểu tượng menu có thể mở rộng đã được thay đổi và tất cả các menu được mở bằng chúng ít nhất đã được chấp nhận một phần cho chủ đề mới. Bối cảnh giao dịch đã được áp dụng đầy đủ, với các tùy chọn mới như thể hiện sự gia tăng giá trị từ thỏa thuận, một số cơ chế mới cũng được thêm vào các thương nhân - như tiền thưởng cho mối quan hệ lợi nhuận tốt." # TL
...
translate vietnamese strings:
    ...
    old "{u}What's New{/u}"
    new "{u}Có Gì Mới{/u}" # TL

    # game/screens/utility/what_new.rpy:68
    old "Click outside to close this window, it can be entered again from the pc."
    new "Nhấp vào bên ngoài để đóng cửa sổ này, bạn vẫn có thể vào lại chỗ này thông qua pc." # TL
...
translate vietnamese strings:
    ...
    new "{b}Thêm rất nhiều nội dung Grace{/b}" # TL
    ...
    new "Gracie có ba sự kiện cốt chuyện mới, thợ máy 'giận dữ & lời xin lỗi', nội dung mới về giấc ngủ (bao gồm hai cảnh footjobs), sự kiện bí mật và hơn thế nữa. Sự kiện cuối cùng trong câu chuyện mới của cô ấy được hợp nhất với sự kiện của Alice và Tiểu Cáo. Ồ, đó là một sự kiện vui nhộn ;)" # TL

    # game/screens/utility/what_new.rpy:191
    old "{b}New Lexi & Mina events{/b}"
    new "{b}Sự kiện mới của Lexi & Mina{/b}" # TL
    ...
    new "Hai chị em này đã có hai sự kiện cốt chuyện mới mỗi người! Lexi cũng có một sự kiện siêu lớn - Buổi hẹn hò trong nhà bếp, một sự kiện mà bạn cần chuẩn bị. Với nhiều nội dung hấp dẫn để mở khóa khi bạn đạt được điểm số cao hơn. Đây là sự kiện dài nhất cho đến nay và là sự kiện đầu tiên của hệ thống 'hẹn hò' mới. Chúc vui vẻ!" # TL

    # game/screens/utility/what_new.rpy:203
    old "{b}Fox girls' events{/b}"
    new "{b}Những cô gái hồ ly{/b}" # TL
    ...
    new "Như đã nói ở trên Tiểu Cáo có một sự kiện kết hợp với Alice & Gracie, Rachel cũng có một sự kiện (cuối cùng là một số hành động với cô ấy: P), Rhainda có hai sự kiện câu chuyện!" # TL

    # game/screens/utility/what_new.rpy:215
    old "{b}New items{/b}"
    new "{b}Vật phẩm mới{/b}" # TL
    ...
    new "Phần mở đầu được làm lại, nhiều thông tin hơn và hấp dẫn hơn. Kiểm tra các bản phát lại hoặc bắt đầu một trò chơi mới để xem nó. Bạn có thể gặp ai đó bất ngờ ở đó không chừng." # TL

    # game/screens/utility/what_new.rpy:258
    old "{b}A lot of other changes & additions{/b}"
    new "{b}Rất nhiều thay đổi và bổ sung khác{/b}" # TL
...
translate vietnamese strings:
    ...
    new "{b}Thám hiểm cùng Tiểu Cáo{/b}" # TL
    ...
    new "Bây giờ bạn có thể đưa Cáo nhỏ ra ngoài trong một cuộc phiêu lưu! Tìm cô ấy trong khi khám phá, sau đó bạn có thể đi với cô ấy bằng cách nói chuyện với cô ấy." # TL

    # game/screens/utility/what_new.rpy:187
    old "{b}Alice - Nun outfit{/b}"
    new "{b}Alice - Trang phục sơ{/b}" # TL

    # game/screens/utility/what_new.rpy:188
    old "In the corruption-filled Asthar, even the nuns are filled with unholy thoughts."
    new "Ở xứ Asthar đầy rẫy những sự sa đọa, ngay cả các nữ tu cũng chứa đầy những suy nghĩ xấu xa." # TL

    # game/screens/utility/what_new.rpy:196
    old "{b}Lola's 3rd event{/b}"
    new "{b}Sự kiện thứ 3 của Lola{/b}" # TL
    ...
    new "Lola Cuối cùng cũng đã có sự kiện mới! Nó sẽ liên quan đến hai tuyến truyện và 3 cảnh sếch." # TL

    # game/screens/utility/what_new.rpy:205
    old "{b}A lot of changes{/b}"
    new "{b}Nhiều thay đổi vãilone{/b}" # TL
    ...
    new "Phông chữ của trò chơi chính đã được thay đổi! Những bộ Sưu tập sẽ được giữ giữa các lần lưu. Thông báo vật phẩm giờ sẽ hiển thị biểu tượng của vật phẩm. Có nhiều thay đổi khác, hãy kiểm tra bảng thay đổi đầy đủ ở dưới cùng để biết thêm về chúng. " # TL
...
translate vietnamese strings:
    ...
    new "Bạn có thể sử dụng các vật phẩm và nghi lễ mới để kiểm soát xem bạn có mơ vào ban đêm hay không! Bạn cũng có thể xác định loại giấc mơ mà bạn sẽ có. Một mẹo: quan hệ tình dục với một succubi khiến bạn có một giấc mơ ướt át vào đêm đó." # TL

    # game/screens/utility/what_new.rpy:208
    old "{b}Postpone Deal With The Devil{/b}"
    new "{b}Hoãn giao dịch với quỷ{/b}" # TL
    ...
    new "{b}Grace - trang phục thỏ{/b}" # TL

    # game/screens/utility/what_new.rpy:222
    old "Super cute, adorable, and fuckin' sexy! Gracie in the new outfit here to steal your heart <3"
    new "Siêu dễ thương, đáng yêu và sexy! Gracie trong trang phục mới ở đây để đánh cắp trái tim của bạn <3" # TL
    ...
    new "Hai giấc mơ mới đã được thêm vào! Không có gì là tốt cả, hehehe~ Hai cơn ác mộng mới sẽ xé toạc sự tỉnh táo của bạn!" # TL

    # game/screens/utility/what_new.rpy:243
    old "{b}New Buffs & Items{/b}"
    new "{b}Buff và Vật phẩm mới{/b}" # TL
    ...
    new "Rất nhiều buff mới và một số debuff đã được thêm vào. Ba mục mới cũng đã được thêm vào. Ngoài ra, một số vật phẩm hiện có thể được tiêu thụ để tăng sức mạnh (rượu)." # TL

    # game/screens/utility/what_new.rpy:247
    old "{b}Card Sounds{/b}"
    new "{b}Âm thanh thẻ{/b}" # TL
    ...
    new "Hầu hết các thẻ bây giờ sẽ phát âm thanh khi được sử dụng! Hy vọng bạn thích nó! Nhấp vào các thẻ bên dưới để thử." # TL
...
translate vietnamese strings:
    ...
    old "{b}NSFW Sounds{/b}"
    new "{b}Âm thanh cảnh SẾCHHH!{/b}" # TL
    ...
    new "{b}Chúng tôi đã thêm vào những âm thanh người lớn cho cái game này!{/b} Cùng với âm thanh chiến đấu, hai thanh âm lượng mới đã được thêm vào cài đặt âm thanh. Bạn có thể điều chỉnh âm lượng của âm thanh ở đó. Hiện tại, chỉ có một số âm thanh được thêm vào cho Alice và Savenia. Sắp có thêm nhiều âm thanh, bao gồm cả tiếng rên rỉ." # TL

    # game/screens/utility/what_new.rpy:224
    old "{b}Alice - Playmate Outfit{/b}"
    new "{b}Alice - trang phục bạn chịch{/b}" # TL

    # game/screens/utility/what_new.rpy:225
    old "When lust overflows, you gotta find your favorite playmate."
    new "Khi ham muốn tuôn trào, bạn phải tìm bạn tình yêu thích của mình." # TL

    # game/screens/utility/what_new.rpy:233
    old "{b}More Replays{/b}"
    new "{b}Nhiều đoạn phát lại hơn{/b}" # TL
    ...
    new "Chúng tôi đã thêm hầu hết nội dung của trò chơi vào menu phát lại. Bây giờ nó có 177 lần phát lại nhiều hơn so với 0.2.3, tổng cộng 357 lần phát lại." # TL
    ...
    new "Bạn có thể tìm thấy hai người này làm việc cùng nhau vào các buổi chiều." # TL
...
translate vietnamese strings:
    ...
    new "{b}Khám phá theo khu vực{/b}" # TL # Victorius - AI
    ...
    new "{b}Chúng tôi đã lắng nghe bạn!{/b} Thay đổi lớn nhất trong phiên bản 0.3.0 là theo gợi ý của bạn! Khám phá được chia thành các khu vực, mỗi khu vực có các sự kiện riêng, các sự kiện câu chuyện cũng yêu cầu bạn khám phá khu vực phù hợp. Đừng lo lắng, tính năng bản đồ làm nổi bật các nơi có sự kiện đã được mở rộng để hoạt động trong Bản đồ Khám phá, cũng vậy." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:194
    old "{b}Exploration Events{/b}"
    new "{b}Sự kiện Khám phá{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:195
    old "A total of twelve new exploration events was introduced to expand upon the new exploration mechanic."
    new "Tổng cộng có mười hai sự kiện khám phá mới được giới thiệu để mở rộng cơ chế khám phá mới." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:204
    old "{b}Card Evolution System{/b}"
    new "{b}Hệ thống Tiến hóa Thẻ{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:205
    old "{b}Level Up your cards!{/b} Further improve your might to face new horrifying foes."
    new "{b}Nâng cấp thẻ của bạn!{/b} Cải thiện thêm sức mạnh của bạn để đối mặt với những kẻ thù đáng sợ mới." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:217
    old "{b}More sex scenes got sfx!{/b} This includes: Alice, Kiara & Lexi scenes, also part of Grace scenes."
    new "{b}Nhiều cảnh sex có âm thanh hơn!{/b} Điều này bao gồm: cảnh của Alice, Kiara & Lexi, cũng như một phần của cảnh Grace." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:222
    old "{b}Wanderer Hideout{/b}"
    new "{b}Nơi ẩn náu của Kẻ lang thang{/b}" # TL # Victorius - AI
    ...
    new "{b}Sự sống đã đến với Nơi ẩn náu của Kẻ lang thang!{/b} 12 nhân vật mới đã được thêm vào đó. Tất cả đều có thể nói chuyện, 3 trong số họ là thương nhân. Có 2 cảnh sex mới ở đó!" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:232
    old "{b}Lexi 16th Event{/b}"
    new "{b}Sự kiện thứ 16 của Lexi{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:240
    old "{b}Mina 19th Event{/b}"
    new "{b}Sự kiện thứ 19 của Mina{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:248
    old "{b}New outfits{/b}"
    new "{b}Trang phục mới{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:249
    old "New outfits for Alice, Grace, Lexi & Mina! Each comes with 2 unique sex scenes."
    new "Trang phục mới cho Alice, Grace, Lexi & Mina! Mỗi trang phục đi kèm với 2 cảnh sex độc đáo." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:258
    old "{b}Carlson Dojo{/b}"
    new "{b}Dojo của Carlson{/b}" # TL # Victorius - AI
    ...
    new "Một địa điểm mới để khám phá! Đấu với các võ sĩ, học các kỹ năng của họ và thống trị kẻ thù của bạn với loại thẻ mới - Võ thuật!" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:268
    old "{b}New Enemies, Arenas & AI Improvements{/b}"
    new "{b}Kẻ thù mới, Đấu trường & Cải tiến AI{/b}" # TL # Victorius - AI
    ...
    new "Tám kẻ thù mới & bốn đấu trường chiến đấu ngẫu nhiên mới đã được giới thiệu. Kẻ thù bao gồm cả những kẻ thù cuối game cũng như những kẻ thù đầu game. AI của kẻ thù đã được cải thiện! Hiện tại có 2 cấp độ thông minh được giới thiệu." # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:279
    old "{b}New Card Types{/b}"
    new "{b}Loại thẻ mới{/b}" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:280
    old "24 new cards among two new card types - Summoning & Martial Art cards!"
    new "24 thẻ mới trong hai loại thẻ mới - Thẻ Triệu hồi & Thẻ Võ thuật!" # TL # Victorius - AI

    # game/screens/utility/what_new.rpy:291
    old "{b}New status effects{/b}"
    new "{b}Hiệu ứng trạng thái mới{/b}" # TL # Victorius - AI
    ...
    new "Mười ba hiệu ứng trạng thái mới đã được thêm vào! Nhiều trong số chúng liên quan đến thẻ Võ thuật mới. Kẻ thù mới cũng sử dụng chúng, khả năng hồi phục của Rồng đã được thay đổi thành hồi phục bẩm sinh." # TL # Victorius - AI
