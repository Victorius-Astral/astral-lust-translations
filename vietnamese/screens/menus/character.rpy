...
translate vietnamese strings:
    ...
    new "{b}{u}{color=#E4CA48}May mắn{/color}{/b}{/u}\n{small}Tăng cơ hội nhận được bài tốt, giảm cơ hội gặp đối thủ mạnh. Tăng với các mã từ Discord hoặc bằng cách giao dịch với một số thực thể nhất định.{/small}" # TL
    ...
    old "Buffs"
    new "Tăng cường" # TL # Victorius - AI
