...
translate vietnamese strings:
    ...
    new "1. Bạn có thể xem trợ giúp bằng cách nhấn 'Q'. Khi chơi, bạn sẽ mở khóa các hướng dẫn mới."

    # game/variables/help.rpy:3
    old "{color=#45B6FE}2. Not all dangers can be overcome at the beginning. Hide and run.{/color}"
    new "{color=#45B6FE}2. Không phải mọi nguy hiểm đều có thể đối đầu ngay từ đầu. Ẩn nấp và chạy.{/color}"

    # game/variables/help.rpy:3
    old "3. In this broken world idiom \"curiosity killed a cat\" is something you should take to heart."
    new "3. Thành ngữ trong thế giới hoang tàn này là \"sự tò mò sẽ giết chết một con mèo\" là điều bạn nên ghi nhớ."

    # game/variables/help.rpy:3
    old "{color=#45B6FE}4. Help Lexi to unlock exploration.{/color}"
    new "{color=#45B6FE}4. Giúp Lexi khám phá.{/color}"

    # game/variables/help.rpy:3
    old "5. Menus can be displayed either by keys 1-6 or by expanding the menu in top right corner."
    new "5. Các menu có thể được hiển thị bằng các phím 1-6 hoặc bằng cách mở rộng menu ở góc trên cùng bên phải."

    # game/variables/help.rpy:3
    old "{color=#45B6FE}6. If you are stuck check out the journal (key '5') for tips.{/color}"
    new "{color=#45B6FE}6. Nếu bạn gặp khó khăn, hãy xem nhật ký (phím '5') để biết các mẹo.{/color}"

    # game/variables/help.rpy:3
    old "7. To start girls events, you need to either talk to them or to be in a right place at the right time."
    new "7. Để kích hoạt những sự kiện dành cho các cô gái, bạn cần nói chuyện với họ hoặc đến đúng nơi, đúng lúc."
    ...
    new "9. Mỗi cô gái chỉ có thể có một sự kiện vào bất kỳ ngày nào."
    ...
    new "{color=#45B6FE}10. Những sự kiện sau này đòi hỏi các cô gái phải tin tưởng bạn. Bạn có thể tăng sự tin tưởng của các cô gái bằng cách thực hiện các sự kiện có thể lặp lại với họ.{/color}"

    # game/variables/help.rpy:3
    old "11. You can expand your hotel at lobby counter, build vault as quick as possible to store materials you find."
    new "11. Bạn có thể mở rộng khách sạn của mình tại quầy ở sảnh, xây dựng kho tiền nhanh nhất có thể để lưu trữ các vật liệu bạn tìm thấy."
    ...
    new "13. Bạn có thể tìm các bộ sưu tập để mở khóa các hình ảnh bổ sung trên máy tính. Tìm bao cao su vàng và bao cao su thường."

    # game/variables/help.rpy:3
    old "Forge allows you to do mostly two things:"
    new "Rèn cho phép bạn làm hai việc:"
    ...
    new "Bạn có thể nhận được nhiều nguyên liệu khác nhau từ những con quái vật bị đánh bại, bạn cũng có thể mua một số thứ từ thương nhân."
    ...
    new "Ở đây bạn có thể chơi với Succubus mà bạn bắt được, bạn có thể thăm tù nhân bằng cách nhấp vào một hành lang ở giữa."
    ...
    new "{size=+10}{gold}Hãy coi chừng. Succubus rất mạnh, đừng săn lùng chúng, trước khi bạn đủ mạnh.{/gold}"

    # game/variables/help.rpy:3
    old "Here you can train your body, increasing strength, agility, and vitality."
    new "Tại đây bạn có thể rèn luyện cơ thể, tăng cường sức mạnh, sự nhanh nhẹn và sinh lực."
    ...
    new "Bên phải của nó, có một chiếc xe đạp, nơi bạn sẽ tăng cường sức sống của mình."
    ...
    new "Bạn có thể lưu trữ cả vật phẩm và thẻ, ở mỗi cấp độ của kho chứa:"

    # game/variables/help.rpy:3
    old " • {color=#45B6FE}[exp_vault_space_per_lvl] items{/color}"
    new " • {color=#45B6FE}[exp_vault_space_per_lvl] Vật phẩm{/color}"

    # game/variables/help.rpy:3
    old " • {color=#45B6FE}[exp_vault_cards_per_lvl] cards{/color}"
    new " • {color=#45B6FE}[exp_vault_cards_per_lvl] Thẻ bài{/color}"
    ...
    new "Bạn có thể đã nhận thấy được mỗi cấp độ. {gold}đúng, kho chứa có thể nâng cấp!{/gold} Bạn có thể làm điều này sau khi lò rèn được xây dựng, tại quầy ở sảnh."

    # game/variables/help.rpy:3
    old "Once vault reaches 4th level, it will also allow to make gun related cards in a gun assembly station."
    new "Khi kho chứa đạt đến cấp độ thứ 4, nó cũng sẽ cho phép tạo các thẻ liên quan đến súng trong một trạm lắp ráp súng."

    # game/variables/help.rpy:3
    old "{gold}{big}You have met Lola, goth hotel owner.{/big}{/gold}"
    new "{gold}{big}Bạn đã gặp Lola, chủ khách sạn goth.{/big}{/gold}"
    ...
    new "Cô ấy sống trong phòng bên cạnh bạn, hãy nhớ đến thăm cô ấy khi bạn ở đây!"

    # game/variables/help.rpy:3
    old "She might surprise you in the future."
    new "Cô ấy có thể làm bạn ngạc nhiên trong tương lai."
    ...
    new "Bạn có thể ở tại nhà nghỉ, nó cũng cho phép bạn sử dụng các tiện ích khác nhau của khách sạn, chẳng hạn như kho chứa hoặc chế tạo đồ."

    # game/variables/help.rpy:3
    old "You can also explore from the hideout, without returning to the hotel."
    new "Bạn cũng có thể khám phá từ nơi đây mà không cần quay lại khách sạn jade."
    ...
    new "Một trong những trò giải trí chính tại đây là Big Bang, nhà thổ do Madam Hof điều hành, ở đây bạn có thể thoải mái vung tiền của mình."

    # game/variables/help.rpy:3
    old "{gold}{big}Congratulations! You've completed your first trip outside, and finally faced The End.{/big}{/gold}"
    new "{gold}{big}Xin chúc mừng! Bạn đã hoàn thành chuyến đi đầu tiên của mình bên ngoài, và cuối cùng đã phải đối mặt với The End.{/big}{/gold}"

    # game/variables/help.rpy:3
    old "You can now go out to explore, it can be done by clicking on arrow to the left in the lobby."
    new "Bây giờ bạn có thể đi ra ngoài để khám phá, nó có thể được thực hiện bằng cách nhấp vào chuột trái trong sảnh."

    # game/variables/help.rpy:3
    old "You can try to find some opportunities outside, or you can look for enemies to fight."
    new "Bạn có thể cố gắng tìm kiếm một số cơ hội bên ngoài, hoặc bạn có thể tìm kiếm kẻ thù để chiến đấu."
    ...
    new "hãy cẩn thận. Succubus rất mạnh và bạn không có hy vọng đánh bại chúng với bộ bài khởi đầu của mình."

    # game/variables/help.rpy:3
    old "Defeat weaker opponents to get cards, train your body and mind, and only then, face powerful monsters."
    new "Đánh bại những đối thủ yếu hơn để nhận thẻ, rèn luyện thể chất và tinh thần, và chỉ sau đó, đối mặt với những con quái vật mạnh mẽ."

    # game/variables/help.rpy:3
    old "{gold}{big}Congratulations! You've began your journey towards the knowledge, and madness accompanying it!{/big}{/gold}"
    new "{gold}{big}Xin chúc mừng! Bạn đã bắt đầu cuộc hành trình hướng tới kiến thức và sự điên rồ đi kèm với nó!{/big}{/gold}"

    # game/variables/help.rpy:3
    old "You can enter it by praying to Keeper of Wisdom at the altar (box with candles at your room)."
    new "Bạn có thể vào đó bằng cách cầu nguyện với Người nắm giữ trí tuệ ở bàn thờ (hộp với nến ở phòng bạn)."

    # game/variables/help.rpy:3
    old "In the library you can read books, deepening your knowledge, you can also help around. Kiara will make it worth it."
    new "Trong thư viện, bạn có thể đọc sách, đào sâu kiến thức của mình, bạn cũng có thể giúp đỡ xung quanh. Kiara sẽ làm cho nó xứng đáng."
    ...
    new "Đây là menu nhân vật, ở đây bạn có thể kiểm tra trạng thái của mình. Hầu hết các số liệu thống kê đều tìm thấy công dụng của chúng, hầu hết có thể giúp ích trong chiến đấu, nhiều số liệu có thể giúp bạn mở khóa nội dung bổ sung, bằng cách kiểm tra thành công."

    # game/variables/help.rpy:3
    old "You can check what any given thing does, just hover over it, and tooltip explaining this stat will appear."
    new "Bạn có thể kiểm tra xem bất kỳ thứ nào có chức năng gì, chỉ cần di chuột qua nó và chú giải công cụ giải thích chỉ số này sẽ xuất hiện."
