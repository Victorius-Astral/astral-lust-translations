...
translate vietnamese strings:
    ...
    new "Terryfying nightmares are about to befall you."
    ...
    new "Your spirit is filled with rituals' remnant spirituality. If the stack is 3 or more during sleep, it'll turn into {ef}Spiritual Taint{/ef}, making you unable to perform rituals for x days. If the stack is maximum, each next ritual will damage your sanity by 10% + 10% for each next ritual. Sleep decreases stack by 1."
