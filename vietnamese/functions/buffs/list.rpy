...
translate vietnamese strings:
    ...
    new "Nhận được {} tái tạo và {} sức mạnh."
...
translate vietnamese strings:
    ...
    new "Bạn sẽ trở nên {{ef}}Bất khả chiến bại{{/ef}} trong {vulnerable} lượt, nhưng bước chân không vững của bạn sẽ làm giảm {dodge}% cơ hội để né đòn. Hiệu ứng này giảm đi {sleep} mỗi khi bạn ngủ và 1 lần mỗi khi bạn chiến đấu."

    # game/functions/buffs/list.rpy:38
    old "Succubi Hormones"
    new "Nội tiết tố Succubi"
    ...
    new "Bạn nhìn thấy cô ấy mỗi khi bạn nhắm mắt, những tiếng rên rỉ nhẹ nhàng của cô ấy vang vọng bên tai bạn. Sự thèm khát không được kiềm chế sẽ ám ảnh bạn ngay cả trong giấc mơ."
    ...
    new "Không có gì ảnh hưởng đến tâm trí của bạn, những giấc mơ sẽ không xuất hiện để ám ảnh bạn."
    ...
    new "Suy nghĩ của bạn khiến bạn không còn chỗ để nghỉ ngơi, đêm nay sẽ rất dài... Bạn nhất định sẽ mơ đêm nay."

    # game/functions/buffs/list.rpy:38
    old "Devil's Call"
    new "Cuộc gọi của Quỷ"

    # game/functions/buffs/list.rpy:38
    old "{evil}'He' is calling you.{/evil}"
    new "{evil}'Hắn' đang gọi ngươi.{/evil}"
    ...
    new "Những giấc mơ hạnh phúc đang chờ đón bạn."
    ...
    # game/functions/buffs/list.rpy:38
    old "Terryfying nightmares are about to befall you."
    new "Những cơn ác mộng kinh hoàng sắp ập đến với bạn."

    # game/functions/buffs/list.rpy:38
    old "Spiritual Infusion"
    new "Truyền dịch tâm linh"

    # game/functions/buffs/list.rpy:38
    old "Your spirit is filled with rituals' remnant spirituality. If the stack is 3 or more during sleep, it'll turn into {ef}Spiritual Taint{/ef}, making you unable to perform rituals for x days. If the stack is maximum, each next ritual will damage your sanity by 10% + 10% for each next ritual. Sleep decreases stack by 1."
    new "Tinh thần của bạn tràn ngập năng lượng tâm linh còn sót lại của nghi lễ. Nếu có 3 cộng dồn hoặc nhiều hơn trong khi ngủ, nó sẽ chuyển thành {ef}Vết rách tâm linh{/ef}, khiến bạn không thể thực hiện nghi lễ trong x ngày. Nếu nó đạt đến tối đa, mỗi nghi thức tiếp theo sẽ làm tổn hại đến sự tỉnh táo của bạn 10% + 10% cho mỗi nghi thức tiếp theo. Ngủ giảm cộng dồn đi 1."

    # game/functions/buffs/list.rpy:38
    old "Spiritual Taint"
    new "Vết rách tâm linh"
    ...
    new "Tinh thần của bạn bị nhuốm màu với lượng tâm linh áp đảo khiến bạn mê sảng. Những âm thanh khó tả vang vọng trong tâm trí bạn, và những hình bóng mờ ảo khó nắm bắt làm ô nhiễm thị giác của bạn. Bạn không thể thực hiện các nghi lễ. Ngủ giảm cộng dồn đi 1."
    ...
    new "Gây ra hiệu ứng tiêu cực ngẫu nhiên khi bắt đầu trận chiến. Số lượng và mức độ nghiêm trọng của các hiệu ứng lớn hơn với cộng dồn cao hơn của {ef}Thoái Hóa{/ef}."

    # game/functions/buffs/list.rpy:38
    old "Blessing - [effects['heart_of_flames'][0]!t]"
    new "Cầu nguyện - [effects['heart_of_flames'][0]!t]"

    # game/functions/buffs/list.rpy:38
    old "You have been imbued with certain effects. They will be triggered in combat."
    new "Bạn đã được thấm nhuần với những hiệu ứng nhất định. Chúng sẽ được kích hoạt trong chiến đấu."
