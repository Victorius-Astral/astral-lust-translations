...
translate vietnamese speak_rachel_build_part2_29ea1a22:
    ...
    rachel "Nó đủ để sống, nhưng tôi sẽ cần thêm một vài thứ khác để biến nó thành một ngôi đền chính thức."
...
translate vietnamese speak_rachel_build_part2_ec7a5bab:
    ...
    me "Nghe có vẻ như là một nơi tuyệt đẹp."
...
translate vietnamese speak_rachel_build_part2_42ef86a8:
    ...
    me "Cô có thể hoàn thành nó không??"
...
translate vietnamese speak_rachel_build_part2_c80fc9c1:
    ...
    rachel "Có, nhưng tôi sẽ yêu cầu nhiều vật liệu hơn."
...
translate vietnamese speak_rachel_build_part3_d4939906:
    ...
    me "Hiểu rồi. Cô có cần gì ngoài gỗ và đá không?"
...
translate vietnamese speak_rachel_build_part3_d9cf31b2:
    ...
    rachel "Có một vài thứ lặt vặt. Tôi sẽ tự mình tìm chúng. Hầu hết các điện thờ có thể được làm bằng hai vật liệu này."
...
translate vietnamese speak_rachel_build_part4_3bb478ee:
    ...
    rachel "Nó dành cho mục đích nghi lễ. Tôi cần chôn chúng xung quanh đền thờ."
...
translate vietnamese speak_rachel_build_part4_f525dac5:
    ...
    me "Được rồi. Tôi sẽ lấy cho cô tất cả những thứ cần thiết."
...
translate vietnamese speak_rachel_build_part5_17722288:
    ...
    rachel "Ba mảnh xương của chúng sẽ đủ. Hoặc một loại xương từ thứ gì đó mạnh hơn, xương rồng sẽ là hoàn hảo."
...
translate vietnamese speak_rachel_build_part5_b0ddf1a9:
    ...
    me "Ba xương đen, hoặc một xương rồng? Nó sẽ không dễ dàng, nhưng tôi sẽ làm những gì mình có thể."
...
translate vietnamese speak_rachel_build_building_17972ce6:
    ...
    me "Nó sẽ tốn nhiều thời gian chứ?"
...
translate vietnamese speak_rachel_build_building_f113eaf3:
    ...
    me "Cô đi đến những nơi nguy hiểm sao?"
...
translate vietnamese speak_rachel_build_building_c31d6959:
    ...
    rachel "Đó là lãnh thổ nơi tôi sống, trước khi xuất hiện ở thành phố này."
...
translate vietnamese speak_rachel_build_building_7a002bbc:
    ...
    rachel "Mm. Ở Thiên đường bị lãng quên, thế giới mà tôi sống, không còn con người nữa."
...
translate vietnamese speak_rachel_build_building_52a973d3:
    ...
    rachel "Con người luôn có quan hệ mật thiết với các vị thần. Họ phục vụ các Ngài, và được tạo ra bởi Ngài."
...
translate vietnamese speak_rachel_build_building_83347d99:
    ...
    rachel "Đây là một thời điểm rất hỗn loạn. Ít nhất đó là những gì các văn bản cổ nói. Chỉ một số ít người còn nhớ về thời đại này."
...
translate vietnamese speak_rachel_build_building_70839238:
    ...
    rachel "Khoảng 200 nghìn năm trước."
...
translate vietnamese speak_rachel_build_building_049e20ab:
    ...
    rachel "Nó cực kỳ nguy hiểm, nhưng cũng chứa đầy cơ hội. Tàn tích của các vị thần có mặt ở khắp mọi nơi, thế giới tràn ngập năng lượng tâm linh."
...
translate vietnamese speak_rachel_build_building_cffe04c7:
    ...
    rachel "Tôi không biết. Tất cả các nguyên văn chỉ nói một điều. Rằng nguy hiểm đến từ bên ngoài."
...
translate vietnamese speak_rachel_build_building_a2d3116e:
    ...
    rachel "Nhiều người tin rằng nó đã bị các vị thần bỏ rơi và lãng quên, do đó có tên là vậy."
...
translate vietnamese speak_rachel_build_building_95fc6aa2:
    ...
    rachel "Được rồi, nếu anh không còn câu hỏi nào nữa, tôi muốn bắt đầu làm việc."
...
translate vietnamese speak_rachel_build_building_2954cb24:
    ...
    rachel "Hãy đến gặp tôi khi anh muốn giúp đỡ một lần nữa, và cảm ơn anh. Ý tôi là nó."
...
translate vietnamese speak_rachel_build_little_fox_findus_bc089777:
    ...
    me "Yeah, tôi sẽ rất vui khi gặp lại em ấy."
...
translate vietnamese strings:
    ...
    new "Đưa 50 đá {#visible}"

    # game/characters/rachel/speak_build.rpy:56
    old "Give 10 wood {#visible}"
    new "Đưa 10 gỗ {#visible}"
