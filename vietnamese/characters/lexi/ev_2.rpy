...
translate vietnamese lexi_2_1_110572d3:
    ...
    lexi "Anh thực sự không nhớ bất cứ điều gì trong năm qua?"
...
translate vietnamese lexi_2_1_4373b715:
    ...
    me "Đáng tiếc là không. Điều cuối cùng anh nhớ là tai nạn xe hơi lúc đi làm về."
...
translate vietnamese lexi_2_1_1dec043f:
    ...
    lexi "Anh đã làm gì trước The End?"
...
translate vietnamese lexi_2_1_3b645459:
    ...
    lexi "Anh là một phi hành gia? Không thể nào, anh đang đùa đúng không?"

# game/characters/lexi/ev_2.rpy:32
translate vietnamese lexi_2_1_92f85197:

    # me "Why would I?"
    me "Tại sao anh phải đùa?"
...
translate vietnamese lexi_2_1_871a8de1:
    ...
    "Bạn trả lời với vẻ mặt thẳng thắn."
...
translate vietnamese lexi_2_1_6e998f81:
    ...
    "Bạn trả lời với một khuôn mặt thẳng thắn."
...
translate vietnamese lexi_2_1a_a3ecea37:
    ...
    me "Đôi khi nó có thể thực sự nhàm chán nhưng anh vẫn thích nó."
...
translate vietnamese lexi_2_1a_215e479a:
    ...
    me "Anh đoán là mình thích cảm giác tạo ra thứ gì đó."
...
translate vietnamese lexi_2_1a_0f7712c0:
    ...
    me "Cha mẹ em không có ở đó. Chuyện gì đã xảy ra với họ vậy?"
...
translate vietnamese lexi_2_1a_7885d061:
    ...
    lexi "Không đâu cả. Hiện tại chúng ta đã có đủ lương thực, vì vậy chúng ta đang tìm kiếm bất cứ thứ gì khác có thể sử dụng."
...
translate vietnamese lexi_2_1a_52122a1d:
    ...
    me "Em đã nói trước đây rằng em là người duy nhất đi ra ngoài để kiếm đồ. Tại sao vậy?"
...
translate vietnamese lexi_2_1a_72fe583a:
    ...
    lexi "Cậu ấy thỉnh thoảng cũng đi nhưng không nhiều. Em không muốn cậu ấy gặp rủi ro."
...
translate vietnamese lexi_2_1a_789a6785:
    ...
    lexi "Nếu một ngày nào đó em chết thì cần phải có người chăm sóc Mina."
...
translate vietnamese lexi_2_1a_a24109ed:
    ...
    lexi "Không ai có thể bảo vệ em khỏi những thứ ngoài kia, nhưng dù sao cũng cảm ơn."
...
translate vietnamese lexi_2_1a_bd6d7fa6:
    ...
    lexi "Nhưng nếu có thứ gì đó tấn công em, thì cứ chạy đi. Cả hai chúng ta không cần phải chết."
...
translate vietnamese lexi_2_1a_eaac4633:
    ...
    lexi "Nếu anh muốn bảo vệ ai đó, thì hãy giữ Mina an toàn cho em sau khi em chết."
...
translate vietnamese lexi_2_1a_37a4c182:
    ...
    lexi "Vậy thì em phải cảm ơn anh rồi!"
...
translate vietnamese lexi_2_1a_c8049230:
    ...
    lexi "Tốt hơn hết anh nên giữ lời hứa của mình nếu không em sẽ quay lại từ nấm mồ của mình để đá vào mông anh!"
...
translate vietnamese lexi_2_2_6e43cde6:
    ...
    "Sau khi đi bộ một lúc, bạn nhận thấy một cái gì đó giữa sương mù."

# game/characters/lexi/ev_2.rpy:112
translate vietnamese lexi_2_2_06b6b4e8:

    # lexi "Look! It seems we found something."
    lexi "Nhìn này! Có vẻ như chúng ta đã tìm thấy một cái gì đó."
...
translate vietnamese lexi_2_2_46e0bfd1:
    ...
    "Khi cô ấy nói, cô ấy đã di chuyển về phía ngôi nhà."
...
translate vietnamese lexi_2_2_f1b2bac3:
    ...
    "Cả hai bạn cẩn thận bước vào qua cánh cửa mở. Những gì bạn nhìn thấy bên trong khiến trái tim bạn đau nhói."
...
translate vietnamese lexi_2_2_abb43b4d:
    ...
    "Một gia đình ba người nằm tắm trong máu của chính họ ở giữa phòng. Người mẹ đang khỏa thân, bạn có thể tưởng tượng tại sao, [lexi] nhanh chóng kiểm tra cơ thể của họ."
...
translate vietnamese lexi_2_2_32f1c2b1:
    ...
    lexi "Không có bất kỳ nguy hiểm nào nữa. Có vẻ như nó đã được thực hiện bởi những tên cướp. Vì chúng đã xong ở đây, nên chúng rời đi rồi."
...
translate vietnamese lexi_2_2_3fe0d827:
    ...
    me "Hãy nhanh chóng lấy những thứ chúng ta cần và trở lại."
...
translate vietnamese lexi_2_2_2ccb8cd6:
    ...
    lexi "Được rồi. Em sẽ kiểm tra tầng trên, anh kiểm tra tầng này."
...
translate vietnamese lexi_2_2_55b25e56:
    ...
    lexi "Cảm ơn vì đã đi với em! Có lẽ chúng ta nên đi chơi cùng nhau lần nữa."
...
translate vietnamese strings:
    ...
    old "Maybe next time"
    new "Có lẽ lần sau đi"

    # game/characters/lexi/ev_2.rpy:26
    old "I was a programmer. We were working on a game"
    new "Anh là một lập trình viên. Bọn anh đang làm việc trên một trò chơi"

    # game/characters/lexi/ev_2.rpy:26
    old "I was an astronaut"
    new "Anh là một phi hành gia"

    # game/characters/lexi/ev_2.rpy:26
    old "I was porn actor"
    new "Anh là diễn viên phim sex"
    ...
    new "Anh sẽ không để bất cứ điều gì xảy ra với em đâu"
