...
translate vietnamese speak_lexi_b267fd29:
    ...
    lexi "Hey, Có chuyện gì vậy?" id speak_lexi_b267fd29
...
translate vietnamese speak_lexi_menu1_6057173a:
    ...
    "Cô ấy đã nói với mình phải làm gì rồi. Có lẽ mình nên quay trở lại, có thể vẫn còn thức ăn ở đó."
...
translate vietnamese speak_lexi_menu1_1f45fd8a:
    ...
    lexi "Ừ, em cần tìm đồ ăn, muốn đi cùng chứ?"
...
translate vietnamese speak_lexi_menu1_135bd2f5:
    ...
    me "Vậy tại sao em không dẫn người khác đi cùng?"
...
translate vietnamese speak_lexi_menu1_c319f7ba:
    ...
    lexi "Nhiều người hơn có nghĩa là dễ phát hiện hơn và bị tìm thấy thường đồng nghĩa với cái chết."
...
translate vietnamese speak_lexi_menu1_6d1b0c17:
    ...
    me "Với nhiều người hơn, sẽ có thể chống lại một số nguy hiểm."
...
translate vietnamese speak_lexi_menu1_b2c681a5:
    ...
    th "Sao em ấy có thể nói về cái chết của mình một cách thản nhiên như vậy?"

# game/characters/lexi/speak.rpy:60
translate vietnamese speak_lexi_menu1_72663b8c:

    # me "We are together, right now."
    me "Ngay bây giờ chúng ta đang ở bên nhau."
...
translate vietnamese speak_lexi_menu1_bfc3d94a:
    ...
    lexi "Ừ, bằng cách đó chúng ta có thể mang về nhiều thứ hơn. Nếu cả hai chúng ta cùng chết thì vẫn còn Alice để đi nhặt đồ."

# game/characters/lexi/speak.rpy:62
translate vietnamese speak_lexi_menu1_f68de440:

    # me "What about Mina and Grace?"
    me "Còn Mina và Grace thì sao?"
...
translate vietnamese speak_lexi_menu1_ac9c63f9:
    ...
    lexi "Anh mong đợi Grace đi ra ngoài tìm đồ à?"
...
translate vietnamese speak_lexi_menu1_c1a79717:
    ...
    me "Well, anh không thể tưởng tượng em ấy là một người nhặt đồ."
...
translate vietnamese speak_lexi_menu1_d47016da:
    ...
    lexi "Vâng, đó sẽ là một cảnh tượng vui nhộn khi được nhìn thấy."
...
translate vietnamese speak_lexi_menu1_424de8a1:
    ...
    lexi "Chúng ta đến đây an toàn rồi. Em sẽ lấy thức ăn. Anyh tìm kiếm bất cứ thứ gì khác có thể sử dụng được."
...
translate vietnamese speak_lexi_menu1_e1cca951:
    ...
    lexi "Em đã sẵn sàng rồi, còn anh thì sao?"
...
translate vietnamese speak_lexi_menu1_af81b1bc:
    ...
    me "Đó là tại bàn tay của em mà anh không thể quên."
...
translate vietnamese speak_lexi_menu2_0e4a430c:
    ...
    me "Không. Nhưng điều đó có liên quan gì?"
...
translate vietnamese speak_lexi_menu2_c0d10f05:
    ...
    lexi "Chúng ta cần nhiều thứ để sống và không có nơi nào tốt hơn để lưu trữ chúng, chúng ta chỉ có thể đặt chúng trong hộp."
...
translate vietnamese speak_lexi_menu2_b27725f5:
    ...
    me "Tại sao em không đặt chúng trong phòng của anh? Chúng sẽ không cản trở bất cứ ai trong đó."
...
translate vietnamese speak_lexi_menu2_77c50307:
    ...
    lexi "Thực ra đã có người sống ở đó trước đây."
...
translate vietnamese speak_lexi_menu2_e2a78ff3:
    ...
    me "Anh đoán đây không phải là một câu chuyện có hậu. Đó là ai vậy?"
...
translate vietnamese speak_lexi_menu2_ade7a944:
    ...
    lexi "Chủ của khách sạn này, tên anh ấy là Jack và anh ấy rất tốt với chúng em. Anh ấy để chúng tôi ở lại đây khi bọn em không còn nơi nào khác để đi."

# game/characters/lexi/speak.rpy:180
translate vietnamese speak_lexi_menu2_030ee7ce:

    # me "What happened to him?"
    me "Chuyện gì đã xảy ra với anh ấy?"
...
translate vietnamese speak_lexi_menu2_c2d24491:
    ...
    lexi "Thế giới bây giờ là như vậy."
...
translate vietnamese speak_lexi_menu2_5758e325:
    ...
    me "Học sinh? Thế em bao nhiêu tuổi?"
...
translate vietnamese speak_lexi_menu2_84b208ec:
    ...
    lexi "Ngày tận thế xảy ra trước sinh nhật lần thứ 20 của em."
...
translate vietnamese speak_lexi_menu2_24c45420:
    ...
    me "Em chỉ trông không giống như một học sinh đối với anh."
...
translate vietnamese speak_lexi_menu2_8d40e353:
    ...
    lexi "Em không biết anh đang nói gì."
...
translate vietnamese speak_lexi_tasks_5c751c2c:
    ...
    lexi "Hiểu rồi. anh có cần em làm gì khác không?"
...
translate vietnamese speak_lexi_tasks_3c4bc4e0:
    ...
    lexi "Nắp chai á? Được rồi. Nó không quá khó."
...
translate vietnamese strings:
    ...
    new "Em Muốn đi khám phá cùng nhau không? {gold}(Cốt truyện){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "How about we do it again? {gold}(Story){/gold}"
    new "Chúng ta làm chuyện đó lần nữa được không? {gold}(Cốt truyện){/gold}"
    ...
    new "Ask if she is alright {gold}(Cốt truyện){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "Need some help? {gold}(Story){/gold}"
    new "Cần giúp gì không? {gold}(Cốt truyện){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "Can I help you somehow? {gold}(Story){/gold}"
    new "Anh có thể giúp gì cho em được không? {gold}(Cốt truyện){/gold}"

    # game/characters/lexi/speak.rpy:12
    old "I have the ice cream {gold}(Story){/gold}"
    new "Anh có kem này {gold}(Cốt truyện){/gold}"
    ...
    new "Em có muốn massage không? {#visible}"

    # game/characters/lexi/speak.rpy:12
    old "Tasks {#visible}"
    new "Nhiệm vụ {#visible}"
    ...
    new "Tại sao có nhiều hộp các tông xung quanh vậy?"

    # game/characters/lexi/speak.rpy:168
    old "What were you doing before The End?"
    new "Em đã làm gì trước The End vậy?"
    ...
    new "Tìm vật liệu (Thời gian: [lexiTasks.scavengeMaterials.duration]) {loot}(Vật liệu+){/loot} {#visible}"
