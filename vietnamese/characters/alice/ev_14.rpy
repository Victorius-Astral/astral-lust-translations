...
translate vietnamese alice_14_c61c6c36:

    # alice "I'm in, but I think we should try something new."
    alice "Em sẽ tham gia, nhưng em nghĩ chúng ta nên thử một cái gì đó mới." # TL

# game/characters/alice/ev_14.rpy:13
translate vietnamese alice_14_a55068a2:

    # me "What do you mean exactly?"
    me "Chính xác là em muốn gì?" # TL
...
translate vietnamese alice_14_081b15bf:
    ...
    alice "Anh thực sự nghĩ rằng em không biết về thứ trong Ngục tối của anh sao?" # TL
...
translate vietnamese alice_14_11d28569:
    ...
    alice "Anh thậm chí còn nhốt ai đó ở đấy cơ... em còn không chắc là mình có muốn biết anh làm gì với tù nhân của anh không nữa." # TL
...
translate vietnamese alice_14_ad31009f:
    ...
    alice "Và thật luôn, Anh không có cách nào tốt hơn để sử dụng tài nguyên của mình à?" # TL
...
translate vietnamese alice_14_a289625b:
    ...
    alice "Thế anh sẽ đưa em đến đó chứ?" # TL

# game/characters/alice/ev_14.rpy:57
translate vietnamese alice_14_40fc69f3:

    # alice "Hmph! Whatever, go have sex with your hand, instead."
    alice "Hmph! Sao cũng được, đi làm bạn với tay phải của mình thay vì em đi." # TL

# game/characters/alice/ev_14.rpy:65
translate vietnamese alice_14_part2_d180988e:
...
translate vietnamese alice_14_part2_f85609cd:
    ...
    alice "Chúng ta sẽ làm gì?" # TL

# game/characters/alice/ev_14.rpy:75
translate vietnamese alice_14_part2_237582ec:
...
translate vietnamese alice_14_part2_8d7fd32f:
    ...
    alice "Em muốn làm điều gì đó mà chúng ta đã chưa từng làm trước đây." # TL
...
translate vietnamese alice_14_part2_64d2cba3:
    ...
    alice "Và tại sao anh lại trói tay em?" # TL

# game/characters/alice/ev_14.rpy:123
translate vietnamese alice_14_part2_f96fadd5:
...
translate vietnamese alice_14_part2_28d63b25:
    ...
    alice "Để mà nói thật thì, bị trói bởi anh như thế này cũng... khá là hot đấy." # TL
...
translate vietnamese alice_14_part2_a68f7064:
    ...
    me "Tin anh đi, phần nóng bỏng chỉ mới bắt đầu thôi. Đã đến lúc em phải di chuyển hông rồi." # TL

# game/characters/alice/ev_14.rpy:148
translate vietnamese alice_14_part2_24b7b2f8:
...
translate vietnamese strings:
    ...
    new "Làm sao anh có thể từ chối một Quý cô được?" # TL
