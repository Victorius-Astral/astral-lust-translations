...
translate vietnamese alice_2_727794f4:
    ...
    "Cả hai nhìn nhau trong một phút, và bạn bắt đầu cảm thấy khó xử."
...
translate vietnamese alice_2_0af0f079:
    ...
    "Sự khó chịu trong giọng nói của bạn dường như khiến nụ cười của cô ấy rộng hơn."
...
translate vietnamese alice_2_2eaa7b94:
    ...
    alice "Vậy anh nghĩ em là loại phụ nữ gì?"
...
translate vietnamese alice_2_1c520ba9:
    ...
    me "Không, xin lỗi anh đã quá đà rồi."
...
translate vietnamese alice_2_7fc0500f:
    ...
    "Bạn không cần phải đợi lâu khi cô ấy bò đến gần bạn, xà vào vòng tay của bạn."
...
translate vietnamese alice_2_daababf4:
    ...
    "Bạn không nói gì nữa, im lặng tận hưởng hơi ấm của nhau."
...
translate vietnamese alice_2_9f032116:
    ...
    alice "{color=#FF958F}[[Sức thu hút không đủ]{/color} Haha! mơ đi!"
...
translate vietnamese alice_2_87779cbd:
    ...
    "Lời đề nghị của bạn khiến cô ấy cười, điều này càng khiến bạn khó chịu hơn."
...
translate vietnamese alice_2_c09f5a24:
    ...
    "Sự chế nhạo của cô ấy đã có tác dụng khi bạn càng cảm thấy tức giận hơn."
...
translate vietnamese alice_2_1a_376314ab:
    ...
    alice "Chắc là tại em đổ anh rồi."
...
translate vietnamese alice_2_1a_eeef5eba:
    ...
    alice "Giờ em đã nhìn đủ rồi, đã đến lúc em làm điều gì đó hữu ích đây."

# game/characters/alice/ev_2.rpy:79
translate vietnamese alice_2_1a_cdb4ee28:

    # "Her suggestive look doesn't escape your eyes."
    "Cái nhìn khêu gợi của cô ấy không thoát khỏi mắt bạn."
...
translate vietnamese alice_2_1a_41a30f7c:
    ...
    "Sau đó, cô ấy bước ra khỏi phòng của bạn và mỉm cười."
...
translate vietnamese alice_2_1b_9fcd09a4:
    ...
    "[alice] đứng lên nhanh đến mức bạn thậm chí không kịp phản ứng."
...
translate vietnamese strings:
    ...
    new "Em cần một con cặc, đó là lý do em ở đây"
...
translate vietnamese strings:
    ...
    new "Đùa giỡn với mình dường như là sở thích của cô ấy."
