...
translate vietnamese room_library_books_l_edd53035:

    # th "What should I read?"
    th "Mình nên đọc cái gì đây?"

# game/places/library/books_l.rpy:26
translate vietnamese room_library_books_l_secrets_6f60ec71:

    # bbs "Sarahel, the grand wizard, Book of Secrets"
    bbs "Sarahel, phù thủy vĩ đại, cuốn sách của sự bí mật"

# game/places/library/books_l.rpy:27
translate vietnamese room_library_books_l_secrets_69c428e4:

    # bbs "In the loving memory of Saint Pio, may This name be lost forever, this tragedy, never occurring again."
    bbs "Trong ký ức yêu thương của Thánh Pio, xin cho tên cái này vĩnh viễn mất đi, thảm kịch này, không bao giờ xảy ra nữa."

# game/places/library/books_l.rpy:28
translate vietnamese room_library_books_l_secrets_0906916e:
    ...
    bbs "Sự tò mò của loài người là không có giới hạn, chúng ta sẽ lao ngay vào ngọn lửa miễn là có thứ chúng ta khao khát ở bên trong."
...
translate vietnamese room_library_books_l_secrets_46a4911d:
    ...
    bbs "Ta đã thấy nhiều nghi lễ được tổ chức mà đến chúng cũng không hiểu được, gọi những cái tên không nên gọi. Mặc dù hầu hết kiến thức chúng sở hữu là sai, nhưng ta đã thấy một số kiến thức bắt nguồn từ các ghi chú đúng."
...
translate vietnamese room_library_books_l_secrets_317e3d2e:
    ...
    bbs "Cuốn sách này ra đời nhằm ngăn chặn những bi kịch không đáng có xảy ra. Bằng cách dạy những điều cơ bản về thế giới thần bí cho những người đam mê và những người mới phi thường."

# game/places/library/books_l.rpy:34
translate vietnamese room_library_books_l_secrets_57d6cb72:
    ...
    bbs "Điều đầu tiên cần lưu ý là không bao giờ gọi một cái tên danh dự không xác định! Tên danh dự là một chuỗi các danh hiệu, chủ yếu là ba, hướng tới thực thể tối cao hơn."
...
translate vietnamese room_library_books_l_secrets_8f918826:
    ...
    bbs "Hai người khác sẽ là Chúa tể Mặt trăng, Hoàng đế của thảm họa, Người mang giấc mơ và Mẹ Trái đất, Nữ hoàng thiên nhiên, Cội nguồn của sự sống."
...
translate vietnamese room_library_books_l_etiquette_6a2c7886:
    ...
    bae "Có vô số nền văn minh trong vũ trụ vô biên và bao nhiêu phiên bản của những gì được coi là hành vi phù hợp, nhưng có một số quy tắc chung được áp dụng phổ biến."

# game/places/library/books_l.rpy:49
translate vietnamese room_library_books_l_etiquette_49d99758:
    ...
    bae "Những quy tắc này được áp dụng khi giao dịch với các Thực Thể Tối Cao. Những đấng Tối Cao cao là những thực thể bất tử phi thường, đôi khi được gọi là Thần."

# game/places/library/books_l.rpy:50
translate vietnamese room_library_books_l_etiquette_ed8abb19:

    # bae "They live in the void between the stars, are powerful beyond understanding, and terrifying beyond imagination."
    bae "Họ sống trong khoảng không giữa các vì sao, có sức mạnh vượt quá sự hiểu biết và đáng sợ ngoài sức tưởng tượng."

# game/places/library/books_l.rpy:51
translate vietnamese room_library_books_l_etiquette_ddb539ed:

    # bae "In my own realm, such beings vanished long ago."
    bae "Trong cõi riêng của tôi, những sinh mệnh như vậy đã biến mất từ lâu."

# game/places/library/books_l.rpy:52
translate vietnamese room_library_books_l_etiquette_e9c4d332:
    ...
    bae "Tuy nhiên, các quy tắc của nghi thức đã được truyền lại. Có lần một người bạn thân của bạn đã mắc sai lầm khi trốn tránh những quy tắc này. Toàn bộ hậu quả của hành động của anh ta sẽ không được ghi lại ở đây, nhưng cảnh báo phải được thực hiện."

# game/places/library/books_l.rpy:53
translate vietnamese room_library_books_l_etiquette_dd477d16:
    ...
    bae "Tôi không muốn những người mà tôi trân trọng sẽ chết theo cách như vậy. Vì vậy, tôi đã nhận nhiệm vụ truyền đạt những điều quan trọng nhất trong các học thuyết."

# game/places/library/books_l.rpy:54
translate vietnamese room_library_books_l_etiquette_f2e82458:
    ...
    bae "Đầu tiên, đừng bao giờ thiếu tôn trọng một vị thần. Niềm tự hào của họ vượt ra ngoài cuộc sống của chúng ta, và như vậy, họ không được mô tả là \"anh ấy\" hoặc \"cô ấy\", nhưng là \"anh ấy\" và \"cô ấy\". Đừng bao giờ thể hiện sự tôn trọng không đúng mực trong giọng nói và suy nghĩ của bạn khi họ là chủ."

# game/places/library/books_l.rpy:58
translate vietnamese room_library_books_l_etiquette_715a2b01:

    # bae "Or rather \"It\", as Their form and gender are not fixed and can take on various forms."
    bae "Hay đúng hơn là \"Ngài\", vì hình thức và giới tính của họ không cố định và có thể ở nhiều dạng khác nhau."
...
translate vietnamese room_library_books_l_etiquette_ec1cb131:
    ...
    bae "Thứ ba, đừng bao giờ gọi tên họ mà không có lý do."

# game/places/library/books_l.rpy:61
translate vietnamese room_library_books_l_etiquette_2754f016:
    ...
    bae "Hãy cầu nguyện với Họ, cầu xin sự quan tâm và ân sủng của Họ, nhưng đừng bao giờ sử dụng tên của Họ một cách phù phiếm. Điều này có thể được hiểu là một phần mở rộng của quy tắc đầu tiên, nhưng nó mang sự khác biệt của riêng nó."

# game/places/library/books_l.rpy:62
translate vietnamese room_library_books_l_etiquette_c0128164:

    # bae "Should one disrespect Them, they may be unmade without a moments hesitation, regardless of distance or time."
    bae "Nếu một người không tôn trọng họ, họ có thể xóa sổ mà không cần do dự, bất kể khoảng cách hay thời gian."

# game/places/library/books_l.rpy:63
translate vietnamese room_library_books_l_etiquette_596f7a26:

    # bae "The fourth and final rule. Do not pray to evil or unknown entities, as that way lies death and madness."
    bae "Quy tắc thứ tư và cuối cùng. Đừng cầu nguyện với những thực thể xấu xa hoặc vô danh, vì con đường đó là cái chết và sự điên rồ."

# game/places/library/books_l.rpy:64
translate vietnamese room_library_books_l_etiquette_796d7534:
    ...
    bae "Trước đây tôi đã do dự khi ghi lại những lời dạy này, vì bất kỳ kiến thức nào về những thực thể này đều có rủi ro lớn. Có lẽ tôi đã trở nên đa cảm ở tuổi già và chỉ đơn giản mong muốn những người khác tránh được nỗi đau mà tôi đã phải trải qua."

# game/places/library/books_l.rpy:65
translate vietnamese room_library_books_l_etiquette_822109f3:
    ...
    bae "Khi đọc những văn bản này, nếu bạn không đủ may mắn để nhận thức được những Đấng Tối Cao đó, tôi hy vọng điều này có thể giúp ích được phần nào cho bạn."

# game/places/library/books_l.rpy:66
translate vietnamese room_library_books_l_etiquette_8d523be8:
    ...
    bae "Đối với những người vẫn chưa biết về sự tồn tại của họ trước khi sự tò mò đã thúc đẩy bạn đọc cuốn sách này. Tôi thực sự thương hại bạn, vì họ sẽ không."

translate vietnamese strings:

    # game/places/library/books_l.rpy:12
    old "Book of Secrets"
    new "Cuốn sách của sự bí mật"
