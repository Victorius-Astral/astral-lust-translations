...
translate vietnamese mirror_player_f26693f2:
    ...
    "Bạn nói trong vài giờ." id mirror_player_f26693f2 # TL
...
translate vietnamese mirror_player_e94b717b:
    ...
    "Đầu bạn đau sau khi làm việc căng thẳng quá nhiều trong ngày hôm nay, bạn cần nghỉ ngơi." # TL
...
translate vietnamese strings:
    ...
    # game/places/hotel/player/mirror.rpy:31
    old "Lexi ([lexi])"
    new "Lexi ([lexi])" # TL # Victorius - AI

    # game/places/hotel/player/mirror.rpy:31
    old "Mina ([mina])"
    new "Mina ([mina])" # TL # Victorius - AI

    # game/places/hotel/player/mirror.rpy:31
    old "Grace ([grace])"
    new "Grace ([grace])" # TL # Victorius - AI

    # game/places/hotel/player/mirror.rpy:31
    old "Alice ([alice])"
    new "Alice ([alice])" # TL # Victorius - AI
