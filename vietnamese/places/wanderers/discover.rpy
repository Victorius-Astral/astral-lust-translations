...
translate vietnamese discover_wanderers_65fc5510:
    ...
    "Tiếng súng rền vang phá vỡ sự im lặng."
...
translate vietnamese discover_wanderers_part2_1e41129d:
    ...
    "Bạn tìm thấy nguồn gốc của các phát bắn."
...
translate vietnamese discover_wanderers_win_e7938e38:
    ...
    me "ông có biết nơi nào an toàn gần đây không?"
...
translate vietnamese discover_wanderers_win_a58e9d67:
    ...
    "Sau một thời gian dài, cuối cùng bạn cũng dừng lại ở một thị trấn nhỏ tồi tàn." id discover_wanderers_win_a58e9d67
...
translate vietnamese discover_wanderers_win_ab5eea35:
    ...
    u_governor "Tôi cũng không biết lý do, nhưng sương mù tránh xa nơi này. Nó tránh tất cả những nơi con người ẩn náu, nhưng bạn có thể đã nhận ra."
...
translate vietnamese discover_wanderers_win_a265d218:
    ...
    governor "Trong khi những người du hành chúng ta là những linh hồn tự do, thì nơi này là nơi trú ẩn an toàn mà người ta có thể sử dụng để buôn bán và nghỉ ngơi."
...
translate vietnamese discover_wanderers_win_ec126fe2:
    ...
    governor "Đúng vậy, những người du mục bao gồm những nhóm người độc lập giúp nhau tồn tại. Bạn có thể coi chúng tôi như một phe."
...
translate vietnamese discover_wanderers_win_f991a53c:
    ...
    me "Nhưng nếu những người du mục là những nhóm người độc lập, thì điều gì sẽ xảy ra với nơi ẩn náu và thống đốc?"
...
translate vietnamese discover_wanderers_win_dcdb7b98:
    ...
    governor "Haha, nơi này là có một không hai."
...
translate vietnamese discover_wanderers_win_d02b95ea:
    ...
    governor "Nắp chai? đúng, là nó đấy."
...
translate vietnamese discover_wanderers_win_cf3a6cd0:
    ...
    th "Mình phải làm cái quái gì với cái này đây?"
...
translate vietnamese discover_wanderers_win_9c3fc517:
    ...
    governor "Rất tiếc là ông không thể nhìn thấy khuôn mặt của mình!"
...
translate vietnamese discover_wanderers_win_acb81293:
    ...
    governor "Đến đây, tôi sẽ đưa ông đến một nơi ông có thể ở."
...
translate vietnamese discover_wanderers_win_d611ebaa:
    ...
    governor "Nó không nhiều, nhưng có còn hơn không. Căn phòng đầu tiên là của ông."
...
translate vietnamese discover_wanderers_win_650ce5b6:
    ...
    governor "Ông có thể ở đây bất cứ lúc nào. Thông thường người ta cần phải trả tiền cho một đêm ở nhà nghỉ, nhưng hôm nay ông đã cứu tôi. Nên hãy để điều đó ở lại giữa chúng ta."
