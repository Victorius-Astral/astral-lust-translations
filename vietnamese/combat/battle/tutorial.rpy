...
translate vietnamese tutorial_combat_end_84b3e835:
    ...
    lexi "Anh cũng nên ưu tiên xây dựng {i}{b}phòng thể dục{/b}{/i}. Anh có thể xây dựng các phòng tại quầy ở sảnh đợi. Ở đó anh có thể tập luyện {i}{str}sức mạnh{/str}{/i}, {i}{vit}Sinh lực{/vit}{/i} và {i}{agi}nhanh nhẹn{/agi}{/i}."
