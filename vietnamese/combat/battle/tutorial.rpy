...
translate vietnamese tutorial_combat_win_0e9ac73e:
    ...
    lexi "Cậu có nghĩ rằng Cậu có thể đánh bại những đối thủ mạnh hơn bản thân bây giờ không?"

# game/combat/battle/tutorial.rpy:131
translate vietnamese tutorial_combat_win_c8a97167:

    # lexi "It's good to be confident!"
    lexi "Thật tốt khi cậu tự tin!"
...
translate vietnamese tutorial_combat_win_3b7ded66:
    ...
    lexi "Tuy nhiên, đừng quá tự tin đấy."
...
translate vietnamese tutorial_combat_win_df49cf00:
    ...
    lexi "Ừm. Chỉ cần đừng làm những điều dại dột. Không có gì phải xấu hổ khi chạy trốn cả."
...
translate vietnamese tutorial_combat_win_20fa15ab:
    ...
    lexi "Tốt đấy. Có rất nhiều quái vật rất mạnh mẽ ngoài đó. Hãy chắc chắn để chạy nếu cậu nghĩ rằng cậu chưa thể xử lý nó."
...
translate vietnamese tutorial_combat_win_a951d98d:
    ...
    me "Chuẩn rồi. Tớ sẽ cẩn thận. Nó sẽ rất tệ khi mà phải bỏ mạng."
...
translate vietnamese tutorial_combat_win_485f2947:
    ...
    lexi "Ahh .. Nếu cậu thiếu tự tin ngay cả bây giờ, sẽ rất khó cho cậu ngoài kia. Tên người sói này thực sự rất yếu.."

# game/combat/battle/tutorial.rpy:159
translate vietnamese tutorial_combat_win_9cbc5c7f:

    # lexi "Don't go out often, 'key?"
    lexi "Đừng ra ngoài quá thường xuyên nhé, 'okey?"
...
translate vietnamese tutorial_combat_lose_ca6b176b:
    ...
    lexi "Sau khi cậu ngất đi, tớ không còn lựa chọn nào khác ngoài việc tự mình đứng lên và đá đít nó."
...
translate vietnamese tutorial_combat_lose_753d1f1a:
    ...
    me "Nếu tớ muốn ra ngoài khám phá thì sao?"
...
translate vietnamese tutorial_combat_lose_9fad501a:
    ...
    lexi "Chúc may mắn. Rèn luyện sự nhanh nhẹn của bạn và chạy thật nhanh."
...
translate vietnamese tutorial_combat_end_fd7a89e1:
    ...
    lexi "Có một số vật dụng trong phòng của bạn có thể giúp ích cho bạn. Hãy thử nâng cao {i}{cha}sức thu hút{/cha}{/i} với gương. {i}{int}Sự thông minh{/int}{/i} tại Khối Rubik trên tủ đầu giường của bạn."
...
translate vietnamese tutorial_combat_end_40cde874:
    ...
    lexi "Trong trận chiến, điều quan trọng hơn là nâng cao {i}{wis}sự thông thái{/wis}{/i} đầu tiên. Bạn có thể làm điều này bằng cách đọc một cuốn sách trên tủ đầu giường của bạn."
...
translate vietnamese strings:
    ...
    new "Bắt đầu hướng dẫn chiến đấu"

    # game/combat/battle/tutorial.rpy:22
    old "Skip tutorial"
    new "Bỏ qua hướng dẫn"

    # game/combat/battle/tutorial.rpy:39
    old "I'm gonna teach you how to kick asses of the threats out there."
    new "Tớ sẽ dạy cậu cách đánh bật những mối đe dọa ngoài kia."
    ...
    new "Những gì chúng ta sẽ chiến đấu bây giờ là một người sói. Đừng lo lắng con này ốm yếu và chậm phát triển. Người sói bình thường mạnh hơn nhiều!"
    ...
    new "Đây là điểm sinh lực của chúng ta. Nếu nó chạm 0, chúng ta sẽ không thể chiến đấu được nữa. Hãy đảm bảo là đừng chết nhé ! Và nhớ rằng, chúng ta cần phải giết chúng trước khi chúng giết chúng ta."
    ...
    new "Bạn có thể thấy các thẻ của mình ở dưới cùng. Đây là bàn tay của bạn. Miễn là bạn có đủ điểm linh hồn, bạn sẽ có thể chơi bất kỳ thẻ nào trong số này."
    ...
    old "Use Strike card"
    new "Sử dụng thẻ Đánh"

    # game/combat/battle/tutorial.rpy:48
    old "To win we need to kill the enemy. You can attack him with your cards. Try using Strike to hit him."
    new "Để giành chiến thắng, chúng ta cần phải giết kẻ thù. Bạn có thể tấn công nó bằng các thẻ của bạn. Hãy thử sử dụng Strike để đánh nó."

    # game/combat/battle/tutorial.rpy:50
    old "Use Strike again!"
    new "Sử dụng thẻ Đánh lần nữa!"

    # game/combat/battle/tutorial.rpy:50
    old "Nice! Hit him again!"
    new "Đẹp! Đánh nó một lần nữa!"
    ...
    new "Chúng ta còn thiếu sót về linh hồn .. Chúng ta nên chuẩn bị cho bước di chuyển của nó. Bạn có thấy thứ này trên đầu nó không? Đó là một dấu hiệu có nghĩa là nó sẽ tấn công một trong hai chúng ta với 5 sát thương."

    # game/combat/battle/tutorial.rpy:58
    old "Use Defend"
    new "Sử dụng Phòng thủ"

    # game/combat/battle/tutorial.rpy:58
    old "Since he's gonna attack, you need to be ready. Use the Defend card."
    new "Vì nố sẽ tấn công, bạn cần phải sẵn sàng. Sử dụng thẻ Phòng thủ."
    ...
    new "Tuyệt quá! Lá chắn bên trái sức khỏe của bạn là một khối. Mỗi khối có thể chặn một điểm thiệt hại. Với 5 khối, tên cướp sẽ không thể làm hại bạn chút nào!"
    ...
    new "Bạn đã làm tất cả mọi thứ bạn có thể đến lượt này. Khi lượt kết thúc, đồng minh và kẻ thù của bạn sẽ hành động. Hãy nhớ rằng, tất cả các quân bài còn lại trên tay của bạn sẽ bị loại bỏ và bạn sẽ được chia một ván bài mới."

    # game/combat/battle/tutorial.rpy:67
    old "You can end turn either by clicking the button, or by pressing 'Space'. Try it now."
    new "Bạn có thể kết thúc lượt bằng cách nhấp vào nút hoặc bằng cách nhấn 'Dấu cách'. Thử ngay bây giờ."
    ...
    new "Nếu bạn cảm thấy mình không có cơ hội trong một cuộc chiến và sắp chết, bạn luôn có thể cố gắng trốn thoát. Cơ hội thoát được ghi ở phần dưới cùng của nút. Mọi nỗ lực chạy trốn sẽ khiến bạn phải trả giá bằng 2 linh hồn."
    ...
    new "Ở góc dưới cùng bên trái là cọc rút bài của bạn. Đó là một đống thẻ mà từ đó bạn sẽ vẽ tay ở lượt tiếp theo. Bạn có thể nhấp vào nó sau để kiểm tra xem bạn có thể nhận được những thẻ nào trong lượt tiếp theo của mình."
    ...
    new "Ở góc bên phải là thẻ đã dùng. Đó là một đống thẻ đã được sử dụng hoặc bị loại bỏ trong quá trình chơi. Khi cọc rút trống rỗng, nó sẽ được lấp đầy bởi các thẻ từ đống loại bỏ."
    ...
    new "Nó sẽ tấn công một lần nữa .. Tôi sợ rằng anh nó thể nhắm vào tôi, bạn có thể giúp tôi phòng thủ được không? Nhấp vào tôi để chọn tôi."
    ...
    new "Tuyệt quá! Bạn có thấy thanh máu của tôi hiện có màu vàng và xung quanh tôi có đèn vàng lơ lửng không? Nó có nghĩa là tôi được chọn. Bây giờ các thẻ buff bạn sử dụng sẽ nhắm tới tôi."
    ...
    new "Sử dụng thẻ Khổng lồ hóa để tăng điểm cho tôi. Bạn sẽ thấy nó đã trao cho tôi tăng sức mạnh thay vì bạn. Đôi khi, tấn công là cách phòng thủ tốt nhất. Khi bạn muốn bỏ thẻ cho chính mình, hãy tự chọn!"
    ...
    new "Tốt lắm! Cảm ơn vì đã buff! Bạn phải nhận thấy rằng một số thẻ sẽ ảnh hưởng đến kẻ thù và những người khác trong đội. Mục tiêu không phải là ngẫu nhiên. Khi bạn di chuột qua một thẻ, ở góc dưới cùng bên trái của thẻ đó có một vòng tròn nhỏ. Nó cho biết ai sẽ bị ảnh hưởng bởi thẻ."
    ...
    new "Các mục tiêu có thể là một hoặc nhiều mục tiêu. Số lượng chính xác được giải thích bằng mô tả thẻ."
    ...
    new "Bây giờ có ba màu bạn cần nhớ: \n {color=#00b438}Màu xanh lá{/color} thẻ nhắm đến thành viên trong nhóm của bạn, đó có thể là bạn. \n {color=#c2001f}màu đỏ{/color} thẻ nhằm vào kẻ thù. \n {color=#010ebd}Màu xanh lam{/color} thẻ ảnh hưởng đến bạn, bất kể đồng đội nào được chọn bây giờ."

    # game/combat/battle/tutorial.rpy:96
    old "Target Wheel"
    new "Vòng quay mục tiêu"
    ...
    new "Một số thẻ phức tạp hơn và ảnh hưởng đến rất nhiều người. Vòng quay mục tiêu có thể có một trong các màu xanh lục, đỏ và xanh lam."
    ...
    new "Nó cũng có thể có tất cả các màu cùng một lúc hoặc không có màu nào nếu nó không ảnh hưởng trực tiếp đến bất kỳ ai và ảnh hưởng đến chính trận chiến. vòng quay mục tiêu mang tính gợi ý nhiều hơn, hiệu ứng thẻ thực tế được giải thích bằng mô tả thẻ."
    ...
    new "Hãy thử sử dụng thẻ đâm."

    # game/combat/battle/tutorial.rpy:107
    old "Status Effects"
    new "Hiệu ứng trạng thái"
    ...
    new "Lá bài đâm đã gây chảy máu cho kẻ thù. Nó sẽ gây địch x sát thương, sau đó giảm đi 1 mỗi lượt. Di chuột qua các hiệu ứng sẽ cho bạn thấy chúng làm gì."
    ...
    new "Có rất nhiều hiệu ứng trạng thái bạn có thể sử dụng để thực hiện các kết hợp chết người. Ví dụ, chất độc tăng gấp đôi sát thương nhận được do chảy máu."
    ...
    new "Hãy nhớ luôn kiểm tra xem các hiệu ứng trạng thái mới có tác dụng gì, để bạn có thể nghĩ ra cách kết hợp có thể đánh bay kẻ thù. Nếu bạn nắm vững các hiệu ứng trạng thái, ngay cả những tên cuồng đạo cũng cần phải tránh bạn!"
    ...
    new "Bây giờ bạn đã biết những điều cơ bản, hãy sử dụng thẻ và trí thông minh của mình để đánh bại kẻ thù!"
    ...
    new "Làm ơn, đừng cố gắng thoát trong khi hướng dẫn. Trước tiên bạn phải học một cái gì đó."

    # game/combat/battle/tutorial.rpy:356
    old "Follow the tutorial! It's not the time to end the turn yet."
    new "Làm theo hướng dẫn đi! Vẫn chưa đến lúc kết thúc lượt."
