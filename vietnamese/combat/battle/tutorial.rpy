...
translate vietnamese tutorial_combat_b8ce5a9c:
    ...
    lexi "Ngoài kia nguy hiểm lắm. Anh có muốn em hướng dẫn không?"
...
translate vietnamese tutorial_combat_win_20fa15ab:
    ...
    lexi "Tốt đấy. Có rất nhiều quái vật rất mạnh mẽ ngoài đó. Hãy chắc chắn để chạy nếu anh thấy mình chưa thể xử lý nó."
...
translate vietnamese tutorial_combat_win_a951d98d:
    ...
    me "Chuẩn rồi. Anh sẽ cẩn thận. Sẽ rất tệ khi mà phải bỏ mạng."
...
translate vietnamese tutorial_combat_lose_ca6b176b:
    ...
    lexi "Sau khi anh ngất đi, em không còn lựa chọn nào khác ngoài việc tự mình đứng lên và đá đít nó."
...
translate vietnamese tutorial_combat_lose_753d1f1a:
    ...
    me "Nếu anh muốn ra ngoài khám phá thì sao?"
...
translate vietnamese tutorial_combat_lose_9fad501a:
    ...
    lexi "Chúc may mắn. Rèn luyện sự nhanh nhẹn của anh và chạy thật nhanh."
...
translate vietnamese tutorial_combat_end_84b3e835:
    ...
    lexi "Anh cũng nên ưu tiên xây dựng {i}{b}phòng thể dục{/b}{/i}. Anh có thể xây dựng các phòng tại quầy ở sảnh đợi. Ở đó anh có thể tập luyện {i}{str}sức mạnh{/str}{/i}, {i}{vit}Sức bền bỉ{/vit}{/i} và {i}{agi}nhanh nhẹn{/agi}{/i}."
...
translate vietnamese strings:
    ...
    new "Để giành chiến thắng, chúng ta cần phải giết kẻ thù. Anh có thể tấn công nó bằng các thẻ của mình. Hãy thử sử dụng Đánh để tấn công nó đi."
    ...
    new "Được lắm! Đánh nó một lần nữa!"
    ...
    new "Vì nó sẽ tấn công, nên anh cần phải sẵn sàng. Sử dụng thẻ Phòng thủ đi."
    ...
    new "Anh đã làm tất cả mọi thứ anh có thể ở lượt này rồi. Khi lượt kết thúc, đồng minh và kẻ thù của anh sẽ hành động. Hãy nhớ rằng, tất cả các quân bài còn lại trên tay của anh sẽ bị loại bỏ và anh sẽ được chia một ván bài mới."

    # game/combat/battle/tutorial.rpy:67
    old "You can end turn either by clicking the button, or by pressing 'Space'. Try it now."
    new "Anh có thể kết thúc lượt bằng cách nhấp vào nút hoặc bằng cách nhấn 'Dấu cách'. Thử ngay bây giờ đi."
    ...
    new "Nếu anh cảm thấy mình không có cơ hội trong một cuộc chiến và sắp chết, anh luôn có thể cố gắng trốn thoát. Cơ hội thoát được ghi ở phần dưới cùng của nút. Mọi nỗ lực chạy trốn sẽ khiến anh phải trả giá bằng 2 năng lượng."
    ...
    new "Ở góc bên phải là thẻ đã dùng. Đó là một đống thẻ đã được sử dụng hoặc bị loại bỏ trong quá trình chơi. Khi cọc rút trống rỗng, nó sẽ được lấp đầy bởi các thẻ từ bên bị loại bỏ."
    ...
    new "Tuyệt quá! Anh có thấy thanh máu của em hiện có màu vàng và xung quanh em có đèn vàng lơ lửng không? Nó có nghĩa là em được chọn rồi đấy. Bây giờ các thẻ buff anh sử dụng sẽ nhắm tới em."

    # game/combat/battle/tutorial.rpy:85
    old "Use Giant"
    new "Sử dụng Khổng Lồ Hóa"
    ...
    new "Tốt lắm! Cảm ơn vì đã buff nha! Anh phải nhận thấy rằng một số thẻ sẽ ảnh hưởng đến kẻ thù và những người khác trong đội. Mục tiêu không phải là ngẫu nhiên. Khi anh di chuột qua một thẻ, ở góc dưới cùng bên trái của thẻ đó có một vòng tròn nhỏ. Nó cho biết ai sẽ bị ảnh hưởng bởi thẻ."
    ...
    new "Lá bài đâm đã gây chảy máu cho kẻ thù. Nó sẽ gây x sát thương, sau đó giảm đi 1 mỗi lượt. Di chuột qua các hiệu ứng sẽ cho anh thấy chúng làm gì."
    ...
    new "Có rất nhiều hiệu ứng trạng thái anh có thể sử dụng để thực hiện các kết hợp chết người. Ví dụ, chất độc tăng gấp đôi sát thương nhận vào từ chảy máu."
    ...
    new "Hãy nhớ luôn kiểm tra xem các hiệu ứng trạng thái mới có tác dụng gì, để anh có thể nghĩ ra cách kết hợp có thể đánh bay kẻ thù. Nếu anh nắm vững các hiệu ứng trạng thái, ngay cả những tên cuồng đạo cũng cần phải tránh xa anh đấy!"
    ...
    new "Bây giờ anh đã biết những điều cơ bản rồi, hãy sử dụng thẻ và trí thông minh của mình để đánh bại kẻ thù đi!"
    ...
    new "Làm ơn, đừng cố gắng thoát trong khi hướng dẫn. Trước tiên anh phải học một cái gì đó đã."
