...
translate french strings:
    ...
    new "Il ne fournira pas de chaleur, mais il couvrira au moins les zones privées."
    ...
    new "Viens, papa. Ta petite fille a des devoirs à faire~"

    # game/variables/outfits.rpy:91
    old "It's [grace]'s job to clean the place, but [alice] is always happy to learn new stuff!"
    new "C'est à [grace] de faire le ménage, mais [alice] est toujours heureuse d'apprendre de nouvelles choses!"
    ...
    new "Personne ne veut que [lexi] soit corrompue, mais je parie que vous aimeriez savoir à quoi elle ressemblerait avec quelques tentacules sur son corps."

    # game/variables/outfits.rpy:91
    old "She's an Angel. Literally. She doesn't seem to grow wings, though. Let's change that."
    new "C'est un ange. Au sens propre. Elle ne semble pas avoir d'ailes, cependant. Changeons cela."
    ...
    new "[kiara] aimerait vraiment les soirées disco modernes. Ce n'est peut-être qu'un rêve à Asthar, mais vous pouvez quand même lui offrir une tenue appropriée."
