...
translate french strings:
    ...
    new "Ceci est la fin de l'histoire de {who} dans {ver}. Cette histoire sera bientôt poursuivie! Vous pouvez vérifier les news et les nouvelles versions sur mon {{patreon1}}{{a=https://www.patreon.com/Victorius}}Patreon{{/a}}{{/patreon1}}."

    # game/variables/classes/Astral.rpy:536
    old "Unique cards obtained: {}"
    new "Cartes uniques obtenues: {}"

    # game/variables/classes/Astral.rpy:540
    old "Unique card obtained: {}"
    new "Carte unique obtenue: {}"

    # game/variables/classes/Astral.rpy:557
    old "HELP"
    new "AIDE"
