...
translate french strings:
    ...
    new "Les options de ce menu sont destinées à améliorer l'accessibilité. Elles peuvent ne pas fonctionner avec tous les jeux, et certaines combinaisons d'options peuvent rendre le jeu injouable. Il ne s'agit pas d'un problème avec le jeu ou le moteur. Pour obtenir les meilleurs résultats lorsque vous changez de police, essayez de conserver la taille du texte telle qu'elle était à l'origine."
    ...
    new "Sauvegarder à l'emplacement %s: [text]"
    ...
    new "Le chargement perdra la progression non sauvegardée. Êtes-vous sûr de vouloir faire cela?"
    ...
    new "Êtes-vous sûr de vouloir passer au choix suivant après un dialogue non vu?"
    ...
    new "La capture d'écran a été enregistrée sous le nom de %s."
    ...
    new "Ce programme contient des logiciels gratuits sous plusieurs licences, notamment la licence MIT et la licence publique générale amoindrie de GNU. Une liste complète des logiciels, y compris des liens vers le code source complet, se trouve {a=https://www.renpy.org/l/license}ici{/a}."
    ...
    new "temps de transfert automatique"
    ...
    old "self voicing volume drop"
    new "baisse du volume de l'auto-vocalisation"
    ...
    old "mute main"
    new "sourdine principale"

    # renpy/common/00preferences.rpy:532
    old "mute music"
    new "coupure de la musique"
    ...
    new "L'auto-voix dirait \"[renpy.display.tts.last]\". Appuyez sur 'alt+shift+V' pour le désactiver."

    # renpy/common/00preferences.rpy:620
    old "Self-voicing enabled. Press 'v' to disable."
    new "L'auto-voicing est activé. Appuyez sur 'v' pour le désactiver."
    ...
    old "Hide deleted"
    new "Cacher ce qui est supprimé"

    # renpy/common/_developer/developer.rpym:154
    old "Show deleted"
    new "Afficher la suppression"
    ...
    new "Cliquez avec le bouton droit de la souris ou échappez-vous pour quitter."
    ...
    new "Le Ren'Py Updater n'est pas supporté sur les appareils mobiles."
    ...
    new "Soit ce projet ne supporte pas la mise à jour, soit le fichier d'état de mise à jour a été supprimé."
    ...
    new "Lors du déballage de {}, un type inconnu {}."
    ...
    new "Renderer Force ANGLE"

    # renpy/common/00gltest.rpy:110
    old "Force GLES Renderer"
    new "Renderer Force GLES"
    ...
    new "Le fichier {a=edit:1:log.txt}log.txt{/a} peut contenir des informations qui vous aideront à déterminer ce qui ne va pas sur votre ordinateur."
    ...
    new "Sélectionnez le Gamepad à calibrer"
    ...
    new "Tente de revenir à une date antérieure, ce qui vous permet de sauvegarder ou de faire un autre choix."
    ...
    new "Ignore l'exception et vous permet de continuer."

    # renpy/common/_errorhandling.rpym:626
    old "Ignores the exception, allowing you to continue. This often leads to additional errors."
    new "Ignore l'exception et vous permet de continuer. Cela entraîne souvent des erreurs supplémentaires."
