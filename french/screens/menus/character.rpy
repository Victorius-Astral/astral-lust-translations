...
translate french strings:
    ...
    new "\n{color=#FFD700}--- État Mental ---{/color}" # TL
    ...
    new "\n{color=#FFD700}--- Statistiques Physiques ---{/color}" # TL
    ...
    new "\n{color=#FFD700}--- Statistiques Mentales ---{/color}" # TL
...
translate french strings:
    ...
    new "{b}{u}{color=#E4CA48}Chance{/color}{/b}{/u}\n{small}Augmente les chances de bonnes cartes., diminue les chances de rencontrer des adversaires puissants. Jouer avec des codes Discord ou échanger avec certains êtres.{/small}" # TL
    ...
    new "{color=#d26a6a}Santé:{/color}" # TL
    ...
    old "Physical Stats"
    new "Statistiques Physiques" # TL

    # game/screens/menus/character.rpy:75
    old "Mental Stats"
    new "Statistiques Mentales" # TL
