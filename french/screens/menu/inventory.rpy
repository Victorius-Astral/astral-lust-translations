...
translate french strings:
    ...
    new "[player.hp]/[player.hp_max]\n[player.sanity] pour 100\n[player.corruption] pour 100" # TL
    ...
    new "La monnaie de base utilisée par les Vagabonds. Qu'est-ce qui les a poussés à la considérer comme précieuse? Personne ne le sait." # TL
    ...
    new "Personne ne connaît l'origine ou l'utilisation de ces pièces, mais il existe un être fou prêt à échanger divers trésors contre elles." # TL

    # game/screens/menu/inventory.rpy:336
    old "Gold bar with 99% purity. The world has changed, but value of gold never changes."
    new "Barre d'or d'une pureté de 99 pour 100. Le monde a changé, mais la valeur de l'or ne change jamais." # TL
    ...
    new "La ressource naturelle la plus durable sur terre, constituée de carbone. Elle est connue pour sa beauté, devenant un excellent cadeau lorsqu'elle est intégrée à un bijou." # TL
    ...
    new "Matériau de base utilisé à la fois pour la construction et l'artisanat. Il y en a beaucoup qui traînent." # TL
    ...
    new "Matériau de base utilisé principalement pour la construction. On peut en trouver à peu près partout dans la ville en ruines." # TL
    ...
    new "Matériau très utile utilisé presque partout, il est présent partout dans le monde moderne." # TL

    # game/screens/menu/inventory.rpy:344
    old "Material used in variety of clothing."
    new "Matériau utilisé dans une variété de vêtements." # TL
    ...
    new "Couramment utilisé comme combustible dans les fonderies et la production d'électricité. Également connu sous le nom d'\'or noir\' dans la région de la Silésie." # TL
