...
translate french strings:
    ...
    new "(Désactive le contenu érotique, sûr pour le streaming.)\n\nLe contenu érotique sera ignoré. Pour voir la total des événements précédents, désactivez le mode Prude et utilisez l'application Replay Gallery sur le PC du joueur.\nLe mode Prude peut être activé/désactivé en toute sécurité au milieu du jeu, mais un événement déjà en cours de lecture peut ne pas être affecté jusqu'à ce qu'il soit déclenché à nouveau. Le mode parciel permet une nudité pas trop explicite, pour le streaming sur Twitch utilisez la total.\n\n(NB - la fonctionnalité total n'est pas garantie)"
    ...
    new "(Nécessite un redémarrage, désactive le rollback)."
    ...
    new "Bloquer le retour en arrière (mise à niveau de la version)"
    ...
    new "(L'utilisation du retour en arrière après le chargement d'une sauvegarde d'une ancienne version du jeu causera probablement des erreurs à l'avenir, cette option garantit que lorsque vous chargez une sauvegarde d'une ancienne version, vous ne pouvez pas revenir en arrière avant le chargement)."
    ...
    new "Couleur du contour du texte"
    ...
    new "{font=fonts/FrederickatheGreat-Regular.ttf}Fredericka{/font} police"
    ...
    new "Changez la police {font=fonts/FrederickatheGreat-Regular.ttf}Fredericka{/font} en police {font=fonts/Brygada1918-Regular.ttf}Brigada 1918{/font}. Cela peut être utile sur les petits écrans si Fredericka devient illisible. Certaines langues imposent la Brigada dans tous les cas."

    # game/screens/settings/game.rpy:96
    old "*Restart required for full change"
    new "*Restart requis pour un changement complet"

    # game/screens/settings/game.rpy:100
    old "Notifications Style"
    new "Style des notifications"
    ...
    new "{color=#FFD700}Merci de faire partie de notre communauté!{/color}"
    ...
    new "Afficher le menu d'interaction"

    # game/screens/settings/game.rpy:145
    old "Show tasks menu"
    new "Afficher le menu des tâches"

    # game/screens/settings/game.rpy:149
    old "Choice Menu Position"
    new "Position du menu de choix"
    ...
    old "Show tutorials"
    new "Afficher les didacticiels"

    # game/screens/settings/game.rpy:158
    old "Reset tutorials"
    new "Réinitialiser les didacticiels"
    ...
    old "Textbox Opacity"
    new "Opacité de la boîte de texte"
    ...
    new "[persistent.text_outline] bordure de la largeur d'un pixel."
