...
translate french strings:
    ...
    new "{a=https://astral-lust-documentation.readthedocs.io/en/latest/changelogs/full.html#changelog-full}{color=#2839fc}{i}Lire le changelog complet{/i}{/color}{/a}"
    ...
    new "Vous pouvez voir plus d'informations, d'aperçus et de contenu sur les sites {a=https://www.patreon.com/Victorius}{color=#2839fc}{i}Patreon{/i}{/color}{/a} et {a=https://discord.gg/rvnBC39USx}{color=#2839fc}{i}Discord{/i}{/color}{/a}."
    ...
    new "Kiara a reçu un nouvel événement expliquant le mythe de la création auquel croient les êtres extraordinaires. N'oublie pas de t'amuser après, 6 nouvelles scènes de sexe, 3 nouvelles tenues, et près de 300 animations! Avez-vous déjà baisé une fille avec votre clone?"

    # game/screens/utility/what_new.rpy:197
    old "{b}Alice Shower Event{/b}"
    new "{b}Événement douche d'Alice{/b}"
    ...
    new "L'événement douche d'[alice] a été étendu avec une nouvelle scène. Amusez-vous avec votre petite fille, et aidez-la à se laver le dos!"
    ...
    new "Cette nouvelle interaction aléatoire entre [lexi] et [grace] vous permettra de connaître un peu plus la fille. Il y a cinq conversations différentes."

    # game/screens/utility/what_new.rpy:229
    old "{b}Outfit Crafting Menu{/b}"
    new "{b}Menu de création de vêtements{/b}"

    # game/screens/utility/what_new.rpy:230
    old "Now when asking [alice] to make outfit, you'll be able to use a new outfits menu!"
    new "Lorsque vous demanderez à [alice] de créer une tenue, vous pourrez utiliser le nouveau menu de création de tenues!"
    ...
    new "Dans cette version, quatre nouvelles cartes uniques sont apparues dans Asthar! Elles font toutes partie de l'Astral Lust 1st Anniversary. La carte Feu d'artifice est disponible sur {a=https://www.patreon.com/Victorius}{patreon1}Patreon{/patreon1}{/a} et {a=https://discord.gg/rvnBC39USx}{patreon1}Discord{/patreon1}{/a} pour tout le monde, les trois autres cartes sont pour tous les Patrons. L'une des cartes permet d'invoquer diverses filles comme alliées - Délires!"

    # game/screens/utility/what_new.rpy:267
    old "{b}Interactions Menu{/b}"
    new "{b}Menu Interactions{/b}"
    ...
    new "Il y a une grosse QoL ici! Maintenant, vous n'avez plus besoin de vérifier ce qui est cliquable un par un. En plus des secrets, les autres éléments interactifs dans le free roam ont maintenant le bouton dans le coin inférieur gauche! Cette fenêtre peut être désactivée dans les paramètres, et avec la touche 'I'."
    ...
    new "Un événement limité dans le temps est apparu! Jouez une série de 7 événements sur le thème de Noël et battez l'esprit de Noël! Une fois l'événement vu, vous ne pouvez pas en voir un autre avant le lendemain (en temps réel). Vous avez jusqu'au 10 janvier pour vaincre l'esprit!"

    # game/screens/utility/what_new.rpy:302
    old "{b}Lexi's Massage{/b}"
    new "{b}Massage de Lexi{/b}"
    ...
    new "Mina s'est fait masser les pieds, maintenant il est temps pour l'autre soeur d'avoir sa part de vos talents de massage! De nombreuses tenues à assortir à de nouvelles scènes H chaudes!"
    ...
    new "Vous avez toujours voulu aider Grace dans ses tâches ménagères à l'hôtel? Vous vouliez peut-être jouer à la maison avec elle? Maintenant, c'est possible ! Aidez-la, elle vous en sera reconnaissante. {b}Montrez-lui qu'il y a des hommes bien dans ce monde!{/b} {i}Elle pourrait poser des questions de maths bizarres, vous êtes prévenus.{/i}"

    # game/screens/utility/what_new.rpy:350
    old "{b}Adventure with Lexi{/b}"
    new "{b}Aventure avec Lexi{/b}"

    # game/screens/utility/what_new.rpy:351
    old "Go out and get some supplies with Lexi, be prepared for trouble!"
    new "Sortez et allez chercher du matériel avec Lexi, préparez-vous à avoir des problèmes!"
    ...
    new "Trois nouvelles histoires avec Savenia! Que se passera-t-il une fois que sa jambe sera guérie? Va-t-elle partir?"

    # game/screens/utility/what_new.rpy:373
    old "{b}New exploration events{/b}"
    new "{b}Nouveaux événements d'exploration{/b}"
    ...
    new "Quatre nouveaux événements d'exploration sont prêts pour vous! Sauvez des femmes, faites-vous tromper, chassez des dragons et fuyez des géants. Les personnages les plus demandés sont présents : la fille du commerçant et la fille du bandit 'flashy'. Il y a aussi une femme enceinte en danger! Sauvez-la et son enfant à naître!"

    # game/screens/utility/what_new.rpy:385
    old "{b}New dream{/b}"
    new "{b}Nouveau rêve{/b}"
    ...
    new "Un rêve amusant t'attend! Vous avez déjà imaginé ce que l'avenir vous réserve? Tombez dans l'étreinte chaleureuse d'Alice et profitez de votre nouvelle vie."
    ...
    new "Un nouveau tutoriel de combat a été introduit. Laissez Lexi vous montrer les bases du combat! Il peut être lancé depuis la porte extérieure du hall."
    ...
    new "Vous vous êtes toujours demandé pourquoi Lexi ne vous apportait pas des choses de l'extérieur? N'y pensez plus, demandez-lui simplement de le faire! Actuellement, les tâches peuvent être assignées à Lexi, Mina, Alice et Grace."

    # game/screens/utility/what_new.rpy:412
    old "{b}Buffs{/b}"
    new "{b}Améliorations{/b}"
    ...
    new "Tu peux maintenant obtenir divers buffs! Ils vous aideront en combat, obtenez-les en assignant les tâches aux filles. Le buff actif apparaîtra dans le menu du personnage."

    # game/screens/utility/what_new.rpy:417
    old "{b}Combat additions{/b}"
    new "{b}Ajouts de combat{/b}"
    ...
    new "Trois nouveaux ennemis bandits vous attendent. Bottez-leur le cul! Vous pouvez le faire avec l'aide d'un nouvel effet de statut - Marque du chasseur, et de deux nouvelles cartes Bécassine et Grenade à fragmentation."
    ...
    new "Vous êtes curieux de connaître l'ancien propriétaire de l'hôtel? Demandez aux filles, elles vous diront peut-être quelque chose d'utile. Grace, Mina et Alice ont un nouveau sujet de conversation!"
    ...
    new "Il y a beaucoup d'autres petits ajouts et changements ici et là. L'interface graphique du journal/codex a été modifiée pour en améliorer la lisibilité. Il y a aussi beaucoup de changements de qualité de vie comme l'utilisation des matériaux du coffre pour l'artisanat."

    # game/screens/utility/what_new.rpy:453
    old "{b}Mina at the Vault{/b}"
    new "{b}Mina dans le coffre{/b}"
    ...
    new "Mina peut maintenant apparaître dans le caveau! Elle a un nouveau sujet à aborder avec nous. Il y a également deux scènes H là-bas."

    # game/screens/utility/what_new.rpy:467
    old "{b}Past Lives{/b}"
    new "{b}Vies Passées{/b}"
    ...
    new "Un nouvel événement parallèle à l'intrigue principale! Cet événement partage plus qu'il n'y paraît au premier abord. C'est le prélude à la vérité sur Asthar."

    # game/screens/utility/what_new.rpy:478
    old "{b}Damsel in Distress{/b}"
    new "{b}Demoiselle en détresse{/b}"
    ...
    new "Il y a cinq nouveaux événements d'exploration! Tous ont pour thème la demoiselle en détresse. Vous pouvez essayer de vaincre les monstres, et vérifier à quel point ces demoiselles peuvent être reconnaissantes."

    # game/screens/utility/what_new.rpy:490
    old "{b}Heart of Flames{/b}"
    new "{b}Coeur de flammes{/b}"
    ...
    new "Il y a un nouvel effet de statut, et une carte qui l'accorde. Heart of Flames fait en sorte que l'effet de brûlure guérisse au lieu d'infliger des dégâts. L'effet et la carte peuvent être trouvés sur le dragon."
    ...
    new "{b}Afficher toutes les cartes{/b}\nUne nouvelle fonction a été ajoutée au pc. Elle vous permet de vérifier toutes les cartes dans le jeu! Vous pouvez regarder les cartes nécessaires pour construire votre deck de rêve, et aussi vérifier les changements de méta entre les versions."
    ...
    new "{b}Animaux de compagnie à câliner{/b}\nLes animaux de compagnie ont enfin été oubliés. Vous pouvez maintenant caresser vos petits amis. Tous les endroits où les animaux apparaissent ont une scène différente."
    ...
    new "{b}Savenia{/b}\nCette version apporte trois nouveaux événements pour Savenia. Au cours desquels nous ferons progresser notre relation au-delà de la maladresse initiale. Il y a aussi une nouvelle scène H répétable pour elle. Le support de la carte a été ajouté pour les événements de son histoire."
    ...
    new "{b}Coffre fort{/b}\nLe coffre fort peut encore être étendu! Avec 4 nouveaux niveaux, couplés à des effets spéciaux, comme la monnaie qui ne prend pas de place, ou des multiplicateurs d'espace. Le coffre-fort T8 peut stocker 600 objets, 32 cartes et une quantité illimitée de monnaie."

    # game/screens/utility/what_new.rpy:644
    old "{b}Experience{/b}\nCharacters experience is now collected & displayed in their stats. (not in SFW mode)"
    new "{b}Expérience{/b}\nL'expérience des personnages est maintenant collectée et affichée dans leurs statistiques. (pas en mode Prude)"
