translate chinese strings:
    ...
    new "（关闭色情内容）\n\n色情内容将会跳过。如果事后想要查看相关内容，请关闭此模式，并使用玩家房间电脑中的事件重放 APP。\n免社死模式可以在游戏过程中随时开启或关闭，但已经触发的剧情将不会被影响，除非被再次触发。“部分”模式下，裸露的内容将会模糊处理。"
    ...
    new "(加载旧版本存档后，使用回退功能，可能造成游戏崩溃。此选项可确保加载旧版本存档后，你将不能回退到加载前的进度。)"
    ...
    new "{font=fonts/FrederickatheGreat-Regular.ttf}Fredericka{/font} 字体"
    ...
    new "将 {font=fonts/FrederickatheGreat-Regular.ttf}Fredericka{/font} 字体改成 {font=fonts/Brygada1918-Regular.ttf}Brigada 1918{/font} 字体。因为在小屏幕上 Fredericka 字体可能难以阅读。某些语言可能也强制使用 Brigada 字体。"
    ...
    new "{color=#FFD700}感谢您成为我们社区的一员！{/color}"
    ...
    new "[persistent.text_outline] 像素宽度"
