...
translate chinese tutorial_combat_win_91a377ad:
    ...
    lexi "还有{i}更{/i}强大的敌人。此外，寡不敌众的情况也很常见。"
...
translate chinese tutorial_combat_win_20fa15ab:
    ...
    lexi "这很好。外面有很多非常强大的怪物。如果你觉得自己还应付不了，一定要快点逃跑。"
...
translate chinese tutorial_combat_win_485f2947:
    ...
    lexi "啊这…如果你现在还缺乏信心，你在外面的日子会很难过。这个狼人真的很弱…"
...
translate chinese tutorial_combat_end_fd7a89e1:
    ...
    lexi "你房间里有些东西可以帮到你。试着用镜子来提升你的{i}{cha}魅力{/cha}{/i}。你床头柜上的魔方可以提升{i}{int}智力{/int}{/i}。"
...
translate chinese tutorial_combat_end_40cde874:
    ...
    lexi "在战斗中，首先提高你的{i}{wis}精神{/wis}{/i}更为重要。你可以通过在床头柜上选择读书来做到这一点。"
...
translate chinese tutorial_combat_end_84b3e835:
    ...
    lexi "你还应该优先建造一个{i}{b}健身房{/b}{/i}。你可以在大厅的柜台扩建。在那里你可以训练{i}{str}力量{/str}{/i}、{i}{vit}耐力{/vit}{/i}和{i}{agi}敏捷{/agi}{/i}。"
...
translate chinese strings:
    ...
    new "我们现在要打败的是一个狼人。别担心，那个是弱化的。通常情况下，狼人要强大得多！"
    ...
    new "这就是我们的健康值。如果它达到零，我们将无法再战斗。别死了! 记住，我们需要在他们杀死我们之前杀死他们。"
    ...
    new "你可以在底部看到你的牌。这是你的手牌。只要你有足够的精神力，你就能打出这些牌中的任何一张。"
    ...
    new "精神力是一种能量，用于在战斗中执行行动。它每回合都会被恢复。默认情况下，精神力的最大值为3，但你可以通过房间里的书来训练精神来增加它。"
    ...
    new "为了获胜，我们需要杀死敌人。你可以用你的牌攻击他。试着用\"打\"来攻击他。"
    ...
    new "我们的精神力不足了。我们应该为他的行动做准备。你看到他头上的这个东西了吗？这是一个指示，意味着他要攻击我们中的任何一个，造成5点伤害。"
    ...
    new "很好! 你身体左侧的这个盾牌是格挡点。每点格挡可以挡住一点伤害。有了5个格挡点，这个恶棍就根本无法伤害你了!"
    ...
    new "如果你觉得你在战斗中没有机会获胜，你会死，你可以尝试逃跑。逃跑的几率在按钮的底部。每一次尝试逃跑都会让你失去2点精神力。"
    ...
    new "在左下角是你的抽牌堆。下一回合你会从这堆牌中抽取你的手牌。你可以在之后点击它来查看下一个回合你可能得到什么牌。"
    ...
    new "在右下角的是你的弃牌堆。这是一堆打牌时用过或丢弃的纸牌。当抽牌堆是空的，它将被从弃牌堆中填满。"
    ...
    new "他又要进攻了。我担心他会攻击我，你能帮我防卫吗?点击我来选择我。"
    ...
    new "太棒了!你看到我的生命值栏现在是黄色的了吗，周围还有漂浮的黄色灯光?这意味着我被选中了。现在你使用的buff卡是以我为目标了。"
    ...
    new "使用巨大化卡给我需要的提升。你会发现它赋予了我力量，而不是你。有时候，进攻是最好的防御。当你想给自己使用一张牌时，选择你自己吧!"
    ...
    new "太棒了!谢谢你的buff!你一定注意到有些卡牌会影响敌方，而有些会影响友方。目标不是随机的。当你将鼠标悬停在一张卡片上时，它的左下角有一个小圆圈。它表示谁会受到这张牌的影响。"
    ...
    new "目标可以是单个的，也可以是多个。“目标数”的确切数量可以通过卡片描述来了解。"
    ...
    new "有些牌比较复杂，会影响很多人。目标范围可以有绿色、红色和蓝色中的一种颜色。"
    ...
    new "它也可以同时拥有所有颜色，或者没有任何颜色，如果它不能直接影响任何人，并影响战斗本身。目标轮更多的是一种提示，实际的卡牌效果是由卡牌描述来解释的。"
    ...
    new "匕首的刺击让敌人流血不止。它将对他造成x点伤害，然后每回合减少1点。悬停在效果上会显示它们的作用。"
    ...
    new "有很多状态效果可以用来制作致命的组合。例如，毒药使流血造成的伤害加倍。"
    ...
    new "记住要经常检查新状态效果的作用，这样你就可以想出一个组合，让敌人大吃一惊。如果你掌握了状态效果，即使是邪教徒也需要避开你！"
