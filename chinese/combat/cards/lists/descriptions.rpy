...
translate chinese strings:
    ...
    new "受到 {damage_min}-{damage_max} 点伤害，等于随机的 {attribute_type} 属性值乘以 {times}。"
    ...
    new "创造 {amount} 个 {{b}}{item}{{/b}}."

    # game/combat/cards/lists/descriptions.rpy:1
    old "Consume {amount} {{b}}{item}{{/b}}."
    new "消耗 {amount} 个 {{b}}{item}{{/b}}."
