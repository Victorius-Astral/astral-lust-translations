...
translate chinese strings:
    ...
    new "Do you want to play home again? {trust}(Trust+){/trust}{lust}(Lust+){/lust}"

    # game/characters/grace/speak.rpy:27
    old "Do you need help with cleaning? {trust}(Trust+){/trust}"
    new "Do you need help with cleaning? {trust}(Trust+){/trust}"

    # game/characters/grace/speak.rpy:27
    old "Do you need help with cooking? {trust}(Trust+){/trust}"
    new "Do you need help with cooking? {trust}(Trust+){/trust}"
