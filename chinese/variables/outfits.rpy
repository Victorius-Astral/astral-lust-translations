translate chinese strings:
    ...
    new "[kiara] 肯定喜欢现代迪斯科派对。这在 Asthar 可能只存在于梦里，但你仍可以给她合适的衣服。"
